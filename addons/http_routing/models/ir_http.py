...
class IrHttp(models.AbstractModel):
    ...
    def _get_converters(cls):
        ...
        """
        return dict(super(IrHttp, cls)._get_converters(), model=ModelConverter,)
        ...
        session_info.update(
            {
                ...
                "cache_hashes": {"translations": translation_hash,},
            }
        )
        return session_info
    ...
    def _dispatch(cls):
        ...
        if (
            request.is_frontend
            and cook_lang != request.lang.code
    ...
    def _get_exception_code_values(cls, exception):
        ...
        values = dict(exception=exception, traceback=traceback.format_exc(),)
    ...
    def _get_error_html(cls, env, code, values):
        return (
            code,
            env["ir.ui.view"]._render_template("http_routing.%s" % code, values),
        )
    ...
    def _handle_exception(cls, exception):
        ...
        with registry(request.env.cr.dbname).cursor() as cr:
            ...
            try:
                ...
                code, html = (
                    418,
                    env["ir.ui.view"]._render_template(
