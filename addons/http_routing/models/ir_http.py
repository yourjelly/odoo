...
class ModelConverter(ir_http.ModelConverter):
    ...
    def to_python(self, value) -> models.AbstractModel:
...
class IrHttp(models.AbstractModel):
    ...
    @classmethod
    def _extension_to_mimetype(cls, ext: str) -> str:
        """ File extension to minetype.
            e.g. ".css" => "text/css"
        """
        exts = {
            '.css': 'text/css',
    ...
    def _slugify(cls, value: str, max_length: int = 0, path: bool = False) -> str:
        if not path:
            ...
            if cls._extension_to_mimetype(ext):
    ...
    def _url_localized(cls,
            ...
            canonical_domain: typing.Optional[typing.Union[str, typing.Tuple[str, str, str, str, str]]] = None,
    ...
    @classmethod
    def _url_lang(cls, path_or_uri: str, lang_code: typing.Optional[str] = None) -> str:
    ...
    @classmethod
    def _url_for(cls, url_from: str, lang_code: typing.Optional[str] = None) -> str:
        ...
        if (
            ...
            and request.env['ir.http']._rewrite_len()
            and (
                len(path) > 1
                and path.startswith('/')
    ...
    @classmethod
    def _is_multilang_url(cls, local_url: str, lang_url_codes: typing.Optional[list[str]] = None) -> bool:
