...
class HrEmployee(models.Model):
    ...
    def _load_pos_data(self, data):
        ...
        minimal_user_ids = employees.filtered(lambda emp: emp.user_id and data['pos.config']['data'][0]['group_pos_minimal_user_id'] in emp.user_id.groups_id.ids).mapped('id')
