...
class PosOrder(models.Model):
    ...
    employee_id = fields.Many2one('hr.employee', help="Person who uses the cash register. It can be a reliever, a student or an interim employee.", readonly=[('state', 'in', ['done', 'invoiced'])])
