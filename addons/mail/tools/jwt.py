...
def base64_decode_with_padding(value: any) -> bytes:
...
def sign(claims: dict, key: str, ttl: int, algorithm: ALGORITHM = ALGORITHM.ES256) -> str:
    """
    A JSON Web Token is a signed pair of JSON objects, turned into base64 strings.
    Example: eyJhbGciOiJIUzI1NiJ9.eyJoZWxsbyJ9.gGqsafn5y_pIbt8pCluR9XsI8dXQmghr2TYGEWpWnU8
