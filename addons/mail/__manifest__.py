...

{
    ...
    "application": True,
    "assets": {
        "web._assets_primary_variables": ["mail/static/src/scss/variables.scss",],
        "web.assets_backend": [
        ...
        "web.assets_backend_prod_only": ["mail/static/src/js/main.js",],
        "web.assets_tests": ["mail/static/tests/tours/**/*",],
        "web.tests_assets": [
