                    ...
                    [
                        {
                            ...
                            "payload": {
                                ...
                                "mail.link.preview.message": [{
                                    "id": link_preview_message.id,
                                    "link_preview_id": link_preview_message.link_preview_id.id,
                                    "message_id": link_preview_message.message_id.id,
                                } for link_preview_message in message.link_preview_message_ids],
                                "mail.message": self._filter_messages_fields(
                                    {
                                        "id": message.id,
                                        "link_preview_ids": [message.link_preview_ids.id],
                                        "link_preview_message_ids": [message.link_preview_message_ids.id],
                                    },
                                ),
                            },
                        }
