...
class TestChannelInternals(MailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.test_partner = (
            cls.env["res.partner"]
            .with_context(cls._test_context)
            .create({"name": "Test Partner", "email": "test_customer@example.com",})
        )
    ...
    def test_channel_recipients_channel(self):
        ...
        channel._action_add_members(
            self.partner_employee | self.partner_admin | self.test_partner
        )
    ...
    def test_channel_recipients_chat(self):
        ...
        self.test_channel._action_add_members(
            self.partner_employee | self.partner_admin | self.test_partner
        )
        with self.mock_mail_gateway():
    ...
    def test_channel_user_synchronize(self):
        ...
        self.test_channel._action_add_members(
            self.partner_employee | self.partner_employee_nomail
        )
        test_channel_private._action_add_members(
            self.partner_employee | self.partner_employee_nomail
        )
        test_channel_group._action_add_members(
            self.partner_employee | self.partner_employee_nomail
        )
    ...
    def test_channel_info_get(self):
        ...
        self.assertEqual(
            set(p["id"] for p in initial_channel_info["members"]),
        ...
        self.assertEqual(
            set(p["id"] for p in solo_channel_info["members"]),
