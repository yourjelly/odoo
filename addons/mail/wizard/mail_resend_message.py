...
class PartnerResend(models.TransientModel):
    ...
    name = fields.Char(related="partner_id.name", compute_sudo=False, readonly=False)
    email = fields.Char(related="partner_id.email", compute_sudo=False, readonly=False)
