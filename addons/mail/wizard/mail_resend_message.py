...
class PartnerResend(models.TransientModel):
    ...
    name = fields.Char(related="partner_id.name", depends=['partner_id'], related_sudo=False, readonly=False)
    email = fields.Char(related="partner_id.email", depends=['partner_id'], related_sudo=False, readonly=False)
