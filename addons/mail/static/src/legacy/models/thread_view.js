    ...
    fields: {
        ...
        lastMessageListViewItem: one("MessageListViewItem", {
            ...
            compute() {
                ...
                const { length, [length - 1]: messageListViewItem } =
        ...
        threadCacheInitialScrollHeight: attr({
            compute() {
                ...
                const threadCacheInitialScrollHeight =
                    this.threadCacheInitialScrollHeights[this.threadCache.localId];
        ...
        threadCacheInitialScrollPosition: attr({
            compute() {
                ...
                const threadCacheInitialScrollPosition =
                    this.threadCacheInitialScrollPositions[this.threadCache.localId];
