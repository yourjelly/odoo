...
Model({
    ...
    fields: {
        ...
        suggestionViews: many("ComposerSuggestionView", {
            compute() {
                const mainSuggestionViews =
                    this.composerSuggestionListViewMainComposerSuggestionViewItems.map(
                        (item) => item.composerSuggestionView
                    );
                const extraSuggestionViews =
                    this.composerSuggestionListViewExtraComposerSuggestionViewItems.map(
                        (item) => item.composerSuggestionView
                    );
