odoo.define('mail.messaging.utils.throttle', function (require) {
'use strict';

const { makeDeferred } = require('mail.messaging.utils.deferred');
...
class Throttle {
    ...
    constructor(env, func, duration) {
         ...
         * time flow in tests.
         * @see mail.messaging.testUtils:start:hasTimeControl
         */
        this.env = env;
        /**
