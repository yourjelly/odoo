...
QUnit.test('delete an attachment', async function (assert) {
    assert.expect(2);
    ...
    await afterNextRender(() => {
        // ensures that the unlink method is called only once, regardless of the amount of times the button is pressed.
