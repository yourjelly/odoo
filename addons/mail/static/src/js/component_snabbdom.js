odoo.define('mail.snabbdom.vnode', function (require) {
...
odoo.define('mail.snabbdom.is', function (require) {
    return {
        array: Array.isArray,
...
odoo.define('mail.snabbdom.h', function (require) {
    var VNode = require('mail.snabbdom.vnode');
    var is = require('mail.snabbdom.is');
...
odoo.define('mail.snabbdom.init', function (require) {
    'use strict';
...
odoo.define('mail.snabbdom.thunk', function (require) {
    var h = require('mail.snabbdom.h');
...
odoo.define('mail.snabbdom.class', function (require) {
...
odoo.define('mail.snabbdom.props', function (require) {
...
odoo.define('mail.snabbdom.attributes', function (require) {
    var booleanAttrs = [
...
odoo.define('mail.snabbdom.eventlistener', function (require) {
...
odoo.define('mail.snabbdom.patch', function (require) {
    // don't load styles or event listeners by default
    return require('mail.snabbdom.init')([
        require('mail.snabbdom.eventlistener'),
        require('mail.snabbdom.attributes'),
    ]);
});
