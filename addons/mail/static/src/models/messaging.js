...
registerModel({
    ...
    lifecycleHooks: {
        ...
        _willDelete() {
            this.env.services['presence'].removeEventListener('window_focus', this._handleGlobalWindowFocus);
    ...
    recordMethods: {
         ...
         */
        async start() {
            this.env.services['presence'].addEventListener('window_focus', this._handleGlobalWindowFocus);
