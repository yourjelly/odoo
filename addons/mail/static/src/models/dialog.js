...
registerModel({
    ...
    identifyingFields: [[
        ...
        'linkPreviewOwnerAsLinkPreviewDeleteConfirm',
    ...
    recordMethods: {
        ...
        _computeComponentName() {
            ...
            if (this.linkPreviewDeleteConfirmView || this.linkPreviewImageDeleteConfirmView) {
                return 'LinkPreviewDeleteConfirm';
            }
            return clear();
        },
        /**
        ...
        _computeLinkPreviewDeleteConfirmView() {
            return this.linkPreviewOwnerAsLinkPreviewDeleteConfirm ? insertAndReplace() : clear();
        },
        /**
         * @private
         * @returns {FieldCommand}
        ...
        _computeRecord() {
            ...
            if (this.linkPreviewDeleteConfirmView) {
                return replace(this.linkPreviewDeleteConfirmView);
            }
            if (this.linkPreviewImageDeleteConfirmView) {
                return replace(this.linkPreviewImageDeleteConfirmView);
            }
            if (this.followerSubtypeList) {
    ...
    fields: {
        ...
        linkPreviewOwnerAsLinkPreviewDeleteConfirm: one('LinkPreviewAsideView', {
