...
QUnit.test("Notification Sent", async (assert) => {
    ...
    assert.containsN($, ".o-mail-MessageNotificationPopover i", 2);
    for (const iconElement of $(".o-mail-MessageNotificationPopover i")) {
        assert.hasClass(iconElement, "fa-check");
    }
