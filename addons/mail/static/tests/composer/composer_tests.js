...
QUnit.test('suggestion list is switchable between commands', async (assert) => {
    ...
    assert.strictEqual($(".o-mail-Composer-input").val(), "");
    await insertText(".o-mail-Composer-input", "#");
    await contains(".o-mail-Composer-suggestion", { count: 1, text: "#Mario Party" });
    await click(".o-mail-Composer-suggestion");
    assert.strictEqual(
        $(".o-mail-Composer-input").val().replace(/\s/, " "),
        "#Mario Party ",
    ...
    await insertText(".o-mail-Composer-input", "@");
    await contains(".o-mail-Composer-suggestion", { count: 1, text: "Luigi" });
    // simulate click of somewhere in the name of channel mention
    const textarea = $(".o-mail-Composer-input")[0];
    textarea.setSelectionRange(3, 3);
    await contains(".o-mail-Composer-suggestion", { count: 1, text: "#Mario Party" });
    // simulate click of end of the input
