...
export class MockModels {
     ...
     * @returns {Object}
     */
    static generateServerData() {
        const partnerRootId = 2;
        const currentPartnerId = 3;
        const currentUserId = 2;
        const publicPartnerId = 4;
        ...
        return {
            ...
            actions: {
                200001: {
                    id: 200001,
                    params: { 'default_active_id': 'mail.box_inbox' },
                ...
                'mail.mail_resend_message_action': {
                    id: 'mail.mail_resend_message_action',
                    name: 'Resend mail',
                ...
                'mail.mail_resend_cancel_action': {
                    id: 'mail.mail_resend_cancel_action',
                    name: 'Resend mail',
                    res_model: 'mail.resend.message',
                    target: 'new',
                    type: 'ir.actions.act_window',
            ...
            models: {
                ...
                'mail.activity': {
                    fields: {
                        ...
                        date_deadline: { string: "Due Date", type: "date", default() {
                ...
                'mail.channel': {
                    fields: {
                        ...
                        members: { string: "Members", type: 'many2many', relation: 'res.partner', default() {
                            return [this.data.currentPartnerId];
                        } },
                        ...
                        uuid: { string: "UUID", type: "char", required: true, default() {
                ...
                'mail.message': {
                    fields: {
                        ...
                        author_id: { string: "Author", type: 'many2one', relation: 'res.partner', default() {
                            return this.data.currentPartnerId;
                        } },
                        body: { string: "Contents", type: 'html', default: "<p></p>" },
                        date: { string: "Date", type: 'datetime', default() {
            ...
            views: {
                ...
                'mail.resend.message,false,form': '<form/>',
                'mail.wizard.invite,false,form': '<form/>',
                'res.fake,false,form': '<form/>',
                'res.fake,false,search': '<search/>',
