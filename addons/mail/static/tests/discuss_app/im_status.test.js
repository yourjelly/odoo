...
import { UPDATE_BUS_PRESENCE_DELAY, UPDATE_BUS_PRESENCE_JITTER } from "@bus/im_status_service";
...
test("change icon on change partner im_status", async () => {
    ...
    await advanceTime((UPDATE_BUS_PRESENCE_DELAY + UPDATE_BUS_PRESENCE_JITTER) * 2);
    await contains(".o-mail-ImStatus i[title='Offline']");
