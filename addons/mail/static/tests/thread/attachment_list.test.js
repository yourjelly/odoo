...
test("simplest layout", async () => {
    ...
    expect(".o-mail-AttachmentCard:eq(0)").toHaveAttribute("title", "test.txt");
    await contains(".o-mail-AttachmentCard-image");
    expect(".o-mail-AttachmentCard-image:eq(0)").toHaveClass("o_image"); // required for mimetype.scss style
    expect(".o-mail-AttachmentCard-image:eq(0)").toHaveAttribute("data-mimetype", "text/plain"); // required for mimetype.scss style
