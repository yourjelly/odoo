    ...
    * snailmail.letter (snailmail addon)
    ...
    def _message_format(self, fnames, format_reply=True):
        ...
        for vals in vals_list:
            ...
            allowed_tracking_ids = message_sudo.tracking_value_ids.filtered(lambda tracking: not tracking.field_groups or self.env.is_superuser() or self.env.user.has_group(tracking.field_groups))
