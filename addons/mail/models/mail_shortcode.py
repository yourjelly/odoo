...
class MailShortcode(models.Model):
    ...
    source = fields.Char('Shortcut', required=True, index='trigram', help="Shortcut that will automatically be substituted with a longer content in your message. Type : followed by the name of your shortcut (e.g. :hello) to use it in your messages.")
    substitution = fields.Text('Substitution', required=True, help="Content that will automatically replace the shortcut of your choosing. This content can still be adapted before sending your message.")
