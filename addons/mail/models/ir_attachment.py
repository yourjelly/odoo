...
class IrAttachment(models.Model):
    ...
    def register_as_main_attachment(self):
        ...
        # main_attachment_id field can be empty, that's why we compare to False;
        # we are just checking that it exists on the model before writing it
        if getattr(related_record, 'main_attachment_id') != False:
            related_record.main_attachment_id = self
