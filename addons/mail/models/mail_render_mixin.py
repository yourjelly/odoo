...
class MailRenderMixin(models.AbstractModel):
    ...
    def _render_template_qweb(self, template_src, model, res_ids,
        ...
        for record in self.env[model].browse(res_ids):
            ...
            try:
                render_result = self.env['ir.qweb']._render(lxml.html.fragment_fromstring(template_src, create_parent='t'), variables).decode()
                render_result = Markup(render_result)
    ...
    def _render_template_inline_template(self, template_txt, model, res_ids,
        ...
        for record in self.env[model].browse(res_ids):
            ...
            instructions = parse_inline_template(str(template_txt))
