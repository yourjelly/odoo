...
class ChannelMember(models.Model):
    ...
    def _rtc_join_call(self, check_rtc_session_ids=None):
        ...
        res = {
            ...
            "serverInfo": self._get_rtc_server_info(rtc_session),
        }
    ...
    def _join_sfu(self):
        if len(self.channel_id.rtc_session_ids) < SFU_MODE_THRESHOLD:
            ...
            return
        elif self.channel_id.sfu_channel_uuid:
            return
        ...
        try:
            ...
            _logger.warning("Failed to obtain a channel from the SFU server, user will stay in p2p")
        if response and response.ok:
            ...
            notifications = [
                [
                    ...
                    {"serverInfo": self._get_rtc_server_info(session, key=sfu_server_key)},
                ]
    ...
    def _get_rtc_server_info(self, rtc_session, key=None):
        ...
        claims = {
            ...
            "ice_servers": self.env['mail.ice.server'].sudo()._get_ice_servers(),
        }
