...
class SaleOrder(models.Model):
    ...
    purchase_line_ids = fields.Many2many('purchase.order.line', string="Purchase Order Lines")
...
class SaleOrderLine(models.Model):
    ...
    purchase_line_ids = fields.Many2many('purchase.order.line',
        string="Generated Purchase Lines", readonly=True,
