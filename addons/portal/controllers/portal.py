...
class CustomerPortal(Controller):
    ...
    def portal_address(self,
        ...
        """
        :param int partner_id: the partner id to edit
        :param dict query_params: The additional query string parameters.
        :rtype: str
        """
        _dummy, address_form_values = self._prepare_address_form_values(partner_id, address_type, **query_params)
    ...
    def _prepare_address_form_values(self, partner_id, address_type, **_kwargs):
        ...
        partner_sudo = self._check_partner_edit_rights(partner_id=partner_id, address_type=address_type, **_kwargs)
        can_edit_vat = (
    ...
    def _get_address_submit_result(self, partner_id=None, address_type='other', **form_data):
        ...
        invalid_fields, missing_fields, error_messages = self._validate_address_values(
            address_values, partner_sudo, **extra_form_data
        )
        ...
        if not partner_sudo:  # Creation of a new address.
            address_values['parent_id'] = address_values.get('parent_id', request.env.user.partner_id.id)
