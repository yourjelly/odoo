...
class PortalMixin(models.AbstractModel):
    ...
    def get_portal_url(self, suffix=None, report_type=None, download=None, query_string=None, anchor=None, subscription=None):
        """
        ...
        """
        self.ensure_one()
        access_url = r"\my\orders\{}".format(self.id) if subscription else self.access_url
