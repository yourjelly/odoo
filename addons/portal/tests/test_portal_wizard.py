...
class TestPortalWizard(MailCommon):
    ...
    def test_portal_wizard_partner(self):
        ...
        self.assertTrue(new_user._has_group('base.group_portal'), 'Must add the group to the user')
    ...
    def test_portal_wizard_public_user(self):
        ...
        self.assertTrue(self.public_user._has_group('base.group_portal'), 'Must add the group portal')
        self.assertFalse(self.public_user._has_group('base.group_public'), 'Must remove the group public')
