...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        aa_name = f"""COALESCE(aa.name->>'{self.env.user.lang or get_lang(self.env).code}', aa.name->>'en_US')""" if \
        ...
        # LINES
        aj_name = f"""COALESCE(aj.name->>'{self.env.user.lang or get_lang(self.env).code}', aj.name->>'en_US')""" if \
