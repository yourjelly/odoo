...
class AccountMove(models.Model):
    ...
    def _compute_eta_response_data(self):
        for rec in self:
            ...
            if response_data:
                ...
                rec.l10n_eg_submission_number = response_data.get('l10n_eg_submission_id')
            else:
    ...
    def action_post_sign_invoices(self):
        ...
        invoices = self.filtered(lambda r: r.country_code == 'EG' and r.state == 'posted' and not r.l10n_eg_submission_number)
        if not invoices:
            return
        ...
        return drive_id._action_sign_invoices(self)
