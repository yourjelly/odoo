...
class Meeting(models.Model):
    ...
    def _odoo_values(self, google_event, default_reminders=()):
        ...
        alarm_commands = self._odoo_reminders_commands(
            google_event.reminders.get("overrides") or default_reminders
        )
    ...
    def _odoo_attendee_commands(self, google_event):
        ...
        if (
            ...
            google_attendees += [
                {"email": user.partner_id.email, "responseStatus": "accepted",}
            ]
    ...
    def _google_values(self):
        ...
        if (
            ...
            values["extendedProperties"] = {
                "private": {"%s_odoo_id" % self.env.cr.dbname: self.id,},
            }
        return values
