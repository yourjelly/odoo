...
class SaleEdiCommon(models.AbstractModel):
    ...
    def _import_order_lines(self, order, tree, xpath):
        ...
        for line_tree in tree.iterfind(xpath):
            ...
            lines_values += self._retrieve_line_charges(order.company_id, line_values, line_values['tax_id'])
    ...
    def _get_allowance_charge_lines_vals(self, lines_vals):
        """ Overide of edi.mixin to get sale order line values for allowance charges.
