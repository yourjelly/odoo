    ...
    const PosMercuryPaymentScreen = (PaymentScreen) =>
        class extends PaymentScreen {
            ...
            credit_code_transaction(parsed_result, old_deferred, retry_nr) {
                ...
                this.env.services.orm.call('pos_mercury.mercury_transaction', 'do_payment', [transaction])
                    .then(function (data) {
            ...
            do_reversal(line, is_voidsale, old_deferred, retry_nr) {
                ...
                this.env.services.orm.call('pos_mercury.mercury_transaction', rpc_method, [request_data])
                    .then(function (data) {
                        if (data === 'timeout') {
                            self.retry_mercury_transaction(
                                def,
