...
class ReplenishmentReport(models.AbstractModel):
    ...
    def _compute_draft_quantity_count(self, product_template_ids, product_variant_ids, wh_location_ids):
        ...
        res['draft_production_qty']['in'] = (grouped_mo and grouped_mo[0]['product_qty']) or 0
        ...
        res['draft_production_qty']['out'] = (grouped_moves and grouped_moves[0]['product_qty']) or 0
