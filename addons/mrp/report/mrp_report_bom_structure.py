...
class ReportBomStructure(models.AbstractModel):
    ...
    def _get_report_data(self, bom_id, searchQty=0, searchVariant=False):
        ...
        return {
            ...
            'is_variant_applied': self.env.user._has_group('product.group_product_variant') and len(bom_product_variants) > 1,
            'is_uom_applied': self.env.user._has_group('uom.group_uom'),
