...
class MrpProduction(models.Model):
    ...
    state = fields.Selection([
        ...
        help=" * Draft: The MO is not confirmed yet.\n"
             ...
             " * Canceled: The MO has been canceled, can't be confirmed anymore.")
    ...
    propagate_cancel = fields.Boolean(
        ...
        help='If checked, when the previous move of the move (which was generated by a next procurement) is canceled or split, the move generated by this move will too')
        ...
        for production in self:
            if 'date_start' in vals and not self.env.context.get('force_date', False):
                if production.state in ['done', 'cancel']:
                    raise UserError(_('You cannot move a manufacturing order once it is canceled or done.'))
