...
class ProductProduct(models.Model):
    ...
    def get_components(self):
        ...
        if bom_kit:
            ...
            return [bom_line.product_id.id for bom_line, data in bom_sub_lines if bom_line.product_id.is_trackable]
        else:
        ...
        for product in bom_kits:
            ...
            for component, bom_sub_lines in bom_sub_lines_grouped.items():
                ...
                for bom_line, bom_line_data in bom_sub_lines:
                    if not component.is_trackable or float_is_zero(bom_line_data['qty'], precision_rounding=bom_line.product_uom_id.rounding):
