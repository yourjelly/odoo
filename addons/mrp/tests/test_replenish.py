...
class TestMrpReplenish(TestMrpCommon):
    ...
    def test_rr_picking_type_id(self):
        ...
        self.picking_type_2 = self.warehouse_1.manu_type_id.copy({'sequence': 100})
        self.env['mrp.bom'].create({
        ...
        self.rr = self.env['stock.warehouse.orderpoint'].create({
            'name': 'Cake RR',
        ...
        self.assertTrue(mo)
        mo.action_cancel()
        self.warehouse_1.manufacture_pull_id.picking_type_id = self.picking_type_2
