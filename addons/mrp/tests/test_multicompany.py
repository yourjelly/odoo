...
class TestMrpMulticompany(common.TransactionCase):
    ...
    def test_product_produce_1(self):
        ...
        product = self.env["product.product"].create({"name": "p1", "tracking": "lot",})
        component = self.env["product.product"].create({"name": "p2",})
    ...
    def test_product_produce_2(self):
        ...
        product = self.env["product.product"].create({"name": "p1",})
