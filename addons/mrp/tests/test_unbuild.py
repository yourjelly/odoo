...
class TestUnbuild(TestMrpCommon):
    ...
    def test_unbuild_with_routes(self):
        ...
        finshed_product = ProductObj.create({"name": "Table", "type": "product",})
        component1 = ProductObj.create({"name": "Table head", "type": "product",})
        component2 = ProductObj.create({"name": "Table stand", "type": "product",})
