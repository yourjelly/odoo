...
class TestMrpOrder(TestMrpCommon):
    ...
    def test_product_produce_duplicate_1(self):
        ...
        mo1, bom, p_final, p1, p2 = self.generate_mo(
            tracking_final="serial", qty_final=1, qty_base_1=1,
        )
    ...
    def test_product_produce_duplicate_2(self):
        ...
        mo1, bom, p_final, p1, p2 = self.generate_mo(
            tracking_base_2="serial", qty_final=1, qty_base_1=1,
        )
    ...
    def test_workcenter_timezone(self):
        ...
        bom = self.env["mrp.bom"].create(
            {
                ...
                "operation_ids": [
                    (
                        0,
                        0,
                        {"name": "SuperOperation01", "workcenter_id": workcenter.id,},
                    ),
                    (
                        0,
                        0,
        ...
        date_planned = (Dt.now() + timedelta(days=7 - Dt.now().weekday())).replace(
