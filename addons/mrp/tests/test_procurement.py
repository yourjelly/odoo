...
class TestProcurement(TestMrpCommon):
    ...
    def test_link_date_mo_moves(self):
        ...
        component_1 = self.env["product.product"].create({"name": "component",})
    ...
    def test_finished_move_cancellation(self):
        ...
        component_mold = self.env["product.product"].create({"name": "Plastic Mold",})
    ...
    def test_procurement_with_empty_bom(self):
        ...
        comp1 = self.env["product.product"].create({"name": "egg",})
