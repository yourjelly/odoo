...
const workcenter_status_blocked = "blocked";
...
export class MOListViewDropdown extends Component {
    ...
    setup() {
        ...
        this.colorIcons = {
            ...
            [workcenter_status_blocked]: "o_status_danger",
        };
    }
    ...
    get statusColor() {
        const state = this.isBlocked ? workcenter_status_blocked : this.workorderState.state;
        return this.colorIcons[state] || "";
    }

    get isBlocked() {
        return this.props.record.data.working_state == workcenter_status_blocked;
    }
