...
class AccountEdiXmlUBLBIS3(models.AbstractModel):
    ...
    * Official doc for EHF Billing 3.0 is the OpenPeppol BIS 3 doc +
    ...
    def _get_partner_party_legal_entity_vals_list(self, partner):
        ...
        for vals in vals_list:
            ...
            if partner.country_code == 'NL':
                vals.update({
                    'company_id': partner.endpoint_value,
                    'company_id_attrs': {'schemeID': partner.eas_code},
                })
            if partner.country_id.code == "LU" and 'l10n_lu_peppol_identifier' in partner._fields and partner.l10n_lu_peppol_identifier:
                vals['company_id'] = partner.l10n_lu_peppol_identifier
    ...
    def _get_partner_party_vals(self, partner, role):
        ...
        vals.update({
            'endpoint_id': partner.endpoint_value,
            'endpoint_id_attrs': {'schemeID': partner.eas_code},
        })
    ...
    def _export_invoice_constraints(self, invoice, vals):
        ...
        constraints.update({
            'eas_code_is_set1': self._check_required_fields(vals['supplier'], 'eas_code'),
            'eas_code_is_set2': self._check_required_fields(vals['customer'], 'eas_code'),
            'endpoint_value_is_set1':  self._check_required_fields(vals['supplier'], 'endpoint_value'),
            'endpoint_value_is_set2':  self._check_required_fields(vals['customer'], 'endpoint_value'),
        })
    ...
    def _invoice_constraints_peppol_en16931_ubl(self, invoice, vals):
        ...
        if vals['supplier'].country_id.code == 'NL':
            constraints.update({
                ...
                ) if vals['supplier'].eas_code not in ('0106', '0190') else '',
            ...
            if vals['customer'].country_id.code == 'NL':
                constraints.update({
                    ...
                    ) if vals['customer'].eas_code not in ('0106', '0190') else '',
                })
