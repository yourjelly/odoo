...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _import_retrieve_and_fill_partner(self, invoice, name, phone, mail, vat, country_code=False, domain=False):
        """ Retrieve the partner, if no matching partner is found, create it (only if he has a vat and a name)
        """
        invoice.partner_id = self.env['account.edi.format']._retrieve_partner(name=name, phone=phone, mail=mail, vat=vat, domain=domain)
