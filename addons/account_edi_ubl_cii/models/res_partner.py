...
class ResPartner(models.Model):
    ...
    peppol_eas = fields.Selection(
        ...
        selection=[
            ...
            ('0106', "0106 - Vereniging van Kamers van Koophandel en Fabrieken in Nederland (Association of Chambers of Commerce and Industry in the Netherlands), Scheme (EDIRA compliant)"),
            ...
            ('0183', "0183 - Numéro d'identification suisse des enterprises (IDE), Swiss Unique Business Identification Number (UIDB)"),
            ('0184', "0184 - DIGSTORG"),
            ...
            ('0216', "0216 - OVTcode"),
            ('0217', "0217 - The Netherlands Chamber of Commerce and Industry establishment number"),
