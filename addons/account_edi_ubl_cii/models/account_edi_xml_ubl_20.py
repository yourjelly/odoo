...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _import_retrieve_partner_vals(self, tree, role):
        ...
        return {
            ...
            'name': self._find_value(f'.//cac:{role}Party/cac:Party//cbc:Name', tree),
    ...
    def _import_fill_invoice(self, invoice, tree, qty_factor):
        ...
        allowance_charges_line_vals, allowance_charges_logs = self._import_document_allowance_charges(tree, invoice.company_id, invoice.journal_id.type, qty_factor)
