    ...
    def _create_move_from_pos_order_lines(self, lines):
        ...
        for product, lines in lines_by_product:
            ...
            for move in confirmed_moves:
                if (
                    first_line.product_id == move.product_id
                    and first_line.product_id.tracking != "none"
                ):
                    if (
                        self.picking_type_id.use_existing_lots
                        or self.picking_type_id.use_create_lots
                    ):
                            ...
                            for lot in line.pack_lot_ids.filtered(lambda l: l.lot_name):
                                ...
                                if self.picking_type_id.use_existing_lots:
                                    ...
                                    quant = existing_lot.quant_ids.filtered(
                                        lambda q: q.quantity > 0.0
                                        or q.location_id.parent_path.startswith(
