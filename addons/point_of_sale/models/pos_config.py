...
class PosConfig(models.Model):
    ...
    use_employees = fields.Boolean(help="If not enabled, only users in the 'Point of Sale' group can log in.")
    employees = fields.Many2many('hr.employee', string="Employees with access", help='If left empty, all employees can log in to the PoS session')
