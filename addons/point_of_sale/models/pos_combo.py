...
class ProductCombo(models.Model):
    ...
    combo_product_ids = fields.One2many("pos.combo.line", "combo_id", string="Products in Combo")
    ...
    @api.constrains("combo_product_ids")
    def _check_combo_product_ids_is_not_null(self):
        if any(not rec.combo_product_ids for rec in self):
