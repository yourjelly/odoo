...
class PosOrder(models.Model):
    ...
    def _prepare_invoice_vals(self):
        ...
        vals = {
            ...
            "invoice_line_ids": [
                (0, None, self._prepare_invoice_line(line)) for line in self.lines
            ],
    ...
    def _create_order_picking(self):
        ...
        if self.to_ship:
            ...
            if not self.session_id.update_stock_at_closing or (
    ...
    def action_receipt_to_customer(self, name, client, ticket):
        ...
        if self.mapped("account_move"):
            report = self.env.ref("point_of_sale.pos_invoice_report")._render_qweb_pdf(
                self.ids[0]
            )
            filename = name + ".pdf"
