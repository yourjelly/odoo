...
class PosOrder(models.Model):
    ...
    user_id = fields.Many2one(
        ...
        readonly=[('state', 'in', ['done', 'invoiced'])],
    )
    ...
    amount_paid = fields.Float(string='Paid', readonly=[('state', '!=', 'draft')], digits=0, required=True)
    ...
    lines = fields.One2many('pos.order.line', 'order_id', string='Order Lines', readonly=[('state', '!=', 'draft')], copy=True)
    company_id = fields.Many2one('res.company', string='Company', required=True, readonly=True)
    pricelist_id = fields.Many2one('product.pricelist', string='Pricelist', required=True, readonly=[('state', '!=', 'draft')])
    ...
    session_id = fields.Many2one(
        ...
        domain="[('state', '=', 'opened')]", readonly=[('state', '!=', 'draft')])
