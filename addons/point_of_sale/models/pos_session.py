...
LoaderContext = namedtuple('LoaderContext', ['data', 'contents', 'model', 'fields'])
...
class PosSession(models.Model):
    ...
    def load_pos_data(self):
        ...
        for model, methods, fields in LOADERS:
            ...
            for method in methods:
                getattr(self, method)(LoaderContext(data, data[model], model, fields))
    ...
    @loader("account.tax", ["name", "amount", "price_include", "include_base_amount", "amount_type", "children_tax_ids"])
