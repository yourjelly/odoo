...
class PosSession(models.Model):
    ...
    def _add_pos_taxes_computation(self, loaded_data):
        ...
        def tax_ids_as_taxes_key(tax_ids):
            return '-'.join(str(tax_id) for tax_id in sorted(tax_ids))

        tax_ids_to_taxes_key = {}
        ...
        for fiscal_position in fiscal_positions:
            for tax_ids, taxes_key in list(tax_ids_to_taxes_key.items()):
                ...
                new_tax_ids = tuple(new_taxes.ids)
                new_taxes_key = tax_ids_as_taxes_key(new_tax_ids)
                ...
                tax_ids_to_taxes_key[new_tax_ids] = new_taxes_key
        ...
        for tax_ids, taxes_key in tax_ids_to_taxes_key.items():
            ...
            taxes_computation['taxes_results'][taxes_key] = {
