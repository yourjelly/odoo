...
class PosSession(models.Model):
    ...
    def _create_cash_statement_lines_and_cash_move_lines(self, data):
        ...
        split_cash_statement_lines = BankStatementLine.create(split_cash_statement_line_vals).mapped('move_id.line_ids').filtered(lambda line: line.account_id.internal_type == 'receivable')
        combine_cash_statement_lines = BankStatementLine.create(combine_cash_statement_line_vals).mapped('move_id.line_ids').filtered(lambda line: line.account_id.internal_type == 'receivable')
