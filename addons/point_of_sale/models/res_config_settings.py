...
class ResConfigSettings(models.TransientModel):
    ...
    module_pos_preparation_display = fields.Boolean(string="Preparation Display", help="Show orders on the preparation display screen.", related='pos_config_id.module_pos_restaurant')
