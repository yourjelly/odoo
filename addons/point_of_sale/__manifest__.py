...

{
    ...
    "demo": ["data/point_of_sale_demo.xml",],
    "installable": True,
    "application": True,
    "website": "https://www.odoo.com/app/point-of-sale-shop",
    "assets": {
        "web.assets_tests": ["point_of_sale/static/tests/tours/**/*",],
        ...
        "point_of_sale.pos_assets_backend_style": ["web/static/src/core/ui/**/*.scss",],
        ...
        "web.assets_qweb": ["point_of_sale/static/src/xml/**/*",],
    },
}
