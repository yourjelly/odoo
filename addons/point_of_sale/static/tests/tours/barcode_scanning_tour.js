...
registry.category("web_tour.tours").add("BarcodeScanningTour", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.isSelectedOrderlineHas("Monitor Stand"),
            ProductScreen.scan_barcode("0123456789"),
            ProductScreen.isSelectedOrderlineHas("Monitor Stand", 2),

            // Test "Prices product" EAN-13 `23.....{NNNDD}` barcode pattern
            ProductScreen.scan_ean13_barcode("2305000000004"),
            ProductScreen.isSelectedOrderlineHas("Magnetic Board", 1, "0.00"),
            ProductScreen.scan_ean13_barcode("2305000123451"),
            ProductScreen.isSelectedOrderlineHas("Magnetic Board", 1, "123.45"),

            // Test "Weighted product" EAN-13 `21.....{NNDDD}` barcode pattern
            ProductScreen.scan_ean13_barcode("2100005000000"),
            ProductScreen.isSelectedOrderlineHas("Wall Shelf Unit", 0, "0.00"),
            ProductScreen.scan_ean13_barcode("2100005080002"),
            ProductScreen.isSelectedOrderlineHas("Wall Shelf Unit", 8),
            Chrome.endTour(),
        ].flat(),
});
...
registry.category("web_tour.tours").add("BarcodeScanningProductPackagingTour", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.isSelectedOrderlineHas("Packaging Product", 1),
            ProductScreen.scan_barcode("12345601"),
            ProductScreen.isSelectedOrderlineHas("Packaging Product", 2),

            // Add the product packaging with its barcode
            ProductScreen.scan_barcode("12345610"),
            ProductScreen.isSelectedOrderlineHas("Packaging Product", 12),
            ProductScreen.scan_barcode("12345610"),
            ProductScreen.isSelectedOrderlineHas("Packaging Product", 22),
            Chrome.endTour(),
        ].flat(),
});
...
registry.category("web_tour.tours").add("GS1BarcodeScanningTour", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.isSelectedOrderlineHas("Product 1"),
            ProductScreen.scan_barcode("0108431673020125100000001"),
            ProductScreen.isSelectedOrderlineHas("Product 1", 2),

            // Add the Product 2 with normal barcode
            ProductScreen.scan_barcode("08431673020126"),
            ProductScreen.isSelectedOrderlineHas("Product 2"),
            ProductScreen.scan_barcode("08431673020126"),
            ProductScreen.isSelectedOrderlineHas("Product 2", 2),

            // Add the Product 3 with normal barcode
            ProductScreen.scan_barcode("3760171283370"),
            ProductScreen.isSelectedOrderlineHas("Product 3"),
            ProductScreen.scan_barcode("3760171283370"),
            ProductScreen.isSelectedOrderlineHas("Product 3", 2),
            Chrome.endTour(),
        ].flat(),
});
