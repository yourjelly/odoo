...
registry.category("web_tour.tours").add("ProductScreenTour", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.isSelectedOrderlineHas("Letter Tray", "1.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Letter Tray", "0.0", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "3", "15.30"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "0.0", "0.0"),
            ProductScreen.clickNumpad("1"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "1.0", "5.1"),
            ProductScreen.clickNumpad("2"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "12.0", "61.2"),
            ProductScreen.clickNumpad("3"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "123.0", "627.3"),
            ProductScreen.clickNumpad(".", "5"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "123.5", "629.85"),
            ProductScreen.clickNumpad("Price"),
            ProductScreen.isModeActiveIs("Price"),
            ProductScreen.clickNumpad("1"),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "123.5", "123.5"),
            ProductScreen.clickNumpad("1", "."),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "123.5", "1,358.5"),
            ProductScreen.clickNumpad("% Disc"),
            ProductScreen.isModeActiveIs("% Disc"),
            ProductScreen.clickNumpad("5", "."),
            ProductScreen.isSelectedOrderlineHas("Desk Organizer", "123.5", "1,290.58"),
            ...
            ProductScreen.isProductDisplayed("Whiteboard Pen"),
            ProductScreen.goBackToMainScreen(),
            ProductScreen.clickSubcategory("Chair test"),
            ProductScreen.isProductDisplayed("Letter Tray"),
            ProductScreen.goBackToMainScreen(),
            ProductScreen.clickSubcategory("Chair test"),
            ProductScreen.goBackToMainScreen(),
            ...
            ProductScreen.clickNumpad("2"),
            ProductScreen.isSelectedOrderlineHas("Whiteboard Pen", "2.0"),
            ProductScreen.clickOrderline("Wall Shelf Unit", "1.0"),
            ProductScreen.clickNumpad("2"),
            ProductScreen.isSelectedOrderlineHas("Wall Shelf Unit", "2.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Wall Shelf Unit", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Whiteboard Pen", "2.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Whiteboard Pen", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isOrderEmpty(),
            ...
            ProductScreen.isSelectedOrderlineHas("Whiteboard Pen", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Monitor Stand", "1.0"),
            ProductScreen.clickOrderline("Wall Shelf Unit", "1.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Wall Shelf Unit", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ...
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Small Shelf", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Monitor Stand", "1.0"),
            ProductScreen.clickOrderline("Magnetic Board", "1.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Magnetic Board", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Monitor Stand", "1.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isSelectedOrderlineHas("Monitor Stand", "0.0"),
            ProductScreen.clickNumpad("⌫"),
            ProductScreen.isOrderEmpty(),
...
registry.category("web_tour.tours").add("FiscalPositionNoTax", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.isNoDiscountApplied("100.00"),
