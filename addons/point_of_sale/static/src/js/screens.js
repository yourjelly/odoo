    ...
    save_changes: function(){
        ...
        if( this.has_client_changed() ){
            if ( this.new_client ) {
                ...
                order.pricelist = _.findWhere(this.pos.pricelists, {'id': this.new_client.property_product_pricelist[0]}) || this.pos.default_pricelist;
            } else {
                order.fiscal_position = undefined;
                order.pricelist = this.pos.default_pricelist;
            }
