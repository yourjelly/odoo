...
export class PosOrderline extends Base {
    ...
    getPackLotLinesToEdit(isAllowOnlyOneLot) {
        ...
        const tempLines = currentPackLotLines
            .map((lotLine) => ({
                id: lotLine.cid, // FIXME cid do not exist on this records, maybe add an uuid field ?
    ...
    getDisplayData() {
        return {
            ...
            oldUnitPrice: formatCurrency(this.get_old_unit_display_price(), this.currency),
