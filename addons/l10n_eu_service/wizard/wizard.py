...
class l10n_eu_service(models.TransientModel):
    ...
    def _default_done_country_ids(self):
        ...
        return (
            ...
            - user.company_id.account_fiscal_country_id
        )
    ...
    def load_views(self, views, options=None):
        ...
        raise UserError(
            _(
                "Starting July 1st 2021, OSS regulation has replaced MOSS. Please first upgrade 'l10n_eu_service' module in the Apps menu, then go back to this setting and click on 'Refresh tax mapping'."
            )
        )
        ...
        return [
            (
                ...
                0,
                {
                    ...
                    and (self.account_collected_id.id or line.account_id.id)
                    or None,
    ...
    def generate_eu_service(self):
        ...
        for country in self.todo_country_ids:
            ...
            data_tax = {
                ...
                "invoice_repartition_line_ids": self._get_repartition_line_copy_values(
                    self.tax_id.invoice_repartition_line_ids
                ),
                "refund_repartition_line_ids": self._get_repartition_line_copy_values(
                    self.tax_id.refund_repartition_line_ids
                ),
                "type_tax_use": "sale",
            ...
            data_fiscal = {
                ...
                "tax_ids": [
                    (0, 0, {"tax_src_id": self.tax_id.id, "tax_dest_id": tax.id})
                ],
            }
