# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'assets_frontend': [
            ...
            ('prepend', 'sale_product_configurator/static/src/js/product_configurator_modal.js'),
            # before script[contains(@src, '/website_sale/static/src/js/website_sale.js')]
            ('prepend', 'website_sale_product_configurator/static/src/js/product_configurator_modal.js'),
            # after link[last()]
