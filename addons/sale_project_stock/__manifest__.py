...

{
    ...
    'summary': 'Access full traceability of inventory operations related to the sales order associated with the analytic account of your projects in your profitability report.',
    'license': 'LGPL-3',
    'category': 'Project',
