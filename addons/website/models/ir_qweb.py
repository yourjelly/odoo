...
class IrQWeb(models.AbstractModel):
    ...
    def _prepare_frontend_environment(self, values):
        ...
        editable = request.env.user._has_group('website.group_website_designer')
        ...
        has_group_restricted_editor = irQweb.env.user._has_group('website.group_website_restricted_editor')
        if has_group_restricted_editor and irQweb.env.user._has_group('website.group_multi_website'):
