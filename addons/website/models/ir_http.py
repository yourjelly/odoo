...
class Http(models.AbstractModel):
    ...
    def _is_allowed_cookie(cls, cookie_type, cookie_name='undefined'):
        ...
        if result and cookie_type == 'optional':
            accepted_cookie_types = json_scriptsafe.loads(request.httprequest.cookies.get('accepted_cookie_types', '{}'))
            if 'optional' in accepted_cookie_types:
                return accepted_cookie_types['optional']
            return not request.env['website'].get_current_website().cookies_bar
