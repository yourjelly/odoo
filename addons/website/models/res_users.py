...
class ResUsers(models.Model):
    ...
    def authenticate(cls, db, login, password, user_agent_env):
        ...
        visitor (user one). Purpose is to try to keep a main visitor linked to
        a user without unlinking / deactivating other visitors as we may need
        them notably for push notifications. """
            ...
            with cls.pool.cursor() as cr:
                ...
                if visitor_sudo:
                    ...
                    if other_user_visitor_sudo:
                        ...
                        (visitor_sudo + other_visitors)._link_to_visitor(visitor_main, unlink=False)
