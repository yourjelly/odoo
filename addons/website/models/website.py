...
class Website(models.Model):
    ...
    def configurator_init(self):
        ...
        configurator_features = self.env['website.configurator.feature'].with_context(lang=self.env.context.get('lang')).search([])
        r['features'] = [{
            'id': feature.id,
            'name': feature.name,
    ...
    def get_client_action_url(self, url, mode_edit=False):
        client_action_url = f'/web#action=website.website_preview&path={url}'
        if mode_edit:
