...
class Website(models.Model):
        ...
        for model_name, field_name in html_fields:
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/web#id={rec.id}&view_type=form&model={model_name}',
    ...
    def _get_html_fields(self):
        # TODO cwg: check if we can use iter the registry
        # if it is too slow maybe orm cache the result
