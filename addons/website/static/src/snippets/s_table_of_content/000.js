...
export class TableOfContent extends Component {
    ...
    setup() {
        ...
        this.scrollElement = closestScrollable(this.el.closest(".s_table_of_content"));
...
registry.category("website.active_elements").add("website.tableOfContent", TableOfContent);
