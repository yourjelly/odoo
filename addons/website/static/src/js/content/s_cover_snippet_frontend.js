odoo.define('website.s_cover_snippet_frontend', function (require) {
    'use strict';

    var sAnimation = require('website.content.snippets.animation');

    // MEDIABLOCK EDITOR
    sAnimation.registry.video_options = sAnimation.Class.extend({
        selector : "section.s_cover_snippet",
