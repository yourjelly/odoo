...
options.registry.masonry_display = options.Class.extend({
    xmlDependencies: (options.Class.xmlDependencies || []).concat(
    ...
    editLayout: function (previewMode, widgetValue, params) {
        ...
        const $template = $(qweb.render(`website.s_template_masonry.${widgetValue}`, {
            websiteId: websiteId,
        }));
