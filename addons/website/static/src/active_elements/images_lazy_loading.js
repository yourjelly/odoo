...
import { onceAllImagesLoaded } from "@website/active_elements/utils";
/**
 ...
 */
export class ImagesLazyLoading extends Component {
    ...
    setup() {
        ...
        for (const imgEl of imgEls) {
            ...
            onceAllImagesLoaded(imgEl).then(() => {
                if (this.isDestroyed) {
                    return;
                }
...
registry.category("website.active_elements").add("website.imagesLazyLoading", ImagesLazyLoading);
