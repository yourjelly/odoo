...
registerWebsitePreviewTour('snippet_social_media', {
    ...
    },
    {
        ...
        trigger: ':iframe .s_social_media:has(a:eq(0)[href="https://twitter.com"])',
    },
    {
    ...
    ...addNewSocialNetwork(9, 8, 'https://instagr.am/odoo.official/'),
    {
        ...
        trigger: ":iframe .s_social_media" +
                 ":has(a:eq(0)[href='https://twitter.com'])" +
                 ":has(a:eq(1)[href='https://www.linkedin.com'])" +
                 ":has(a:eq(2)[href='https://www.youtube.com'])" +
                 ":has(a:eq(3)[href='https://www.instagram.com'])" +
                 ":has(a:eq(4)[href='https://www.github.com'])" +
                 ":has(a:eq(5)[href='https://www.tiktok.com'])" +
    ...
    },
    {
        ...
        trigger: ":iframe .s_social_media" +
                 ...
                 ":has(a:eq(4)[href='https://www.github.com'])" +
                 ":has(a:eq(5)[href='https://www.tiktok.com'])" +
                 ":has(a:eq(6)[href='https://www.facebook.com'])" +
                 ":has(a:eq(7)[href='https://whatever.it/1EdSw9X']:has(i.fa-pencil))" +
                 ":has(a:eq(8)[href='https://instagr.am/odoo.official/']:has(i.fa-instagram))",
    },
    {
