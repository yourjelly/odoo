...

{
    ...
    'new_page_templates': {
        'about': {
            '0': ['s_banner', 's_text_block', 's_three_columns', 's_company_team', 's_quotes_carousel'],
            '1': ['s_picture', 's_showcase', 's_three_columns', 's_company_team', 's_quotes_carousel'],
            '2': ['s_banner', 's_three_columns', 's_showcase', 's_company_team', 's_quotes_carousel'],
            '3': ['s_picture', 's_three_columns', 's_company_team', 's_quotes_carousel', 's_showcase'],
            '4': ['s_banner', 's_text_block', 's_three_columns', 's_quotes_carousel', 's_showcase'],
            '5': ['s_picture', 's_three_columns', 's_showcase', 's_quotes_carousel', 's_company_team'],
        },
        'landing': {
            '0': ['s_cover', 's_features', 's_call_to_action', 's_media_list'],
            '1': ['s_parallax', 's_showcase', 's_quotes_carousel', 's_call_to_action'],
            '2': ['s_cover', 's_parallax', 's_media_list', 's_quotes_carousel'],
            '3': ['s_cover', 's_features', 's_media_list', 's_quotes_carousel', 's_showcase'],
            '4': ['s_carousel', 's_quotes_carousel', 's_call_to_action', 's_media_list'],
            '5': ['s_cover', 's_features', 's_media_list', 's_parallax', 's_quotes_carousel'],
        },
        'gallery': {
            '0': ['s_image_gallery', 's_carousel', 's_quotes_carousel', 's_images_wall'],
            '1': ['s_masonry_block', 's_carousel', 's_quotes_carousel', 's_images_wall'],
            '2': ['s_image_gallery', 's_masonry_block', 's_carousel', 's_quotes_carousel'],
            '3': ['s_carousel', 's_images_wall', 's_quotes_carousel', 's_masonry_block'],
            '4': ['s_images_wall', 's_image_text', 's_text_image', 's_image_gallery'],
            '5': ['s_image_gallery', 's_masonry_block', 's_images_wall', 's_carousel'],
        },
        'services': {
            '0': ['s_banner', 's_text_image', 's_features', 's_showcase', 's_three_columns'],
            '1': ['s_text_image', 's_three_columns', 's_showcase', 's_features', 's_media_list'],
            '2': ['s_banner', 's_text_image', 's_features', 's_three_columns', 's_quotes_carousel'],
            '3': ['s_banner', 's_three_columns', 's_features', 's_product_catalog', 's_showcase'],
            '4': ['s_text_image', 's_showcase', 's_tabs', 's_features', 's_three_columns'],
            '5': ['s_banner', 's_three_columns', 's_showcase', 's_product_catalog', 's_features'],
        },
        'pricing': {
            '0': ['s_title', 's_numbers', 's_color_blocks_2', 's_features', 's_comparisons', 's_showcase'],
            '1': ['s_title', 's_numbers', 's_color_blocks_2', 's_product_catalog', 's_features', 's_showcase'],
            '2': ['s_title', 's_numbers', 's_color_blocks_2', 's_features', 's_comparisons', 's_media_list'],
            '3': ['s_title', 's_numbers', 's_comparisons', 's_features', 's_product_catalog', 's_showcase'],
            '4': ['s_title', 's_numbers', 's_product_catalog', 's_features', 's_showcase', 's_media_list'],
            '5': ['s_title', 's_numbers', 's_comparisons', 's_product_catalog', 's_features', 's_showcase'],
        },
        'team': {
            '0': ['s_banner', 's_three_columns', 's_company_team', 's_quotes_carousel', 's_showcase', 's_media_list'],
            '1': ['s_carousel', 's_media_list', 's_three_columns', 's_company_team', 's_showcase', 's_quotes_carousel'],
            '2': ['s_banner', 's_three_columns', 's_company_team', 's_carousel', 's_media_list', 's_quotes_carousel'],
            '3': ['s_three_columns', 's_company_team', 's_quotes_carousel', 's_showcase', 's_carousel', 's_media_list'],
            '4': ['s_banner', 's_text_block', 's_three_columns', 's_company_team', 's_media_list', 's_showcase'],
            '5': ['s_picture', 's_three_columns', 's_company_team', 's_quotes_carousel', 's_showcase', 's_media_list'],
        },
    },
    'license': 'LGPL-3',
}
