...

{
    ...
    'assets': {
        ...
        'website.assets_editor': [
            ...
            'web/static/src/scss/pre_variables.scss',
            'web/static/lib/bootstrap/scss/_variables.scss',
            'website/static/src/components/ace_editor/**/*',
            'website/static/src/components/ace_warning/ace_warning.js',
            'website/static/src/components/ace_warning/ace_warning.xml',
