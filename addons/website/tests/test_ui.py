...
class TestUi(odoo.tests.HttpCase):
    ...
    def test_02_restricted_editor(self):
        ...
        self.start_tour("/web", 'restricted_editor', login='restricted')
    ...
    def test_08_website_style_custo(self):
        self.start_tour("/web", "website_style_edition", login="admin")
    ...
    def test_14_carousel_snippet_content_removal(self):
        self.start_tour("/web", "carousel_content_removal", login='admin')
