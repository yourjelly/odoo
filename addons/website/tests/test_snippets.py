...
class TestSnippets(HttpCase):
    ...
    def test_01_empty_parents_autoremove(self):
        self.start_tour("/web", "snippet_empty_parent_autoremove", login='admin')
    ...
    def test_03_snippets_all_drag_and_drop(self):
        ...
        self.start_tour("/web#action=website.website_editor&%s" % path, "snippets_all_drag_and_drop", login='admin', timeout=300)

    def test_04_countdown_preview(self):
        self.start_tour("/web", "snippet_countdown", login='admin')

    def test_05_social_media(self):
        self.start_tour("/web", 'snippet_social_media', login="admin")
        self.assertEqual(
    ...
    def test_06_snippet_popup_add_remove(self):
        self.start_tour('/web', 'snippet_popup_add_remove', login='admin')
