...
class TestCowViewSaving(TestViewSavingCommon):
    ...
    def test_cow_generic_view_with_already_existing_specific(self):
        ...
        base_view = View.create(
            {"name": "Base", "type": "qweb", "arch": "<div>content</div>",}
        )
        ...
        second_view = View.create({"name": "Base", "type": "qweb", "arch": view_arch,})
    ...
    def test_module_new_inherit_view_on_parent_already_forked(self):
        ...
        View._load_records(
            [
                dict(
                    xml_id="_website_sale_comparison.product_add_to_compare",
                    values={"website_id": None, "inherit_id": random_views[0].id,},
                )
            ]
        )
        ...
        View._load_records(
            [
                dict(
                    xml_id="_website_sale_comparison.product_add_to_compare",
                    values={"inherit_id": random_views[0].id,},
                )
            ]
        )
        self.assertEqual(
    ...
    def test_specific_view_module_update_inherit_change(self):
        ...
        View._load_records(
            [dict(xml_id=self.inherit_view.key, values={"inherit_id": base_view_2.id,})]
        )
