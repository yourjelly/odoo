...
class TestAccountBankStatement(common.TransactionCase):
    ...
    def test_account_bank_statement_def(self):
        ...
        self.journal = self.AccBankState.with_context({'lang': u'en_US', 'tz': False, 'active_model': 'ir.ui.menu', 'journal_type': 'bank', 'journal_id': 10, 'date': time.strftime("%Y/%m/%d")})._default_journal()
