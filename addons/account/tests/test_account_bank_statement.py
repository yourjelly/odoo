...
class TestAccountBankStatement(TestAccountBankStatementCommon):
    ...
    def test_cash_statement_with_difference(self):
        ...
        self.assertRecordValues(
            statement.line_ids, [{"amount": 100.0, "is_reconciled": True,}]
        )
...
class TestAccountBankStatementLine(TestAccountBankStatementCommon):
    ...
    def _test_statement_line_edition(
        ...
        self.assertRecordValues(
            statement_line, [{"amount": amount, "amount_currency": amount_currency,}]
        )
        self.assertRecordValues(
        ...
        self.assertRecordValues(
            statement_line,
            [{"amount": amount * 2, "amount_currency": amount_currency * 2,}],
        )
        self.assertRecordValues(
            liquidity_lines,
            [
    ...
    def test_constraints(self):
        ...
        assertStatementLineConstraint(
            statement_vals,
            {**statement_line_vals, "foreign_currency_id": self.currency_1.id,},
        )

        # Can't have a stand alone amount in foreign currency without foreign currency set.
        assertStatementLineConstraint(
            statement_vals, {**statement_line_vals, "amount_currency": 10.0,}
        )
    ...
    def test_reconciliation_statement_line_state(self):
        ...
        self.assertBankStatementLine(
            self.statement_line,
            {**self.expected_st_line, "is_reconciled": True,},
            [
                {
