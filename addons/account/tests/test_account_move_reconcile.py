...
class TestAccountMoveReconcile(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.fake_country = cls.env["res.country"].create(
            {"name": "The Island of the Fly", "code": "YY",}
        )
            ...
            [
                {
                    ...
                    "line_ids": [
                        ...
                        (
                            0,
                            0,
                            {"debit": 0.0, "credit": 2160.0, "account_id": account_id,},
                        ),
                    ],
                },
                {
                    ...
                    "line_ids": [
                        ...
                        (
                            0,
                            0,
                            {"debit": 2160.0, "credit": 0.0, "account_id": account_id,},
                        ),
                    ],
                },
            ]
    ...
    def test_reconcile_cash_basis_tax_grid_refund(self):
        ...
        tax_cash_basis_moves = res["tax_cash_basis_moves"].sorted(
            lambda move: move.tax_cash_basis_move_id.id
        )
