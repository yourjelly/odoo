...
class TestAccountMoveMultiCurrency(AccountTestInvoicingCommon):
    ...
    def _test_no_currency(self, invoice):
        self.assertInvoiceValues(invoice, [
            {'debit': 0.0,      'credit': 2400.0,   'amount_currency': 0.0,     'currency_id': False},
            {'debit': 0.0,      'credit': 360.0,    'amount_currency': 0.0,     'currency_id': False},
            {'debit': 2760.0,   'credit': 0.0,      'amount_currency': 0.0,     'currency_id': False},
        ], {
