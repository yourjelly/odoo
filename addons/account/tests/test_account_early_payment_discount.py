...
class TestAccountEarlyPaymentDiscount(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.pay_term_8th_day_following_month = cls.env['account.payment.term'].create({
            'name': '8th day of the following month',
            'has_early_payment': True,
            'discount_time_availability': 'day_following_month',
            'discount_days': 8,
            'line_ids': [
                (0, 0, {
                    'value': 'balance',
        ...
        cls.pay_term_15th_day_current_month = cls.env['account.payment.term'].create({
            'name': '15th day of the current month',
            'has_early_payment': True,
            'discount_time_availability': 'day_current_month',
            'discount_days': 15,
            'line_ids': [
                (0, 0, {
                    'value': 'balance',
        ...
        cls.pay_term_cash_discount_10_percent_10_days_after_inv_month_tax_inc = cls.env['account.payment.term'].create({
            'name': '10% reduction if payment within 10 days after the invoice month, tax included',
            'has_early_payment': True,
            'discount_days': 10,
            'discount_time_availability': 'days_after_invoice_month',
        ...
        cls.pay_term_cash_discount_10_percent_10_days_after_inv_month_tax_excl = cls.env['account.payment.term'].create({
            'name': '10% reduction if payment within 10 days after the invoice month, tax ecluded',
            'has_early_payment': True,
            'discount_days': 10,
            'discount_time_availability': 'days_after_invoice_month',
            'percentage_to_discount': 10,
        ...
        cls.inv_1200_10_percents_discount_no_tax = cls.env['account.move'].create({
            ...
            'invoice_payment_term_id': cls.pay_term_cash_discount_10_percent_10_days_after_inv_month_tax_inc,
        })
        cls.inv_1500_10_percents_discount_tax_incl_15_percents_tax = cls.env['account.move'].create({
            ...
            'invoice_line_ids': [(0, 0, {
                'name': 'line',
                'price_unit': 1500.0,
                'tax_ids': cls.product_a.taxes_id.ids,# 15%
            })],
            'invoice_payment_term_id': cls.pay_term_cash_discount_10_percent_10_days_after_inv_month_tax_inc,
        })
        cls.inv_1500_10_percents_discount_tax_excl_15_percents_tax = cls.env['account.move'].create({
            ...
            'invoice_payment_term_id': cls.pay_term_cash_discount_10_percent_10_days_after_inv_month_tax_excl,
        })
        ...
        cls.out_invoice_2 = cls.env['account.move'].create({
            ...
            'invoice_payment_term_id': cls.default_pay_term_cash_discount,
        })
        ...
        cls.out_invoice_4_no_discount = cls.env['account.move'].create({
            ...
            'partner_id': cls.partner_b.id,
            'currency_id': cls.currency_data['currency'].id,
            'invoice_line_ids': [(0, 0, {'product_id': cls.product_a.id, 'price_unit': 5000.0})],
        })
    ...
    def test_early_payment_assert_default_values(self):
        ...
        self.assertRecordValues(self.default_pay_term_cash_discount, [{
            ...
            'discount_days': 7,
            'discount_time_availability': 'days_after_invoice_date',
    ...
    def test_early_payment_end_date(self):
        ...
        assertEarlyDiscountPaymentTermDate(self.pay_term_cash_discount_10_percent_10_days_after_inv_month_tax_inc, '2022-02-25', '2022-03-10')
        assertEarlyDiscountPaymentTermDate(self.pay_term_8th_day_following_month, '2022-02-25', '2022-03-08')
        assertEarlyDiscountPaymentTermDate(self.pay_term_8th_day_following_month, '2022-02-25', '2022-03-08')
