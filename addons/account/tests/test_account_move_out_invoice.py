...
class TestAccountMoveOutInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_out_invoice_line_onchange_partner_1(self):
        ...
        self.assertInvoiceValues(
            self.invoice,
            [
                {**self.product_line_vals_1, "partner_id": self.partner_b.id,},
                {**self.product_line_vals_2, "partner_id": self.partner_b.id,},
                {**self.tax_line_vals_1, "partner_id": self.partner_b.id,},
                {**self.tax_line_vals_2, "partner_id": self.partner_b.id,},
                {
                    **self.term_line_vals_1,
                    "name": "turlututu",
    ...
    def test_out_invoice_line_onchange_rounding_price_subtotal_1(self):
        ...
        def check_invoice_values(invoice):
            self.assertInvoiceValues(
                ...
                {"amount_untaxed": 0.03, "amount_tax": 0.0, "amount_total": 0.03,},
            )
    ...
    def test_out_invoice_line_onchange_rounding_price_subtotal_2(self):
        ...
        def check_invoice_values(invoice):
            self.assertInvoiceValues(
                ...
                {"amount_untaxed": 82.64, "amount_tax": 17.36, "amount_total": 100.0,},
            )
    ...
    def test_out_invoice_line_onchange_currency_1(self):
        ...
        self.assertInvoiceValues(
            ...
            {**self.move_vals, "currency_id": self.currency_data["currency"].id,},
        )
    ...
    def test_out_invoice_create_refund_auto_post(self):
        ...
        self.assertRecordValues(refund, [{"state": "draft", "auto_post": True,}])
        ...
        move = self.env["account.move"].create(
            {
                ...
                "currency_id": self.currency_data["currency"].id,
                "invoice_payment_term_id": self.pay_terms_a.id,
                "invoice_line_ids": [(0, None, self.product_line_vals_1),],
            }
        )
        move.write({"invoice_line_ids": [(0, None, self.product_line_vals_2),]})
    ...
    def test_out_invoice_switch_out_refund_2(self):
        ...
        modified_product_line_vals_1.update(
            {"quantity": -modified_product_line_vals_1["quantity"]}
        )
        modified_product_line_vals_2 = self.product_line_vals_2.copy()
        modified_product_line_vals_2.update(
            {"quantity": -modified_product_line_vals_2["quantity"]}
        )
        move = self.env["account.move"].create(
            {
                "move_type": "out_invoice",
    ...
    def test_out_invoice_multi_company(self):
        ...
        def _check_invoice_values(invoice):
            self.assertInvoiceValues(
                ...
                {"amount_untaxed": 1000.0, "amount_total": 1000.0,},
            )
        ...
        invoice_create = self.env["account.move"].create(
            {
                ...
                "invoice_line_ids": [
                    (0, 0, {"product_id": product.id, "price_unit": 1000.0,})
                ],
            }
        )
