...
class TestAccountMoveOutInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_post_valid_invoices_when_auto_post(self):
        ...
        invalid_invoice_2 = self.env['account.move'].create({
            'move_type': 'out_invoice',
            'invoice_date': '2023-01-01',
            'date': '2023-01-01',
            'partner_id': self.partner_a.id,
        ...
        for move in [valid_invoice, invalid_invoice_1, invalid_invoice_2]:
        ...
        self.assertEqual(invalid_invoice_1.message_ids[1].child_ids.preview,
                         "The move could not be posted: The field 'Customer' is required, please complete it to validate the Customer Invoice.")
        self.assertEqual(invalid_invoice_2.state, 'draft')
        self.assertEqual(invalid_invoice_2.message_ids[1].child_ids.preview,
                         'The move could not be posted: You need to add a line before posting.')
