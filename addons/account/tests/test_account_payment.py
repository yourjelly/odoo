...
class TestAccountPayment(AccountTestInvoicingCommon):
    ...
    def test_payment_move_sync_create_write(self):
        ...
        self.assertRecordValues(
            ...
            [expected_counterpart_line, expected_liquidity_line,],
        )
        ...
        self.assertRecordValues(
            payment.move_id,
            [{**expected_move_values, "partner_id": self.partner_b.id,}],
        )
        self.assertRecordValues(
            payment.line_ids.sorted("balance"),
            [
    ...
    def test_inbound_payment_sync_writeoff_debit_sign(self):
        ...
        self.assertRecordValues(
            payment,
            [{"payment_type": "inbound", "partner_type": "customer", "amount": 100.0,}],
        )
    ...
    def test_internal_transfer(self):
        ...
        self.assertRecordValues(
            payment.move_id,
            [{**expected_move_values, "partner_id": self.partner_a.id,}],
        )
        self.assertRecordValues(
            payment.line_ids.sorted("balance"),
            [
                {**expected_counterpart_line, "account_id": copy_receivable.id,},
                expected_liquidity_line,
            ],
        )
        ...
        self.assertRecordValues(
            ...
            [expected_liquidity_line, expected_counterpart_line,],
        )
    ...
    def test_compute_currency_id(self):
        ...
        self.assertRecordValues(
            payment, [{"currency_id": self.currency_data["currency"].id,}]
        )
        self.assertRecordValues(
            payment.move_id, [{"currency_id": self.currency_data["currency"].id,}]
        )
        self.assertRecordValues(
            payment.line_ids.sorted("balance"),
            [
    ...
    def test_reconciliation_payment_states(self):
        ...
        self.assertRecordValues(
            payment, [{"is_reconciled": False, "is_matched": False,}]
        )
        ...
        self.assertRecordValues(
            payment, [{"is_reconciled": True, "is_matched": False,}]
        )
        ...
        self.assertRecordValues(payment, [{"is_reconciled": True, "is_matched": True,}])
