...
class TestTaxCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.fixed_tax = cls.env["account.tax"].create(
            {"name": "Fixed tax", "amount_type": "fixed", "amount": 10, "sequence": 1,}
        )
        ...
        cls.tax_0_percent = (
            ...
            .create({"name": "test_0_percent", "amount_type": "percent", "amount": 0,})
        )

        cls.tax_5_percent = (
            cls.env["account.tax"]
            .with_company(cls.company_data["company"])
            .create({"name": "test_5_percent", "amount_type": "percent", "amount": 5,})
        )

        cls.tax_8_percent = (
            cls.env["account.tax"]
            .with_company(cls.company_data["company"])
            .create({"name": "test_8_percent", "amount_type": "percent", "amount": 8,})
        )
        cls.tax_12_percent = (
            cls.env["account.tax"]
            .with_company(cls.company_data["company"])
            .create(
                {"name": "test_12_percent", "amount_type": "percent", "amount": 12,}
            )
        )
        ...
        cls.tax_19_percent = (
            ...
            .create(
                {"name": "test_19_percent", "amount_type": "percent", "amount": 19,}
            )
        )
        ...
        cls.tax_21_percent = (
            ...
            .with_company(cls.company_data["company"])
            .create(
                {"name": "test_21_percent", "amount_type": "percent", "amount": 19,}
            )
        )
