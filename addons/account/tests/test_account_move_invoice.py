...
class TestAccountMove(SavepointCase):
    ...
    def test_out_invoice_line_onchange_product(self):
        ...
        self.assertRecordValues(move.line_ids.sorted('credit'), [
            {
                'name': '/',
                'product_id': False,
    ...
    def test_out_invoice_line_onchange_discount(self):
        ...
        self.assertRecordValues(move.invoice_line_ids.sorted('discount'), [
            {
                'name': 'product_a',
                'product_id': self.product_a.id,
                'account_id': self.parent_acc_revenue_1.id,
        ...
        self.assertRecordValues(move.line_ids.sorted(lambda line: (line.discount, line.credit)), [
            {
                'name': '/',
                'product_id': False,
                'account_id': self.parent_acc_receivable_1.id,
    ...
    def test_out_invoice_line_advance_edition_custom_aml(self):
        ...
        self.assertRecordValues(move.line_ids.sorted('price_unit'), [
            {
                'name': '/',
                'product_id': False,
                'account_id': self.parent_acc_receivable_1.id,
