...
class AccountTestInvoicingCommon(TransactionCase):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.outbound_payment_method_line = bank_journal.outbound_payment_method_line_ids[
            0
        ]
    ...
    def setup_company_data(cls, company_name, chart_template=None, **kwargs):
        ...
        company = cls.env["res.company"].create({"name": company_name, **kwargs,})
...
class TestAccountReconciliationCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.cash_basis_journal = cls.env["account.journal"].create(
            {"name": "Test CABA", "code": "tCABA", "type": "general",}
        )
