...
class TestReconciliationMatchingRules(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.tax21 = cls.env["account.tax"].create(
            {"name": "21%", "type_tax_use": "purchase", "amount": 21,}
        )

        cls.tax12 = cls.env["account.tax"].create(
            {"name": "12%", "type_tax_use": "purchase", "amount": 12,}
        )
    ...
    def test_auto_reconcile_with_duplicate_match(self):
        ...
        self.rule_1.write(
            {"auto_reconcile": True, "match_partner_ids": [(5, 0, 0)],}
        )
    ...
    def test_reverted_move_matching(self):
        ...
        self.bank_line_1.write(
            {"payment_ref": "8", "partner_id": partner.id, "amount": -10,}
        )
        self._check_statement_matching(
            self.rule_1,
            {
    ...
    def test_invoice_matching_rule_no_partner(self):
        ...
        self.bank_line_1.write(
            {"payment_ref": "Tournicoti66", "partner_id": None, "amount": 95,}
        )
    ...
    def test_inv_matching_rule_auto_rec_no_partner_with_writeoff(self):
        ...
        self.bank_line_1.write(
            {"payment_ref": "doudlidou355", "partner_id": None, "amount": 95,}
        )
    ...
    def test_avoid_amount_matching_bypass(self):
        ...
        self.bank_line_2.write(
            {"payment_ref": self.invoice_line_2.move_id.payment_reference, "amount": 1,}
        )
    ...
    def test_payment_similar_communications(self):
        ...
        payment_partner = self.env["res.partner"].create({"name": "Bernard Gagnant",})
        ...
        self.bank_line_1.write(
            {"amount": 1000, "payment_ref": "a1b2c3", "partner_id": payment_partner.id,}
        )
