...
class TestReconciliationMatchingRules(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        st_lines = cls.env['account.bank.statement.line'].create([
            {
        ...
        cls.bank_line_1, cls.bank_line_2, cls.bank_line_3, cls.bank_line_4, cls.bank_line_5, cls.cash_line_1 = st_lines
        st_lines.button_post()
