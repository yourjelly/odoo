...
class TestTaxTotals(AccountTestInvoicingCommon):
    ...
    def test_consistency_round_globally_1(self):
        ...
        self.assertRecordValues(invoice, [{
            'amount_untaxed': invoice.tax_totals['amount_untaxed'],
            'amount_tax': invoice.tax_totals['groups_by_subtotal']['Untaxed Amount'][0]['tax_group_amount'],
            'amount_total': invoice.tax_totals['amount_total'],
        }])
