...
class AccountMove(models.Model):
    ...
    def _populate_factories(self):
        ...
        def search_partner_ids(company_id):
            return self.env['res.partner'].search([('company_id', '=?', company_id), ('id', 'in', self.env.registry.populated_models['res.partner'])]).ids
        ...
        def get_lines(random, values, **kwargs):
            ...
            lines = [get_line(
                ...
                label=i,
                balance_sign=balance_sign or (i % 2) or -1,
    ...
    def _populate(self, size):
        ...
        records.filtered(lambda r: r.date < fields.Date.today()).post()
        return records
