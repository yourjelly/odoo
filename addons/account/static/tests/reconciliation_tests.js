...
QUnit.module('account', {
    ...
    QUnit.test('Reconciliation partial', function (assert) {
        ...
        assert.ok( widget.$('button.btn-primary:not(hidden)').length, "should not display the reconcile button"); // FIXME
        assert.ok( widget.$('.text-danger:not(hidden)').length, "should display counterpart alert"); // FIXME
