...
export class ProductLabelSectionAndNoteListRender extends SectionAndNoteListRenderer {
    ...
    getActiveColumns(list) {
        ...
        const productCol = activeColumns.find((col) => this.productColumn.includes(col.name));
