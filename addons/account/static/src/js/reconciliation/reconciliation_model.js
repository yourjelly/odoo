...
var StatementModel = BasicModel.extend({
    ...
    reload: function() {
        ...
        self.lines = {};
        self.pagerIndex = 0;
        // whomever added this deserves to be spanked ! this is the model, it should have no ties with the DOM ! use either controller or renderer, or even better add stuff to the model to make this check
    ...
    updateProposition: function (handle, values) {
        ...
        if (!line.reconciliation_proposition.slice(0,-1).every(function(prop) {return prop.to_check == values.to_check;})) {
            ...
            // whomever added this deserves to be spanked ! this is the model, it should have no ties with the DOM ! use either controller or renderer, call the function that is bound to the click!
