...
class AccountMove(models.Model):
    ...
    def _prepare_invoice_aggregated_taxes(self, filter_invl_to_apply=None, filter_tax_values_to_apply=None, grouping_key_generator=None):
        ...
        self.env['account.tax']._split_base_lines_tax_details_per_repartition_lines(to_process, company)

        # Round according '_get_generation_dict_from_base_line' to avoid rounding issues when dealing with 'round_globally'.
        self.env['account.tax']._round_base_lines_tax_details(to_process, company)
