...
class AccountMove(models.Model):
    ...
    def _prepare_invoice_aggregated_taxes(self, filter_invl_to_apply=None, filter_tax_values_to_apply=None, grouping_key_generator=None):
        ...
        if tax_lines is not None:
            ...
            # There can be multiple tax lines with the same tax_repartition_line
            tax_line_map = {}
            ...
            for tax_repartition_line, tax_lines in tax_line_map.items():
                ...
                if round_per_line:
                    ...
                    # We later distribute this error too (in an additional rounding unit on some lines as far as possible)
                ...
                for tax_value_info in matched_tax_values_info:
                    ...
                    if tax_difference_error:
                        additional_difference = (tax_difference_error if tax_difference_error_sign * tax_difference_error < self.currency_id.rounding
                                                 else tax_difference_error_sign * self.currency_id.rounding)
                        tax_difference_error -= additional_difference
                        difference += additional_difference
