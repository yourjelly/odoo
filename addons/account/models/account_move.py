...
class AccountMove(models.Model):
    ...
    adjusting_entries_origin_move_type = fields.Selection(
        string="Adjusting Entries Origin Move Type",
        related="adjusting_entries_origin_move_id.move_type",
    )
    ...
    def open_adjusting_entry_origin_move(self):
        self.ensure_one()
        match self.adjusting_entries_origin_move_type:
            case 'in_invoice':
                move_name = 'Bill'
            case 'out_refund':
