...
class AccountMoveLine(models.Model):
    ...
    def _add_reconciliation_exchange_difference_fix_residual_lines_vals(self, exchange_diff_move_vals):
    ...
    def _add_reconciliation_exchange_difference_fix_cash_basis_lines_vals(self, exchange_diff_move_vals):
        ''' Generate the exchange difference values used to create the journal items
    ...
    def _create_reconciliation_exchange_difference_move(self):
        ...
        to_reconcile = self._add_reconciliation_exchange_difference_fix_residual_lines_vals(exchange_diff_move_vals)

        # Fix cash basis entries.
        is_cash_basis_needed = self[0].account_internal_type in ('receivable', 'payable')
        if is_cash_basis_needed:
            self._add_reconciliation_exchange_difference_fix_cash_basis_lines_vals(exchange_diff_move_vals)
