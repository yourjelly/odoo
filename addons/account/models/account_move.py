        ...
        if not recompute_tax_base_amount:
            for line in base_lines:
                ...
                line_ids_commands.append((1, line.id, {
                    ...
                    'tag_ids': [(6, 0, tax_reps.tag_ids.ids)],
                }))
...
class AccountMoveLine(models.Model):
    ...
    def _get_price_unit(self):
        ...
        if self.move_id.is_invoice(include_receipts=True):
            ...
            return self.amount_currency if self.currency_id else self.balance
    ...
    def _get_currency(self):
        # OVERRIDE
        self.ensure_one()
        return self.currency_id or self.move_id.company_id.currency_id
    ...
    def _is_refund_document(self):
        ...
        self.ensure_one()
        if self.move_id.is_invoice(include_receipts=True):
            return self.move_id.type in ('out_refund', 'in_refund')
        else:
