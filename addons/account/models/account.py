...
class AccountTax(models.Model):
    ...
    def _get_tax_grouping_key_from_base_line(self, line_vals, tax_vals):
        ...
        return {
            ...
            'analytic_tag_ids': [(6, 0, line_vals['analytic_tags'].ids if tax_vals['analytic'] else [])],
    ...
    def _get_tax_grouping_key_from_tax_line(self, line_vals):
        ...
        return {
            ...
            'tax_ids': [(6, 0, line_vals['taxes'].ids)],
            'tax_tag_ids': [(6, 0, line_vals['tax_tags'].ids)],
            'tax_id': (line_vals['group_tax'] or tax).id,
            'analytic_tag_ids': [(6, 0, line_vals['analytic_tags'].ids if tax.analytic else [])],
        ...
        :return: A dictionary in the following form:
            {
                ...
                'groups_by_subtotal':           A dictionary formed liked {'subtotal': groups_data}
