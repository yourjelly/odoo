...
class AccountBankStatementLine(models.Model):
    ...
    fiscal_date = fields.Boolean(string='Fiscal Year Date', default=True, help="Technical field set to True when reconciliation page open.")
    ...
    def get_move_lines_for_reconciliation_widget(self, partner_id=None, excluded_ids=None, str=False, offset=0, limit=None):
        ...
        """
        aml_recs = self.get_move_lines_for_reconciliation(partner_id=partner_id, excluded_ids=excluded_ids, str=str, offset=offset, limit=limit, additional_domain=[('date_maturity', '>=', self.company_id.account_opening_date)])
