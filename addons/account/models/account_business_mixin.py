...
class AccountBusinessMixin(models.AbstractModel):
    ...
    def _get_tax_grouping_key_from_base_line(self, business_vals, tax_vals):
        ...
        return {
            ...
            'tax_ids': tax_vals['tax_ids'] and [Command.set(tax_vals['tax_ids'])] or [],
            'tax_tag_ids': tax_vals['tag_ids'] and [Command.set(tax_vals['tag_ids'])] or [],
