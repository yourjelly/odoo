    ...
    def _get_installments_data(self, payment_currency=None, payment_date=None):
        ...
        for i, line in enumerate(term_lines, start=1):
            installment = {
                ...
                'amount_residual_currency': line.amount_residual_currency,
                'amount_residual': line.amount_residual,
                'sign_amount_residual_currency': sign * line.amount_residual_currency,
                'sign_amount_residual': sign * line.amount_residual,
                'type': 'other',
            ...
            if move._is_eligible_for_early_payment_discount(payment_currency or line.currency_id, payment_date):
                installment.update({
                    ...
                    'sign_amount_residual_currency': sign * line.discount_amount_currency,
                    'sign_amount_residual': sign * line.discount_balance,
            ...
            if line.display_type == 'payment_term':
                if line.date_maturity < payment_date:
