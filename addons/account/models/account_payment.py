...
class AccountPayment(models.Model):
    ...
    def button_open_invoices(self):
        ...
        if len(self.reconciled_invoice_ids) == 1:
            action.update(
                {"view_mode": "form", "res_id": self.reconciled_invoice_ids.id,}
            )
        else:
            action.update(
                {
    ...
    def button_open_bills(self):
        ...
        if len(self.reconciled_bill_ids) == 1:
            action.update(
                {"view_mode": "form", "res_id": self.reconciled_bill_ids.id,}
            )
        else:
            action.update(
                {
    ...
    def button_open_statements(self):
        ...
        if len(self.reconciled_statement_ids) == 1:
            action.update(
                {"view_mode": "form", "res_id": self.reconciled_statement_ids.id,}
            )
        else:
            action.update(
                {
