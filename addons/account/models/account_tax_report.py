...
class AccountTaxReportLine(models.Model):
    ...
    def _get_carryover_destination_line(self, options):
        """
        Return the destination lines for the carryover for this tax report line.
        It could return two or more lines in some particular configuration.

        E.g. Italian tax report, two company in the same tax unit but with different fiscal year end date.
        :param options: The options of the tax report.
        :return: The lines on which we'll carryover this tax report line when closing the tax period.
        """
        self.ensure_one()
