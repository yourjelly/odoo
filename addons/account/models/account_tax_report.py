...
class AccountTaxReportLine(models.Model):
    ...
    is_carryover_persistent = fields.Boolean(
        ...
        help="Defines how this report line creates carry over lines when performing tax closing."
             ...
             "will add an additional 10 to it when doing the closing, so a total carry over of 60. "
             " If false, the total carried over amount will be forced to the total for this report line: "
