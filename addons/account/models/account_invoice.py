...
class AccountInvoiceLine(models.Model):
    ...
    def _set_taxes(self):
        ...
        self.ensure_one()
        company = self.invoice_id.company_id or self.env.user.company_id
        if self.invoice_id.type in ('out_invoice', 'out_refund'):
            taxes = self.product_id.taxes_id or self.account_id.tax_ids or company.account_sale_tax_id
        else:
            taxes = self.product_id.supplier_taxes_id or self.account_id.tax_ids or company.account_purchase_tax_id
