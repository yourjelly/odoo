    ...
    def generate_email(self, res_ids, fields):
        ...
        for record in records:
            ...
            for doc in record.edi_document_ids:
                edi_generation = doc.edi_format_id._when_is_edi_generated()
                if edi_generation in ['post', 'print']:
                    # retrieve attachments (pdf has already been rendered)
                ...
                elif edi_generation == 'generate_email':
                    # generate now
                    doc.state = 'to_send'
                    doc._process_documents_no_web_services()
        return res
