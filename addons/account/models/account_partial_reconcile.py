...
class AccountPartialReconcile(models.Model):
    ...
    def _collect_tax_cash_basis_values(self):
        ...
        for partial in self:
            for move in {partial.debit_move_id.move_id, partial.credit_move_id.move_id}:
                ...
                # Add partials.
                if 'partials' in tax_cash_basis_values_per_move[move.id]:
                    tax_cash_basis_values_per_move[move.id]['partials'] |= partial
                else:
                    tax_cash_basis_values_per_move[move.id]['partials'] = partial
    ...
    # TODO: check with qdp if analytic fields are correct (here + in stable)
    ...
    def _prepare_cash_basis_counterpart_tax_line_vals(self, tax_line, cb_tax_line_vals):
        ...
        return {
            ...
            'analytic_account_id': cb_tax_line_vals['analytic_account_id'],
            'analytic_tag_ids': cb_tax_line_vals['analytic_tag_ids'],
    ...
    def _fix_cash_basis_full_balance_coverage(self, move_values, partial_values, pending_cash_basis_lines, partial_lines_to_create):
        ...
        0.03 / 0.5 = 0.015 ~ 0.02 on the tax report as base amount. This is wrong because we expect 0.03.
    ...
    def _create_tax_cash_basis_moves(self, tax_cash_basis_values_per_move):
        ...
        for move_values in tax_cash_basis_values_per_move.values():
            ...
            for i, partial in enumerate(move_values['partials']):
                partial_values = partial._collect_tax_cash_basis_values_per_partial(move_values)
