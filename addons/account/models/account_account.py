...
class AccountAccount(models.Model):
    ...
    def _unlink_except_account_set_on_customer(self):
        ...
        if partner_prop_acc:
            ...
            raise UserError(
                _("You cannot deactivate the account %s which is set on a customer or vendor.\n\n"
                    "Imagine that this customer’s receivables evaporate; your CFO might not like it :)"
                    , account_name)
            )
