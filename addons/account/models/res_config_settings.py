...
class ResConfigSettings(models.TransientModel):
    ...
    account_journal_early_pay_discount_expense_account_id = fields.Many2one(
        comodel_name='account.account',
        string='Cash Discount Expense account',
        help='Account for the difference amount after the expense discount has been granted',
        readonly=False,
        related='company_id.account_journal_early_pay_discount_expense_account_id',
        domain="[('deprecated', '=', False), ('company_id', '=', company_id), ('account_type', '=', 'expense')]",
    )
    account_journal_early_pay_discount_income_account_id = fields.Many2one(
        comodel_name='account.account',
        string='Cash Discount Income account',
        help='Account for the difference amount after the income discount has been granted',
        readonly=False,
        related='company_id.account_journal_early_pay_discount_income_account_id',
