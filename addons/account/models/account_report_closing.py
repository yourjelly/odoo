...
class AccountReportClosing(models.Model):
    ...
    locked_journal_ids = fields.Many2many(string="Locked Journals", comodel_name='account.journal', tracking=True) #TODO OCO implémenter ça
    ...
    lock_journals = fields.Boolean(related='closing_type_id.lock_journals')
