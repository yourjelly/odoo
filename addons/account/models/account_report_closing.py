...
class AccountReportClosing(models.Model):
    ...
    locked_journal_ids = fields.Many2many(string="Locked Journals", comodel_name='account.journal', tracking=True)
    locked_company_ids = fields.Many2many(string="Locked Companies", comodel_name='res.company', relation='account_report_closing_locked_companies', tracking=True)
