...
function buildMockRPC(mockRPCs?: MockRPC | MockRPC[]) {
...
export function makeMockFetch(mockRPCs: MockRPC | MockRPC[]): typeof fetch {
  const _rpc = buildMockRPC(mockRPCs);
