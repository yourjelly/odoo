...
export class ActionMenus extends Component {
  ...
  get actionItems() {
    ...
    const callbackActions = (this.props.items.other || []).map((action) =>
    ...
    const registryActions = ActionMenus.registry.getAll().map(({ Component, getProps }, index) => ({
...
ActionMenus.components = { Dropdown, DropdownItem };
ActionMenus.props = {
...
ActionMenus.template = "wowl.ActionMenus";
