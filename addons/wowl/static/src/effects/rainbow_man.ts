...
export class RainbowMan extends Component<{ message: string; fadeout?: string }, OdooEnv> {
  static template = "wowl.rainbow_man";
  static rainbowFadeouts = { slow: 4500, medium: 3500, fast: 2000, no: false };

  // LPE fixme: make this a lazy loaded template
  ...
  constructor(...args: any[]) {
    ...
    const delay = fadeout ? (RainbowMan.rainbowFadeouts as any)[fadeout] : false;
  ...
  _onAnimationEnd(ev: AnimationEvent) {
