...
class HrExpense(models.Model):
    ...
    untaxed_amount = fields.Float(
        "Subtotal", store=True, compute="_compute_amount", digits="Account"
    )
    ...
    def _compute_amount_residual(self):
        for expense in self:
            ...
            payment_term_lines = expense.sheet_id.account_move_id.line_ids.filtered(
                lambda line: line.expense_id == self
    ...
    def _compute_label_convert_rate(self):
        ...
        for expense in records_with_diff_currency:
            ...
            rate_txt = _(
                ...
                rate=float_repr(rate, expense.company_currency_id.decimal_places),
...
class HrExpenseSheet(models.Model):
    ...
    def action_sheet_move_create(self):
        ...
        if any(not sheet.journal_id for sheet in self):
            raise UserError(
                _(
                    "Specify expense journal in tab Other Info to generate accounting entries."
                )
            )
