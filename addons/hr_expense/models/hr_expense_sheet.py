...
class HrExpenseSheet(models.Model):
    ...
    def _compute_can_reset(self):
        is_expense_user = self.env.user._has_group('hr_expense.group_hr_expense_team_approver')
        for sheet in self:
    ...
    def _compute_can_approve(self):
        is_team_approver = self.env.user._has_group('hr_expense.group_hr_expense_team_approver')
        is_approver = self.env.user._has_group('hr_expense.group_hr_expense_user')
        is_hr_admin = self.env.user._has_group('hr_expense.group_hr_expense_manager')
