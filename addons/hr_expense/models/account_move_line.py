...
class AccountMoveLine(models.Model):
    ...
    def _compute_all_tax(self):
        ...
        super(AccountMoveLine, expenses.with_context(force_price_include=True))._compute_all_tax()
        super(AccountMoveLine, self - expenses)._compute_all_tax()
    ...
    def _convert_to_tax_base_line_dict(self):
        if self.expense_id:
            return super(AccountMoveLine, self.with_context(force_price_include=True))._convert_to_tax_base_line_dict()
