...
class QrInvoiceWizard(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        results.update({
            ...
            'nb_classic_inv': len(dispatched_invoices['others']),
            ...
            'classic_inv_text': determine_invoices_text(nb_inv=len(dispatched_invoices['others']), inv_format="classic"),
        })
        return results
    ...
    def action_view_faulty_invoices(self):
        ...
        invoices = self.env['account.move'].browse(self._context['active_ids'])
        dispatched_invoices = invoices._l10n_ch_dispatch_invoices_to_print(self)
        faulty_invoices = dispatched_invoices['others']
