...
class AccountMove(models.Model):
    ...
    @api.depends('invoice_partner_bank_id.l10n_ch_postal')
    ...
    @api.depends('name', 'invoice_partner_bank_id.l10n_ch_isr_subscription_chf')
    def _compute_l10n_ch_isr_number(self):
        ...
        for record in self:
            if record.name and record.invoice_partner_bank_id and record.invoice_partner_bank_id.l10n_ch_postal:
                ...
                invoice_issuer_ref = record.invoice_partner_bank_id.l10n_ch_isr_subscription_chf
