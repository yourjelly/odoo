...
class Partner(models.Model):
    ...
    #TODO make this fields compute editable or no compute at all to support all endpoint schemes.
    #Each smp has its own scheme.
    #First, we will probaby only support vat, but we should allow extending easily the supported schemes.
    #See full list there : https://docs.peppol.eu/poacc/billing/3.0/codelist/eas/
