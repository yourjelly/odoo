...
QUnit.test('convert style to class on edit', function (assert) {
    ...
    testUtils.createAsyncView({
        ...
        mockRPC: function (route, args) {
            if (args.method === "write") {
                assert.strictEqual(args.args[1].body,
                    '<p class="pull-right" style="margin:0px;font-size:13px;font-family:&quot;Lucida Grande&quot;, Helvetica, Verdana, Arial, sans-serif;float:right;">toto '+
                    '<img '+
                    ...
                    '>'+
                    'toto toto</p><p style="margin:0px;font-size:13px;font-family:&quot;Lucida Grande&quot;, Helvetica, Verdana, Arial, sans-serif;">tata</p>',
                    "should save the content");
            }
