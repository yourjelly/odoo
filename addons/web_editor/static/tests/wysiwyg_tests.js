    ...
    return weTestUtils.createWysiwyg({
        ...
        var styleTests = [
            ...
            { name: "COMPLEX Click BOLD then 'a': italic bold -> italic (across paragraphs)",
                ...
                do: function () {
                    $btnBold.mousedown().click();
                    weTestUtils.keydown('a', $editable, {firstDeselect: true});
                },
                test: {
    ...
    return weTestUtils.createWysiwyg({
        ...
        var indentTests = [
            ...
            { name: "Click OUTDENT on P with indent in a LI (must outdent the p)",
                content: '<ul><ul><li><p style="margin-left: 1.5em;">dom</p></li></ul></ul>',
                start: 'p:contents(0)->1',
                do: function () {
                    $dropdownPara.mousedown().click();
                    $btnOutdent.mousedown().click();
                ...
                test: {
                    content: '<ul><ul><li><p>dom</p></li></ul></ul>',
                    start: 'p:contents(0)->1',
                },
            },
        ];
...
var _clickMedia = function (wysiwyg, assert, callbackInit, test) {
    var $btnMedia = wysiwyg.$('.note-insert .fa-file-image-o').mousedown().click();
