...
describe('Paste', () => {
    ...
    describe('Complex html div', () => {
        const complexHtmlData = `<div><div><span style="color: #fb4934;">abc</span><span style="color: #ebdbb2;">def</span></div><div><span style="color: #fb4934;">ghi</span><span style="color: #fe8019;">jkl</span></div><div><span style="color: #fb4934;">jkl</span><span style="color: #ebdbb2;">mno</span></div></div>`;
        it('should convert div to p', async () =>{
            await testEditor(BasicEditor, {
                ...
                contentAfter: '<p>abcdef</p><p>ghijkl</p><p>jklmno[]</p>',
            });
        });
    });
