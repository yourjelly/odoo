...
const Wysiwyg = Widget.extend({
    ...
    setupCollaboration(collaborationChannel) {
        ...
        if (this.options.checkForExtraRendering) {
            editorCollaborationOptions.checkForExtraRendering = this.options.checkForExtraRendering;
        }
    ...
    resetEditor: async function (value, options) {
        ...
        this.setValue(value);
        this.odooEditor.historyReset();
        this.odooEditor.multiselectionRemoveAll();
