...
dom.isVideo = function (node) {
    ...
    return (node.tagName === "IFRAME" || node.tagName === "DIV") && (node.parentNode.className && node.parentNode.className.indexOf('media_iframe_video') !== -1 || node.className.indexOf('media_iframe_video') !== -1);
};
