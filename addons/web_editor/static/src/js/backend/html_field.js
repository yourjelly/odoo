        ...
        this.iframePromise = new Promise((resolve) => {
            ...
            this.iframeRef.el.addEventListener('load', async () => {
                ...
                if (!this.sandboxedPreview) {
                    ...
                    html.innerHTML = iframeContent;
                    const body = html.querySelector("body.o_in_iframe");
                    body.classList.add("o_readonly");
                    body.style.overflow = "hidden";
                    const iframeTarget = html.querySelector("div#iframe_target");
                    iframeTarget.innerHTML = value;
                    cwindow.document.documentElement.innerHTML = html.outerHTML;
                    this.state.iframeVisible = true;
                    this.onIframeUpdated();
                } else {
