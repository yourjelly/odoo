...
var exportVariable = (function (exports) {
    ...
    const leftLeafFirstPath = createDOMPathGenerator(DIRECTIONS.LEFT);
    ...
    const leftLeafOnlyInScopeNotBlockNoEditablePath = createDOMPathGenerator(DIRECTIONS.LEFT, {
        leafOnly: true,
        inScope: true,
    ...
    const rightLeafOnlyPathNotBlockNotEditablePath = createDOMPathGenerator(DIRECTIONS.RIGHT, {
        leafOnly: true,
        isNodeDescendantTraversable: isNotEditableNode,
    });
    const rightLeafOnlyInScopeNotBlockPath = createDOMPathGenerator(DIRECTIONS.RIGHT, {
        leafOnly: true,
        inScope: true,
        isNodeDescendantTraversable: isNotBlock,
        stopFunction: isNotBlock,
     ...
     *                      node is encountered.
     */
    function createDOMPathGenerator(
        direction,
     ...
     * @returns {Node}
     */
    function lastLeaf(node, filterOutFunction) {
     ...
     * @returns {Node}
     */
    function firstLeaf(node, stopFunction) {
    ...
    /**
     * Get the highest not editable node if the `node` is within `root` and is a
     * non editable node.
     *
     ...
     *
     * ```js
     * getHighestNotEditableFromNotEditable(document.querySelector(".C")) // return "B"
     * ```
     */
    function getHighestNotEditableFromNotEditable(node, root) {
    ...
    class OdooEditor extends EventTarget {
        ...
        _fixSelectionOnContenteditableFalse() {
            ...
            const startContainerNotEditable = getHighestNotEditableFromNotEditable(
                startContainer,
                this.editable,
            );
            const endContainerNotEditable = getHighestNotEditableFromNotEditable(
                endContainer,
                this.editable,
            );
    ...
    exports.getHighestNotEditableFromNotEditable = getHighestNotEditableFromNotEditable;
    ...
    exports.leftLeafFirstPath = leftLeafFirstPath;
    exports.leftLeafOnlyInScopeNotBlockNoEditablePath = leftLeafOnlyInScopeNotBlockNoEditablePath;
    exports.leftLeafOnlyNotBlockPath = leftLeafOnlyNotBlockPath;
    ...
    exports.rightLeafOnlyInScopeNotBlockPath = rightLeafOnlyInScopeNotBlockPath;
    exports.rightLeafOnlyNotBlockNotEditablePath = rightLeafOnlyNotBlockNotEditablePath;
    exports.rightLeafOnlyNotBlockPath = rightLeafOnlyNotBlockPath;
    exports.rightLeafOnlyPathNotBlockNotEditablePath = rightLeafOnlyPathNotBlockNotEditablePath;
