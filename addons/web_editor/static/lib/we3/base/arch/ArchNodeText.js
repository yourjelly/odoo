...
we3.ArchNodeText = class extends we3.ArchNode {
     ...
     * @override
     */
    isBlankNode () { return false; }
    /**
     * @override
     */
    isBlankText () { return false; }
    /**
     * @override
     */
    ...
    _removeSide (offset, isLeft) {
        ...
        if (isOnEdge || this.isVirtual()) {
            ...
            return this._removeSideOnEdge(offset, isLeft);
        }
        var next = this.split(offset);
    ...
    _removeSideOnEdge (offset, isLeft) {
