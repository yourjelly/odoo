    ...
    constructor () {
        ...
        this.doms = [
            ...
            },
            {
                ...
                test: '<p><b>one</b></p><p>two</p><p><i>three</i></p>' // p within p -> p split, inner p removed
            },
            {
            ...
            },
            {
                ...
                test: '<div><p><b>one</b></p><p>two</p><p><i>three</i></p></div>'
            },
            {
...
% if toto:
<p>TOTO</p>
%end</div></section><p><i>iiii</i> <iframe data-src="/test"/> <b>bbb</b></p>`,
            },
        ];
...
<p><i>iiii</i> <iframe data-src="/test"/> <b>bbb</b></p>`,
    ...
    test (assert) {
        ...
        this.doms.forEach(function (test) {
            ...
            assert.strictEqual(value, test.test, test.name + ' (idempotent)');
        });
