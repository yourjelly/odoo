...
we3.addArchNode('DOCUMENT', class extends Media {
    //--------------------------------------------------------------------------
    // static
    //--------------------------------------------------------------------------
    ...
    static parse (json) {
        ...
        if (json.attributes && json.nodeName === 'a') {
            json.attributes.forEach(function (attribute) {
                if (attribute[0] === 'class' && attribute[1].indexOf('we3-document') !== -1 || attribute[0] === 'data-mimetype') {
                    isDocument = true;
                }
            });
        }
...
we3.addArchNode('PICTOGRAM', class extends Media {
    //--------------------------------------------------------------------------
    // static
    //--------------------------------------------------------------------------
...
we3.addArchNode('VIDEO', class extends Media {
    //--------------------------------------------------------------------------
    // static
    //--------------------------------------------------------------------------
    ...
    static parse (json) {
        var isVideo = false;
        if (json.nodeName === 'div' && json.attributes) {
            json.attributes.forEach(function (attribute) {
                if (attribute[0] === 'class' && attribute[0].indexOf('media_iframe_video') !== -1) {
                    isVideo = true;
                }
            });
        }
