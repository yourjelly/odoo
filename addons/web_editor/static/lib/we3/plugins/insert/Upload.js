...
we3.addPlugin('Upload', class extends we3.AbstractPlugin {
...
we3.addPlugin('UploadDocument', class extends we3.AbstractPlugin {
...
we3.addPlugin('UploadImage', class extends (we3.getPlugin('UploadDocument')) {
    static get autoInstall () {
...
we3.addPlugin('UploadCropImage', class extends we3.AbstractPlugin {
    static get autoInstall () {
        return ['Media', 'Upload', 'CropImage'];
    }
    constructor () {
        super(...arguments);
        this.dependencies = ['Upload', 'CropImage'];
    }

    start () {
        this.dependencies.CropImage.on('save', this, this._onSaveCroppedImages.bind(this));
        return super.start();
    }
