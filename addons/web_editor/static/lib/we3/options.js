...
Object.assign(we3.options, {
    ...
    keyMap: {
        pc: {
            ...
            'CTRL+SHIFT+NUM7':  'List.toggleList:ul',
            'CTRL+SHIFT+NUM8':  'List.toggleList:ol',
            'CTRL+SHIFT+NUM9':  'List.toggleList:checklist',
        ...
        mac: {
            ...
            'CMD+SHIFT+NUM7':   'List.toggleList:ul',
            'CMD+SHIFT+NUM8':   'List.toggleList:ol',
            'CMD+SHIFT+NUM9':   'List.toggleList:checklist',
        ...
        help: {
            ...
            'List.toggleList:ul':        'Toggle unordered list',
            'List.toggleList:ol':        'Toggle ordered list',
            'List.toggleList:checklist':'Toggle checklist',
