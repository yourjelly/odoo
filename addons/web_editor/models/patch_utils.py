...
def generate_comparison(
    new_content, old_content, html_attribute_to_ignore=None
):
    ...
    :param list[string] html_attribute_to_ignore: list of html attributes
                                                  to ignore

    :return: string: the comparison content
    """
    if html_attribute_to_ignore is None:
        html_attribute_to_ignore = []
