...
""",
    ...
    'assets': {
        ...
        'web_editor.wysiwyg_iframe_editor_assets': [
            ...
            'web/static/src/legacy/js/libs/bootstrap_tooltip.js',
            'web/static/src/legacy/js/libs/bootstrap_scrollspy.js',
            'web/static/src/legacy/js/libs/bootstrap_dropdown.js',
            'web/static/src/legacy/js/libs/bootstrap_modal.js',
