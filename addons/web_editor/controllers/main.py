...
class Web_Editor(http.Controller):
    ...
    @http.route("/web_editor/wysiwyg_iframe", type='http', auth='none', csrf=False)
    def get_wysiwyg_iframe_content(self, bundleNames, avoidDoubleLoad, onUpdateIframeId, content="", readonly=0):
