...
class UtmCampaign(models.Model):
    ...
    is_campaign_activated = fields.Boolean(compute="_compute_is_campaign_activated")
    ...
    def _compute_is_campaign_activated(self):
        for campaign in self:
            campaign.is_campaign_activated = self.env.user.has_group('mass_mailing.group_mass_mailing_campaign')
