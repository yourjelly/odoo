...
class MailingTrace(models.Model):
    ...
    scheduled = fields.Datetime(
        help="Date when the email has been created", default=fields.Datetime.now
    )
    ...
    @api.depends(
        "sent", "opened", "clicked", "replied", "bounced", "exception", "ignored"
    )
    ...
    def set_opened(self, mail_mail_ids=None, mail_message_ids=None):
        traces = self._get_records(
            mail_mail_ids, mail_message_ids, [("opened", "=", False)]
        )
    ...
    def set_clicked(self, mail_mail_ids=None, mail_message_ids=None):
        traces = self._get_records(
            mail_mail_ids, mail_message_ids, [("clicked", "=", False)]
        )
    ...
    def set_replied(self, mail_mail_ids=None, mail_message_ids=None):
        traces = self._get_records(
            mail_mail_ids, mail_message_ids, [("replied", "=", False)]
        )
