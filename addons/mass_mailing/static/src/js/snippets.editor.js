...
export class MassMailingSnippetsMenu extends snippetsEditor.SnippetsMenu {
    ...
    setup() {
        super.setup();
        this.mailingState = useState(this.env.mailingState);
        ...
        useEffect(
            ...
            () => [this.mailingState.selectedTheme]
        );
    ...
    _computeSnippetTemplates(html) {
        this.env.switchImages(this.mailingState.selectedTheme, $(html));
