...
class StockRule(models.Model):
    ...
    def _get_similar_procurements_groupby(self, procurement):
        ...
        """
        return procurement.values.get('sale_line_id'), super(StockRule, self)._get_similar_procurements_groupby(procurement)

    @api.model
    def _get_similar_procurements_sorted(self, procurement):
        return procurement.values.get('sale_line_id'), super(StockRule, self)._get_similar_procurements_sorted(procurement)
