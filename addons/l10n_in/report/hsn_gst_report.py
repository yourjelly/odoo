...
class L10nInProductHsnReport(models.Model):
    ...
    price_total = fields.Monetary(string='Taxable Value')
    total = fields.Monetary(string="Total Value")
    l10n_in_igst_amount = fields.Monetary(string="Integrated Tax Amount")
    l10n_in_cgst_amount = fields.Monetary(string="Central Tax Amount")
