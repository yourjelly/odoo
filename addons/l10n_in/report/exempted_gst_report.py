...
class L10nInExemptedReport(models.Model):
    ...
    nil_rated_amount = fields.Monetary("Nil rated supplies")
    exempted_amount = fields.Monetary("Exempted")
    ...
    l10n_in_cgst_amount = fields.Monetary(string="CGST Amount")
    l10n_in_sgst_amount = fields.Monetary(string="SGST Amount")
