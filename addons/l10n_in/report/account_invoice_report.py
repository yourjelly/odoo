...
class L10nInAccountInvoiceReport(models.Model):
    ...
    price_total = fields.Monetary(string='Total Without Tax')
    total = fields.Monetary(string="Invoice Total")
    ...
    def _select(self):
        select_str = """
            SELECT min(aml.id) AS id,
                ...
                sum(aml.l10n_in_igst_amount) AS l10n_in_igst_amount,
                sum(aml.l10n_in_cgst_amount) AS l10n_in_cgst_amount,
                sum(aml.l10n_in_sgst_amount) AS l10n_in_sgst_amount,
                sum(aml.l10n_in_cess_amount) AS l10n_in_cess_amount,
