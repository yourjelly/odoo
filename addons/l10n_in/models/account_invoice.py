    ...
    def _compute_l10n_in_gstr_section(self):
        ...
        def is_b2cs(move):
            return (
                ...
                (get_transaction_type(move) == 'inter_state' and
                    (is_invoice(move) and move.amount_total <= 250000) or
                    (move.debit_origin_id and move.debit_origin_id.amount_total <= 250000) or
                    (move.reversed_entry_id and move.reversed_entry_id.amount_total <= 250000)
                ))
            )
        ...
        def is_cdnur_b2cl(move):
            return (
                ...
                (
                    (move.debit_origin_id and move.debit_origin_id.amount_total > 250000) or
                    (move.reversed_entry_id and move.reversed_entry_id.amount_total > 250000) or
