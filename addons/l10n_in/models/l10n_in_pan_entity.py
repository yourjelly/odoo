...
class L10nINTaxTcs(models.Model):
    ...
    certificate_number = fields.Char(string="Certificate Number issued u/s 206C")
    valid_from = fields.Date(string="Valid From")
    valid_upto = fields.Date(string="Valid Upto")

    @api.constrains('valid_from', 'valid_upto', 'tax_group_ids')
...
class L10nINTaxTds(models.Model):
    ...
    certificate_number = fields.Char(string="Certificate Number issued u/s 197")
    valid_from = fields.Date(string="Valid From")
    valid_upto = fields.Date(string="Valid Upto")
