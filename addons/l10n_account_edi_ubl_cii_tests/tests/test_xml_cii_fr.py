...
class TestCIIFR(TestUBLCommon):
    ...
    def test_encoding_in_attachment_facturx(self):
        ...
        self._test_encoding_in_attachment(invoice.xml_id, 'factur-x.xml')
    ...
    def test_import_partner_facturx(self):
        ...
        self._test_import_partner(invoice.xml_id, self.partner_1, self.partner_2)
