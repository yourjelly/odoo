odoo.define('web_tip.web_tip', function (require) {
    ...
    var Tip = Class.extend({
        ...
        trigger_tip: function() {
            ...
            this.popover = this.$element.data('bs.popover').$tip;
            ...
            // hide tip
            if (this.popover.hasClass('out')) {
                this.popover.removeClass('out');
            }
            this.popover.on('mouseleave', function() {
                self.hide_tip();
            });
        ...
        hide_tip: function() {
            this.popover.removeClass('in').addClass('out');
        },
