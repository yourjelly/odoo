...
class L10nSaEdiMove(models.Model):
    ...
    _rec_name = "l10n_sa_move_id"

    l10n_sa_move_id = fields.Many2one("account.move", string="Invoice", required=True)
    ...
    l10n_sa_xml_content = fields.Binary("UBL Content", required=True)
