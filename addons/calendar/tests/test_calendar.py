...
class TestCalendar(SavepointCaseWithUserDemo):
    ...
    def test_event_order(self):
        ...
        def create_event(name, date):
            return self.CalendarEvent.create(
                {"name": name, "start": date + " 12:00:00", "stop": date + " 14:00:00",}
            )
    ...
    def test_event_activity(self):
        ...
        test_record = self.env["res.partner"].create({"name": "Test",})
        now = datetime.now()
        ...
        test_event = (
            ...
            .with_context(active_model=test_record._name, active_id=test_record.id,)
            .create(
                {
                    "name": test_name,
                    "description": test_description,
    ...
    def test_event_allday_activity_timezone(self):
        ...
        calendar_event.with_context({"tz": "Pacific/Honolulu"}).write(
            {"start": "2018-10-16 00:00:00", "start_date": "2018-10-16",}
        )
    ...
    def test_event_creation_mail(self):
        ...
        def _test_one_mail_per_attendee(self, partners):
            ...
            for partner in partners:
                mail = (
                    ...
                    .sudo()
                    .search([("notified_partner_ids", "in", partner.id),])
                )
        ...
        m.write(
            {"partner_ids": partner_ids, "recurrence_update": "all_events",}
        )
