        ...
        for proxy_user in proxy_users:
            ...
            try:
                res = proxy_user._make_request(
                    SERVER_URL + "/api/l10n_it_edi/1/in/RicezioneInvoice",
            ...
            if proxy_acks:
                try:
                    proxy_user._make_request(
                        SERVER_URL + "/api/l10n_it_edi/1/ack",
        ...
        for filename, response in responses.items():
            ...
            if "id_transaction" in response:
                ...
                to_return[invoice].update(
                    {
                        "error": _(
                            "The invoice was successfully transmitted to the Public Administration and we are waiting for confirmation."
                        ),
                        "blocking_level": "info",
                    }
                )
    ...
    def _l10n_it_post_invoices_step_2(self, invoices):
        ...
        if self.env["ir.config_parameter"].get_param(
            ...
            try:
                responses = proxy_user._make_request(
                    SERVER_URL + "/api/l10n_it_edi/1/in/TrasmissioneFatture",
        ...
        for id_transaction, response in responses.items():
            ...
            if state == "ricevutaConsegna":
                ...
                errors = [
                    element.find("Descrizione").text
                    for element in response_tree.xpath("//Errore")
                ]
                to_return[invoice] = {
    ...
    def _l10n_it_edi_upload(self, files, proxy_user):
        ...
        * error_level:   Info, warning, error.
        ...
        result = proxy_user._make_request(
            SERVER_URL + "/api/l10n_it_edi/1/out/SdiRiceviFile", params={"files": files}
        )
