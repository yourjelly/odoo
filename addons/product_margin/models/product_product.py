...
class ProductProduct(models.Model):
    ...
    def _read_group(self, domain, groupby=(), aggregates=(), having=(), offset=0, limit=None, order=None):
        ...
        aggregate_accepted = {f'{field_name}:sum' for field_name in fields_list} # Only sum is allowed
        ...
        all_records = self.browse(tuple(id_ for *__, ids in res for id_ in ids))
