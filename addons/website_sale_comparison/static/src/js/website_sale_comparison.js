...
var ProductComparison = publicWidget.Widget.extend(VariantMixin, {
    ...
    init: function () {
        ...
        this.product_data = {};
        this.comparelist_product_ids = JSON.parse(get_cookie('comparelist_product_ids') || '[]');
    ...
    _loadProducts: function (product_ids) {
        ...
        return this._rpc({
            ...
            params: {
                ...
                cookies: JSON.parse(get_cookie('comparelist_product_ids') || '[]'),
            },
        }).then(function (data) {
    ...
    _updateCookie: function () {
        set_cookie('comparelist_product_ids', JSON.stringify(this.comparelist_product_ids), 24 * 60 * 60 * 365, 'required');
