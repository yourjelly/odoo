...
class TestSaleStock(TestSaleCommon, ValuationReconciliationTestCommon):
    ...
    def test_06_uom(self):
        ...
        so1.write({"order_line": [(1, so1.order_line.id, {"product_uom_qty": 2}),]})
        ...
        so1.write({"order_line": [(1, so1.order_line.id, {"product_uom_qty": 3}),]})
    ...
    def test_15_cancel_delivery(self):
        ...
        """
        group_auto_done = self.env["ir.model.data"].xmlid_to_object(
