...
class AccountMove(models.Model):
    ...
    def _get_invoiced_lot_values(self):
        ...
        last_write_dates = last_invoice and [
            wd for wd in last_invoice.invoice_line_ids.mapped("write_date") if wd
        ]
        ...
        if so_line:
            ...
            qty_invoiced = sum(
                [
                    ...
                    for x in so_line.invoice_lines
                    if x.move_id.state == "posted"
                ]
            )
            average_price_unit = self.product_id._compute_average_price(
