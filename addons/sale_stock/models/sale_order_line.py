...
class SaleOrderLine(models.Model):
    ...
    def _get_qty_procurement(self, previous_product_uom_qty=False):
        # previous_product_uom_qty used in sale_mrp override
        self.ensure_one()
        qty = 0.0
    ...
    def _prepare_procurement_run_values(self, qty):
        self.ensure_one()
        ...
        return [
            ...
            self._prepare_procurement_values(group_id=group_id),
        ]

    def _get_procurement_group(self):
        self.ensure_one()
        return self.order_id.procurement_group_ids[:1]
