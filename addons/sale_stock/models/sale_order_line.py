...
class SaleOrderLine(models.Model):
    ...
    def _compute_qty_to_deliver(self):
        ...
        for line in self:
            ...
            if line.state in ('draft', 'sent', 'sale') and line.product_type == 'consu' and line.product_is_trackable and line.product_uom and line.qty_to_deliver > 0:
    ...
    def _action_launch_stock_rule(self, previous_product_uom_qty=False):
        ...
        for line in self:
            ...
            if line.state != 'sale' or line.order_id.locked or not line.product_id.type == 'consu' :
                continue
