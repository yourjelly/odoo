    ...
    def default_get(self, fields_list):
        ...
        if active_model == 'account.move':
            ...
            if not active_record.partner_id:
                type_name = _("vendor payment") if active_record.payment_type == 'supplier' else _("customer payment")
    ...
    def _compute_type_name(self):
        for wizard in self:
            if wizard.related_payment_id:
                wizard.type_name = _("vendor payment") if wizard.related_payment_id.payment_type == 'supplier' else _("customer payment")
            else:
