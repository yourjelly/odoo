...
class LivechatController(http.Controller):
    ...
    def livechat_lib(self, ext, **kwargs):
        ...
        files, _ = request.env["ir.qweb"]._get_asset_content(
            bundle, options=request.context
        )
    ...
    def livechat_init(self, channel_id):
        ...
        if available:
            ...
            country_code = (
                ...
                and request.session.geoip.get("country_code")
                or False
            )
            if country_code:
                country_ids = (
            ...
            if not channel.rating_ids:
                ...
                if channel.channel_partner_ids:
                    values["rated_partner_id"] = (
                        channel.channel_partner_ids[0]
                        and channel.channel_partner_ids[0].id
                        or False
                    )
