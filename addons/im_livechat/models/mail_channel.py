...
class MailChannel(models.Model):
    ...
    def channel_fetch_message(self, last_id=False, limit=20):
        ...
        channel = (
            self.with_context(im_livechat_use_username=True)
            if self.channel_type == "livechat"
            else self
        )
        return super(MailChannel, channel).channel_fetch_message(
        ...
        for channel in self:
            ...
            if channel.channel_type == "livechat":
                ...
                if channel.livechat_operator_id:
                    res = channel.livechat_operator_id.with_context(
                        im_livechat_use_username=True
                    ).name_get()[0]
    ...
    def _email_livechat_transcript(self, email):
        ...
        mail = (
            ...
            .create(
                {
                    "subject": _(
                        "Conversation with %s", self.livechat_operator_id.name
                    ),
