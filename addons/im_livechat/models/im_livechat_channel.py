...
class ImLivechatChannel(models.Model):
    ...
    def _get_random_operator(self, lang=None, country_id=None):
        ...
        if lang:
            same_lang_operator_ids = operators.filtered(lambda operator: operator.partner_id.lang == lang)
        ...
        if country_id and not operator:
            same_country_operator_ids = operators.filtered(lambda operator: operator.partner_id.country_id.id == country_id)
