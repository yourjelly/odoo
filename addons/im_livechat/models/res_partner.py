...
class Partners(models.Model):
    ...
    def name_get(self):
        if self.env.context.get("im_livechat_use_username"):
            ...
            users_with_livechatname = self.env["res.users"].search(
            ...
            partner_without_livechatname = self - users_with_livechatname.mapped(
                "partner_id"
            )
            no_livechatname_name_get = super(
                Partners, partner_without_livechatname
            ).name_get()
