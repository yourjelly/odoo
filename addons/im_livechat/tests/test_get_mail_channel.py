...
class TestGetMailChannel(TransactionCase):
    ...
    def test_channel_get_livechat_visitor_info(self):
        ...
        channel_info = self.livechat_channel.with_user(
            ...
            anonymous_name="Visitor 22", country_id=belgium.id
        )
        ...
        self.assertEqual(
            channel_info["operator_pid"], (operator.partner_id.id, "Michel")
        )
        visitor_info = channel_info["livechat_visitor"]
    ...
    def test_channel_not_pinned_for_operator_before_first_message(self):
        ...
        init_channels = (
            ...
            .with_user(operator_channel_partner.partner_id.user_ids[0])
            .channel_fetch_slot()
        )
        self.assertIn(
            channel_info["id"],
            [
                init_channel_info["id"]
                for init_channel_info in init_channels["channel_livechat"]
            ],
