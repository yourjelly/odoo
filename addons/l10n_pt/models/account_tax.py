...
class AccountTaxGroup(models.Model):
    ...
    l10n_pt_tax_region = fields.Selection(string="Region", selection=L10N_PT_TAX_REGIONS_SELECTION)
    l10n_pt_tax_category = fields.Selection(string="Tax Category", selection=L10N_PT_TAX_CATEGORIES_SELECTION, required=True, default="N")
