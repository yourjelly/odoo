...
class PosOrder(models.AbstractModel):
    ...
    @api.model
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, include_products=False):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        data.update({'sale_details': self.get_sale_details(data['date_start'], data['date_stop'], configs, data['include_products'])})
        return data
