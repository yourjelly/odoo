...
class SaleOrder(models.Model):
    ...
    def _update_programs_and_rewards(self):
        ...
        # Remove any coupons that do not belong to the customer
        self.applied_coupon_ids = self.applied_coupon_ids.filtered(lambda c: not c.partner_id or c.partner_id == self.partner_id)
