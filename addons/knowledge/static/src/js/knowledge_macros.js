...
export class KnowledgeMacro {
    /**
     * @param {integer} breadcrumbsIndex index of the breadcrumb to navigate to
     * @param {string} breadcrumbsTitle display string of the breadcrumb
    ...
    start() {
         ...
         * (@see KnowledgeService) . It will then validate that the correct view
         * has been loaded, and launch the macro action.
         */
        const startMacro = {
            name: "restore_record",
