...
Wysiwyg.include({
    ...
    init: function (parent, options) {
        if (options.knowledge_commands) {
             ...
             * powerboxFilters is an array of functions used to filters commands
     ...
     * @param {Element} owner
     */
    _notifyToolbarsKnowledgeFieldHtmlInjector(owner) {
        const toolbarsData = [];
     ...
     */
    _notifyBehaviorsKnowledgeFieldHtmlInjector(anchor) {
        const behaviorsData = [];
