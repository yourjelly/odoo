...
class TestCreatePicking(common.TestProductCommon):
    ...
    def test_00_create_picking(self):
        ...
        self.assertEqual(
            self.po.picking_count, 1, "Purchase: one picking should be created"
        )
        self.assertEqual(
    ...
    def test_02_check_mto_chain(self):
        ...
        """
        stock_location = self.env["ir.model.data"].xmlid_to_object(
            "stock.stock_location_stock"
        )
        customer_location = self.env["ir.model.data"].xmlid_to_object(
            "stock.stock_location_customers"
        )
        picking_type_out = self.env["ir.model.data"].xmlid_to_object(
