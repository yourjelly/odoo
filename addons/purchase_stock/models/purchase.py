...
class PurchaseOrder(models.Model):
    ...
    incoterm_location = fields.Char(string='Incoterm Location', readonly=[('state', '=', 'done')])
    ...
    picking_type_id = fields.Many2one('stock.picking.type', 'Deliver To', readonly=[('state', 'in', Purchase.READONLY_STATES)], required=True, default=_default_picking_type, domain="['|', ('warehouse_id', '=', False), ('warehouse_id.company_id', '=', company_id)]",
