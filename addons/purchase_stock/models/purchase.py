...
class PurchaseOrder(models.Model):
    ...
    picking_count = fields.Integer(
        compute="_compute_picking", string="Picking count", default=0, store=True
    )
...
class PurchaseOrderLine(models.Model):
    ...
    def _prepare_stock_move_vals(
        ...
        return {
            ...
            + relativedelta(days=self.order_id.company_id.po_lead),
    ...
    def _find_candidate(
        ...
        lines = self.filtered(
            ...
            and (
                (values["orderpoint_id"] and not values["move_dest_ids"])
