odoo.define('website_form_editor.tour', function (require) {
    ...
    const addField = function (data, name, type, label, required, hidden) {
        ...
        ...selectButtonByData(data),
        {
            ...
            trigger: `.s_website_form_field[data-type="${name}"], .s_website_form_field label[for="${name}"]`, //custom or existing field
            run: function () {},
        }];
    ...
    tour.register("website_form_editor_tour", {
        ...
        ...addCustomField('one2many', 'checkbox', 'Products', true),
        {
            ...
            content: "Check the resulting field",
            trigger: ".s_website_form_field.o_website_form_custom.o_website_form_required_custom" +
        ...
        ...addCustomField('selection', 'radio', 'Service', true),
        {
            ...
            content: "Check the resulting field",
            trigger: ".s_website_form_field.o_website_form_custom:not(.o_website_form_required_custom)" +
    ...
    tour.register("website_form_editor_tour_submit", {
    ...
    },[
        {
            ...
            extra_trigger:  "form[data-model_name='mail.mail']" +
                            ...
                            ":has(.s_website_form_field.o_website_form_required_custom:has(label:contains('State')):has(select[name='State'][required]:has(option[value='France'])))" +
