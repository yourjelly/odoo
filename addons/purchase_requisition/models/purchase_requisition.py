...
class PurchaseRequisition(models.Model):
    ...
    purchase_ids = fields.One2many('purchase.order', 'requisition_id', string='Purchase Orders', readonly=[('state', '=', 'done')])
    line_ids = fields.One2many('purchase.requisition.line', 'requisition_id', string='Products to Purchase', readonly=[('state', '=', 'done')], copy=True)
