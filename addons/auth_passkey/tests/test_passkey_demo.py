    ...
    def setUpClass(self):
        ...
        self.passkeys = {
            'test-yubikey': {
                ...
                'credential_identifier': '2f6a7a8ef716b823134669191caaaabd06f3d03864dc96c93b1d45f1c8bdf6748d8e57f1dd9ee792280c7540022e0801',
            ...
            'test-yubikey-nano': {
                'user': self.admin_user,
                'credential_identifier': 'c2dc34bbb0fcae9ee7abb5815850adfc5461107a54e841ef1204e7dc106277937e504e5af570b34bc35a56e87bc9d173',
            ...
            'test-keepassxc': {
                'user': self.demo_user,
                'credential_identifier': 'cba689549b2fbd24a46f04de199d456d03ff8c20e1a3b1013f066afb79408d0d',
                ...
                'sign_count': False,  # keepassxc doesn't support sign_count
                'auth': {
    ...
    def test_authentication(self):
        for passkey in self.passkeys.values():
            ...
            with self.patch_start_auth(webauthn_challenge):
                ...
                if passkey.get('sign_count', True):
