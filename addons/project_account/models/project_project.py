...
class Project(models.Model):
    ...
    def _add_purchase_items(self, profitability_items, with_action=True):
        ...
        with_action = with_action and (self.env.user._has_group('account.group_account_invoice') or self.env.user._has_group('account.group_account_readonly'))
    ...
    def _get_items_from_aal(self, with_action=True):
        ...
        if with_action and self.env.user._has_group('account.group_account_readonly'):
