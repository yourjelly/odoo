    ...
    def button_validate(self):
        ...
        for cost in self:
            ...
            for line in cost.valuation_adjustment_lines.filtered(lambda line: line.move_id):
                remaining_qty = sum(line.move_id.get_stock_valuation_layer_ids().mapped('remaining_qty'))
                linked_layer = line.move_id.get_stock_valuation_layer_ids()[:1]
    ...
    def get_valuation_lines(self):
        ...
        for move in self._get_targeted_move_ids():
            ...
            vals = {
                ...
                'move_id': move.id,
                'quantity': qty,
                'former_cost': sum(move.get_stock_valuation_layer_ids().mapped('value')),
