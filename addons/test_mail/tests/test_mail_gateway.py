...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_body(self):
        ...
        # test pure html
        quotedprintable = self.format(test_mail_data.MAIL_TEMPLATE_QUOPRI, email_from='"Sylvie Lelitre" <test.sylvie.lelitre@agrolait.com>')
        res = self.env['mail.thread'].message_parse(self.from_string(quotedprintable))
