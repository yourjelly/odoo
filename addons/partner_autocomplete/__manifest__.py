...

{
    ...
    "assets": {
        ...
        "web.tests_assets": ["partner_autocomplete/static/lib/**/*",],
        "web.qunit_suite_tests": ["partner_autocomplete/static/tests/**/*",],
        "web.assets_qweb": ["partner_autocomplete/static/src/xml/**/*",],
    },
}
