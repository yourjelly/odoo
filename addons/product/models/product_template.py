...
class ProductTemplate(models.Model):
    ...
    lst_price = fields.Float(
        "Public Price", related="list_price", readonly=False, digits="Product Price"
    )
    ...
    def _name_search(
        ...
        while True:
            ...
            if not products:
                ...
                template_ids = super(ProductTemplate, self)._name_search(
                    name=name,
            ...
            if (not products and not current_round_templates) or (
                limit and (len(templates) > limit)
            ):
                break
    ...
    def _get_possible_combinations(
        ...
        product_template_attribute_values_per_line = [
            ptal.product_template_value_ids for ptal in attribute_lines
        ]
