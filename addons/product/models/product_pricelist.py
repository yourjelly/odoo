...
class Pricelist(models.Model):
    ...
    def _get_partner_pricelist_multi(self, partner_ids):
        ...
        for partner in Partner.with_company(company_id).browse(partner_ids):
        ...
        if remaining_partner_ids:
            ...
            pl_fallback = (
                ...
                # when computing
                Pricelist.browse(int(IrConfigParameter.get_param(f'res.partner.property_product_pricelist_{company_id}'))) or
                Pricelist.browse(int(IrConfigParameter.get_param('res.partner.property_product_pricelist'))) or
