...
class report_product_pricelist(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data):
        ...
        return self._get_report_data(
            data["active_model"], product_ids, pricelist_id, quantities, "pdf"
        )
    ...
    def _get_report_data(
        self, active_model, active_ids, pricelist_id, quantities, report_type="html"
    ):
        products = []
                    ...
                    for variant in product.product_variant_ids:
                        variants.append(
                            self._get_product_data(
                                False, variant, pricelist, quantities
                            )
                        )
