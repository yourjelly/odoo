...
class SaleOrder(models.Model):
            ...
            return [
                {
                    ...
                    "product_id": program.discount_line_product_id.id,
                    "price_unit": -self._get_reward_values_discount_fixed_amount(
                        program
                    ),
                    "product_uom_qty": 1.0,
    ...
    def _get_applicable_programs(self):
        ...
        programs = (
            self.env["coupon.program"]
            .with_context(no_outdated_coupons=True,)
            .search(
                [
    ...
    def _get_applicable_no_code_promo_program(self):
        ...
        programs = (
            self.env["coupon.program"]
            .with_context(no_outdated_coupons=True, applicable_coupon=True,)
            .search(
                [
