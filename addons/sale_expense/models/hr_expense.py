...
class Expense(models.Model):
    ...
    sale_order_id = fields.Many2one('sale.order', compute='_compute_sale_order_id', store=True, string='Customer to Reinvoice', tracking=True,
        readonly=[('state', 'in', ['done', 'refused'])],
