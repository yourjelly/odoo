...
class TestMassMailCommon(MassMailCommon, TestMailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.mailing_bl = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'preview': 'Hi <t t-esc="object.name"/> :)',
            'body_html': """<div><p>Hello <t t-esc="object.name"/></p>,
<t t-set="url" t-value="'www.odoo.com'"/>
<t t-set="httpurl" t-value="'https://www.odoo.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.odoo.tz/my/{{object.name}}">https://www.odoo.tz/my/<t t-esc="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.odoo.be">https://www.odoo.be</a></span>
<span>Website2: <a id="url2" t-attf-href="https://{{url}}">https://<t t-esc="url"/></a></span>
<span>Website3: <a id="url3" t-att-href="httpurl"><t t-esc="httpurl"/></a></span>
