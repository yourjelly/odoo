...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_es_edi_get_invoices_info(self, invoices):
        ...
        for invoice in invoices:
            ...
            partner_info = {'NombreRazon': com_partner.name[:120]}
            IDOtro_ID = com_partner.vat or 'NO_DISPONIBLE'

            if (not com_partner.country_id or com_partner.country_id.code == 'ES') and com_partner.vat:
                # ES partner with VAT.
                partner_info['NIF'] = com_partner.vat[2:] if com_partner.vat.startswith('ES') else com_partner.vat
            elif com_partner.country_id.code in eu_country_codes:
                # European partner.
                ...
                if com_partner.country_id:
                    partner_info['IDOtro']['CodigoPais'] = com_partner.country_id.code
