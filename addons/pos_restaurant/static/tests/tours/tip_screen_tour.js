...
registry.category("web_tour.tours").add("PosResTipScreenTour", {
    ...
    steps: () =>
        [
            ...
            FloorScreen.isOrderCountSyncedInTable("2", "1"),
            FloorScreen.clickTable("2"),
            ProductScreen.totalAmountIs("2.0"),
            ...
            FloorScreen.backToFloor(),
            FloorScreen.isOrderCountSyncedInTable("2", "2"),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            ...
            FloorScreen.backToFloor(),
            FloorScreen.isOrderCountSyncedInTable("5", "4"),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            ...
            TipScreen.isPercentAmountValueIs("15%", "0.30"),
            TipScreen.isPercentAmountValueIs("20%", "0.40"),
            TipScreen.isPercentAmountValueIs("25%", "0.50"),
            TipScreen.clickPercentTip("20%"),
            TipScreen.isInputAmountValueIs("0.40"),
            FloorScreen.backToFloor(),
            FloorScreen.isShown(),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            ...
            TipScreen.isPercentAmountValueIs("15%", "0.90"),
            TipScreen.isPercentAmountValueIs("20%", "1.20"),
            TipScreen.isPercentAmountValueIs("25%", "1.50"),
            TipScreen.clickPercentTip("25%"),
            TipScreen.isInputAmountValueIs("1.50"),
            FloorScreen.backToFloor(),
            FloorScreen.isShown(),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            ...
            TipScreen.isPercentAmountValueIs("15%", "1.20"),
            TipScreen.isPercentAmountValueIs("20%", "1.60"),
            TipScreen.isPercentAmountValueIs("25%", "2.00"),
            TipScreen.setCustomTip("1.00"),
            TipScreen.isInputAmountValueIs("1.00"),
            FloorScreen.backToFloor(),
            FloorScreen.isShown(),
            ...
            TicketScreen.isTipValueIs("1.00"),
