...
models.Order = models.Order.extend({
    build_by_product_resume: function(){
        var resume = {};
    ...
    saveChanges: function(){
        this.saved_resume = this.build_by_product_resume();
        this.orderlines.each(function(line){
    ...
    computeChanges: function(categories){
        var current_res = this.build_by_product_resume();
