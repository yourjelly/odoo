...
""",
    ...
    "demo": ["data/pos_restaurant_demo.xml",],
    "installable": True,
    "auto_install": False,
    "assets": {
        ...
        "web.assets_backend": ["point_of_sale/static/src/scss/pos_dashboard.scss",],
        "web.assets_tests": ["pos_restaurant/static/tests/tours/**/*",],
        "point_of_sale.qunit_suite_tests": ["pos_restaurant/static/tests/unit/**/*",],
        "web.assets_qweb": ["pos_restaurant/static/src/xml/**/*",],
    },
}
