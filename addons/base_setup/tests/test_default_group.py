...
class TestResConfig(TransactionCase):
    ...
    def test_multi_company_res_config_group(self):
        ...
        # Sanity check
        self.assertTrue(user not in group_system.user_ids)
        ...
        self.assertTrue(user in self.env.ref('base.group_system').sudo().user_ids)
        ...
        self.assertTrue(new_user in group_system.user_ids)
        ...
        self.assertTrue(new_user not in group_system.user_ids)
