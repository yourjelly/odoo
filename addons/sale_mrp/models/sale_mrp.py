...
class MrpProduction(models.Model):
    ...
    sale_order_id = fields.Many2one('sale.order', store=True, string="Source sale order", related='procurement_group_id.sale_id')
...
class SaleOrder(models.Model):
    ...
    mrp_production_ids = fields.One2many('mrp.production', 'sale_order_id', string="Generated MO")
    mrp_production_count = fields.Integer("Number of Generated MO", compute='_compute_mrp_production_count')
    ...
    def action_view_mrp_production(self):
        self.ensure_one()
        return {
            'name': _('Manufacturing Order generated by %s' % self.name),
            'view_mode': 'tree,form',
