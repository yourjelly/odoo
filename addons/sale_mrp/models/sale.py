...
class SaleOrder(models.Model):
    ...
    def _compute_mrp_production_count(self):
        for sale in self:
            sale.mrp_production_count = len(
                sale.procurement_group_id.stock_move_ids.created_production_id.procurement_group_id.mrp_production_ids
            )
...
class SaleOrderLine(models.Model):
                ...
                if relevant_bom:
                    ...
                    if dropship:
                        if order_line.move_ids and all(
                            m.state == "done" for m in order_line.move_ids
                        ):
                    ...
                    order_line.qty_delivered = moves._compute_kit_quantities(
    ...
    def _get_qty_procurement(self, previous_product_uom_qty=False):
        ...
        if bom and previous_product_uom_qty:
            return previous_product_uom_qty and previous_product_uom_qty.get(
                self.id, 0.0
            )
