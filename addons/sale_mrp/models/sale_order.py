...
class SaleOrder(models.Model):
    ...
    def _compute_mrp_production_ids(self):
        data = self.env['procurement.group']._read_group([('sale_id', 'in', self.ids)], ['sale_id'], ['id:array_agg'])
        mrp_productions = {}
        for sale, ids in data:
            procurement_groups = self.env['procurement.group'].browse(ids)
