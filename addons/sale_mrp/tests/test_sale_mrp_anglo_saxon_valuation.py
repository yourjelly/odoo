...
class TestSaleMRPAngloSaxonValuation(ValuationReconciliationTestCommon):
    ...
    def _create_product(self, name, product_type, price, is_trackable=True):
        return self.env['product.product'].create({
            ...
            'categ_id': self.stock_account_product_categ.id if is_trackable else self.env.ref('product.product_category_all').id,
        })
    ...
    def test_sale_mrp_kit_bom_cogs(self):
        ...
        self.component_bb = self._create_product('Component BB', 'consu', 5.00, False)
        self.kit_a = self._create_product('Kit A', 'consu', 0.00)
        self.kit_b = self._create_product('Kit B', 'consu', 0.00, False)
    ...
    def test_anglo_saxo_return_and_credit_note(self):
        ...
        kit = self._create_product('Simple Kit', 'consu', 0)
        component = self._create_product('Compo A', 'consu', 0)
    ...
    def test_kit_avco_fully_owned_and_delivered_invoice_post_delivery(self):
        ...
        compo01 = self._create_product('Compo 01', 'consu', 10)
        compo02 = self._create_product('Compo 02', 'consu', 20)
        kit = self._create_product('Kit', 'consu', 0)
