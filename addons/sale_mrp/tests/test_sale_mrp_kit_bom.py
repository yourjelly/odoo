...
class TestSaleMrpKitBom(TransactionCase):
    ...
    def _create_product(self, name, product_type, price, is_trackable=True):
    ...
    def test_sale_mrp_kit_cost(self):
        ...
        self.kit_product = self._create_product('Kit Product', 'consu', 1.00)
        # Creating components
        self.component_a = self._create_product('Component A', 'consu', 1.00)
        self.component_a.product_tmpl_id.standard_price = 6
        self.component_b = self._create_product('Component B', 'consu', 1.00)
    ...
    def test_qty_delivered_with_bom(self):
        ...
        self.kit = self._create_product('Kit', 'consu', 0.00)
        self.comp = self._create_product('Component', 'consu', 0.00)
    ...
    def test_qty_delivered_with_bom_using_kit(self):
        ...
        self.kitA = self._create_product('Kit A', 'consu', 0.00, False)
        self.kitB = self._create_product('Kit B', 'consu', 0.00, False)
        self.compA = self._create_product('ComponentA', 'consu', 0.00, False)
        self.compB = self._create_product('ComponentB', 'consu', 0.00, False)
    ...
    def test_sale_kit_show_kit_in_delivery(self):
        ...
        kitA = self._create_product('Kit Product', 'consu', 0.00)
        compA = self._create_product('ComponentA', 'consu', 0.00)
        compB = self._create_product('ComponentB', 'consu', 0.00)
    ...
    def test_qty_delivered_with_bom_using_kit2(self):
        ...
        kitAB = self._create_product('Kit AB', 'consu', 0.00)
        kitABC = self._create_product('Kit ABC', 'consu', 0.00)
        compA = self._create_product('ComponentA', 'consu', 0.00)
        compB = self._create_product('ComponentB', 'consu', 0.00)
        compC = self._create_product('ComponentC', 'consu', 0.00)
