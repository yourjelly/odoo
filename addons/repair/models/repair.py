...
class Repair(models.Model):
    ...
    def _amount_total(self):
        for order in self:
            order.amount_total = order.pricelist_id.currency_id.round(
    ...
    def _unlink_except_confirmed(self):
        for order in self:
            ...
            if (
                ...
                and order.invoice_id.posted_before
            ):
                raise UserError(
                    _(
    ...
    def _create_invoices(self, group=False):
        ...
        for (
            (partner_invoice_id, currency_id, company_id),
            invoices,
        ) in grouped_invoices_vals.items():
