...
QUnit.module("spreadsheet > Global filters model", {}, () => {
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            setCellContent(model, "B3", '=PIVOT(1, "__count", "#product_id", 1)');
            await addGlobalFilter(
                model,
                {
                    id: "42",
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            setCellContent(model, "B3", '=PIVOT(1, "probability", "#product_id", 1)');
            await addGlobalFilter(
                model,
                {
                    id: "42",
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            setCellContent(model, "B3", '=PIVOT(1, "probability")');
            await addGlobalFilter(
                model,
                {
                    id: "42",
