...
QUnit.test("Odoo formulas are migrated", (assert) => {
    ...
    assert.strictEqual(migratedData.sheets[0].cells.A1.content, `=PIVOT("1")`);
    ...
    assert.strictEqual(migratedData.sheets[0].cells.A7.content, `=PIVOT("1")`);
});
...
QUnit.test("Pivot 'day' arguments are migrated", (assert) => {
    ...
    const migratedData = migrate(data);
    assert.strictEqual(migratedData.sheets[0].cells.A1.content, `=PIVOT("1","07/21/2022")`);
    assert.strictEqual(migratedData.sheets[0].cells.A2.content, `=PIVOT.HEADER("1","12/11/2022")`);
    assert.strictEqual(migratedData.sheets[0].cells.A3.content, `=PIVOT("1","07/21/2021")`);
    assert.strictEqual(migratedData.sheets[0].cells.A4.content, `=PIVOT("1","test")`);
    assert.strictEqual(
        migratedData.sheets[0].cells.A5.content,
        `=PIVOT("1","07/21/2021")+"21/07/2021"`
    );
...
QUnit.test("Pivot formulas are migrated from 9 to 10", (assert) => {
    ...
    assert.strictEqual(migratedData.sheets[0].cells.A4.content, `=PIVOT.TABLE("1")`);
    assert.strictEqual(migratedData.sheets[0].cells.A5.content, `=PIVOT("1")`);
});
