...
class L10nHuEdiTestCommon(AccountEdiTestCommon):
    @classmethod
    def setUpClass(cls, chart_template_ref="l10n_hu.hungarian_chart_template", edi_format_ref="l10n_hu_edi.edi_hun_nav_3_0"):
        ...
        cls.partner_group_company_1 = cls.env["res.partner"].create({
            ...
            "country_id": cls.env.ref("base.hu").id,
            "vat": "17781774-5-44",
            "l10n_hu_group_vat": "10625790-4-44",
        })
        cls.partner_group_company_2 = cls.env["res.partner"].create({
            ...
            "country_id": cls.env.ref("base.hu").id,
            "vat": "17781774-5-44",
            "l10n_hu_group_vat": "10725759-4-05",
        })
        ...
        # Taxes
        cls.tax_vat = cls.env.ref(f"l10n_hu.{company.id}_F27")
        cls.tax_vat_18 = cls.env.ref(f"l10n_hu.{company.id}_F18")
        cls.tax_aam = cls.env.ref(f"l10n_hu.{company.id}_VA")
    ...
    def create_edi_credentials(cls):
        ...
        with mock.patch.object(type(cls.env["l10n_hu_edi.credentials"]), "test", autospec=True):
            return cls.env["l10n_hu_edi.credentials"].create([
                {
                    "mode": "test",
