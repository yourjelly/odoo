...
class AuthSignupHome(Home):
    ...
    @http.route('/web/signup', captcha='signup', type='http', auth='public', website=True, sitemap=False)
    ...
    @http.route('/web/reset_password', captcha='password_reset', type='http', auth='public', website=True, sitemap=False)
