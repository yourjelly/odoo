...
class PosSelfOrderController(http.Controller):
    ...
    def process_order(self, order, access_token, table_identifier, device_type):
        ...
        preset_id = order['preset_id'] if pos_config.self_ordering_takeaway or pos_config.use_presets else False
    ...
    def _verify_authorization(self, access_token, table_identifier, order):
        ...
        is_takeaway = order and pos_config.self_ordering_takeaway and pos_config.self_ordering_takeaway_preset_out.id == order.get('preset_id')
