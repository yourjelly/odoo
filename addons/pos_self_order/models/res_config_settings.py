...
class ResConfigSettings(models.TransientModel):
    ...
    pos_self_ordering_takeaway_preset_in = fields.Many2one(related="pos_config_id.self_ordering_takeaway_preset_in", readonly=False)
    pos_self_ordering_takeaway_preset_out = fields.Many2one(related="pos_config_id.self_ordering_takeaway_preset_out", readonly=False)
