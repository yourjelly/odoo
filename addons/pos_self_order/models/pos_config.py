...
class PosConfig(models.Model):
    ...
    def _load_self_data_models(self):
        return ['pos.session', 'sale.order', 'sale.order.line', 'pos.payment', 'pos.payment.method', 'res.currency', 'pos.category', 'product.product', 'product.combo', 'product.combo.item',
