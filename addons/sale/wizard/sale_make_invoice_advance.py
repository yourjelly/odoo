...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def _create_invoice(self, order, so_line, amount):
        ...
        invoice_vals = {
            ...
            '': order.fiscal_position_id.id or order.partner_id.property_account_position_id.id,
        ...
        invoice = self.env['account.move'].with_context(type='out_invoice', assist_move_creation=True).create(invoice_vals)
