...
class SaleOrderLine(models.Model):
    ...
    def _compute_tax_id(self):
        for line in self:
            ...
            companies = line.company_id.search([('id', 'child_of', line.company_id.id)]).ids if line.company_id else [False]
            taxes = line.product_id.taxes_id.filtered(lambda r: line.company_id.id in companies)
