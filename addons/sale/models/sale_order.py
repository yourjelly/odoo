...
class SaleOrder(models.Model):
    ...
    def _nothing_to_invoice_error(self):
        msg = _(
            ...
            "Click on the \"truck\" icon (top-right of your screen) and follow instructions.\n"
            "- You should modify the invoicing policy of your product: "
            "Open the product, go to the \"Sales tab\" and modify invoicing policy from \"delivered quantities\" to \"ordered quantities\"."
        )
    ...
    def _get_portal_return_action(self):
        ...
        Note: extended in enterprise/sale_renting.
        """
        self.ensure_one()
    ...
    def update_prices(self):
        """Recompute the prices of all existing lines."""
        self.ensure_one()
        lines_to_update = []
    ...
    # Bridges between independent modules #
    @api.model
