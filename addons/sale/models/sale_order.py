...
class SaleOrder(models.Model):
    ...
    @api.depends('client_order_ref', 'date_order', 'origin', 'partner_id', 'tax_totals')
    ...
    def _fetch_duplicate_orders(self):
        ...
        :rtype: dict
        """
        orders = self.filtered('client_order_ref')
        if not orders:
            return {}
            ...
            SELECT
              ...
              JOIN sale_order AS duplicate_order
                ON sale_order.company_id = duplicate_order.company_id
                 ...
                 AND sale_order.amount_total = duplicate_order.amount_total
                 AND sale_order.client_order_ref = duplicate_order.client_order_ref
                 AND sale_order.origin = duplicate_order.origin
