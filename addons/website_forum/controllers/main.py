...
class WebsiteForum(WebsiteProfile):
    ...
    def questions(
        ...
        **post
        ...
        question_ids = Post.search(
            domain, limit=self._post_per_page, offset=pager["offset"], order=sorting
        )
    ...
    def question_ask_for_close(self, forum, question, **post):
        ...
        values.update(
            {"question": question, "forum": forum, "reasons": reasons,}
        )
    ...
    def validation_queue(self, forum, **kwargs):
        ...
        values = self._prepare_user_values(forum=forum)
        values.update(
            {"posts_ids": posts_to_validate_ids.sudo(), "queue_type": "validation",}
        )
    ...
    def offensive_posts(self, forum, **kwargs):
        ...
        values = self._prepare_user_values(forum=forum)
        values.update(
            {"posts_ids": offensive_posts_ids.sudo(), "queue_type": "offensive",}
        )
