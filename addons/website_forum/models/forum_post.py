...
class Post(models.Model):
    ...
    bump_date = fields.Datetime('Bumped on', readonly=True, help="Field to keep track of a "
    "post last activity. Updated whenever it is manually bumped, replied to, or when a comment is "
    "added on the post or one of its replies.", required=True, default=fields.Datetime.now())
