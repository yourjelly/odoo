...
Ask questions, get answers, no distractions
    ...
    "assets": {
        ...
        "web.assets_tests": ["website_forum/static/tests/**/*",],
        "web.assets_frontend": [
        ...
        "web.assets_qweb": ["website_forum/static/src/xml/*.xml",],
    },
}
