...
class AccountMove(models.Model):
    ...
    l10n_es_tbai_cancel_attachment_id = fields.Many2one(
        ...
        related='l10n_es_tbai_cancel_document_id.xml_attachment_id'
    )
    ...
    def _l10n_es_tbai_check_can_send(self):
        ...
        if self.l10n_es_tbai_state != 'to_send':
    ...
    def _l10n_es_tbai_get_values(self, cancel=False):
        ...
        if values['is_sale']:
            ...
            values.update(self._l10n_es_tbai_get_in_invoice_values_batuz())
    ...
    def _l10n_es_tbai_get_invoice_values(self, cancel=False):
        ...
        return {
            ...
            **(self._l10n_es_tbai_get_tax_details() if not cancel else {}),
            ...
            'base_lines': [line._convert_to_tax_base_line_dict() for line in self.invoice_line_ids.filtered(lambda line: line.display_type not in ('line_section', 'line_note'))],
    ...
    def _l10n_es_tbai_get_tax_details(self):
        partner = self.commercial_partner_id
        if not partner._l10n_es_is_foreign():
            return {'tax_details_info_vals': self._l10n_es_edi_get_invoices_tax_details_info()}
        else:
            return {
    ...
    def _l10n_es_tbai_get_in_invoice_values_batuz(self):
        ...
        if values['is_refund']:
            ...
            values['credit_note_docs'] = (self.reversed_entry_id | self.l10n_es_tbai_reversed_ids).l10n_es_tbai_post_document_id
