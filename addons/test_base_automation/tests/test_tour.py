...
class BaseAutomationTestUi(HttpCase):
    ...
    def test_form_view(self):
        ...
        origin_link_onchange = type(self.env["base.automation.action.link"]).onchange
        ...
        self.patch(type(self.env["base.automation.action.link"]), "onchange", _onchange_base_auto_link)
