    ...
    steps: () => [
        ...
        },
        {
            ...
            run() {
                ...
                assertEqual(
                    ...
                    "User is setOn save // Based on date fieldAfter creationAfter last update // On deleteOn live update"
                );
            },
        },
        {
        ...
        },
        {
            ...
            run() {
                ...
                assertEqual(
                    triggerGroups.map((el) => el.innerText).join(" // "),
                    "Stage is set toUser is setTag is addedPriority is set toOn save // Based on date fieldAfter creationAfter last update // On deleteOn live update"
                );
            },
        },
        {
