...
class StockPickingBatch(models.Model):
    ...
    used_weight_percentage = fields.Float(
        string="Weight %", compute='_compute_used_weight_percentage')
    used_volume_percentage = fields.Float(
        string="Volume %", compute='_compute_used_volume_percentage')
    max_picking_weight = fields.Float(string="Weight", compute='_compute_used_weight_percentage')
    max_picking_volume = fields.Float(string="Volume", compute='_compute_used_volume_percentage')
