    ...
    def _compute_l10n_ro_edi_stock_enable_send(self):
        for picking in self:
            picking.l10n_ro_edi_stock_enable_send = (picking.l10n_ro_edi_stock_enable
                                                     ...
                                                     and not picking.l10n_ro_edi_stock_interface_id._get_last_stock_validated_document())
    ...
    def _compute_l10n_ro_edi_stock_enable_amend(self):
        for picking in self:
            picking.l10n_ro_edi_stock_enable_amend = picking.l10n_ro_edi_stock_enable and (
                    ...
                    or (picking.l10n_ro_edi_stock_state == 'stock_sending_failed'
                        and picking.l10n_ro_edi_stock_interface_id._get_last_stock_validated_document()))
