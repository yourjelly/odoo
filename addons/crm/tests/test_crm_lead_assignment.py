...
class TestLeadAssign(TestLeadAssignCommon):
    ...
    def test_assign_duplicates(self):
        ...
        self.assertLessEqual(
            len(leads_st1), 83
        )  # 75 * 122 / 165 * 1.5 (because random)
        self.assertLessEqual(
            len(leads_stc), 100
        )  # 90 * 122 / 165 * 1.5 (because random)
        self.assertGreaterEqual(
            len(leads_st1), 27
        )  # 75 * 122 / 165 * 0.5 (because random)
        self.assertGreaterEqual(
            len(leads_stc), 33
        )  # 90 * 122 / 165 * 0.5 (because random)
        self.assertEqual(
    ...
    def test_assign_no_duplicates(self):
        ...
        self.assertLessEqual(
            len(leads_st1), 102
        )  # 75 * 150 / 165 * 1.5 (because random)
        self.assertLessEqual(
            len(leads_stc), 123
        )  # 90 * 150 / 165 * 1.5 (because random)
        self.assertGreaterEqual(
            len(leads_st1), 34
        )  # 75 * 150 / 165 * 0.5 (because random)
        self.assertGreaterEqual(
            len(leads_stc), 41
        )  # 90 * 150 / 165 * 0.5 (because random)
        self.assertEqual(
            len(leads_st1) + len(leads_stc), len(leads)
        )  # Make sure all lead are assigned
