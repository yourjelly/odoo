...
class TestCRMLead(TestCrmCommon):
    ...
    def test_crm_lead_partner_sync_email_phone_corner_cases(self):
        ...
        lead.write(
            {"email_from": '"My Name" <%s>' % test_email, "phone": "+1 202-555-0888",}
        )
        contact.write(
            {"email": '"My Name" <%s>' % test_email, "phone": "+1 202-555-0888",}
        )
        ...
        contact.write(
            {"country_id": be_country.id, "phone": "+32456001122",}
        )
    ...
    def test_crm_team_alias(self):
        ...
        new_team.write(
            {"use_leads": False, "use_opportunities": False,}
        )
