...
tour.register('crm_tour', {
    ...
    trigger: ".o_opportunity_kanban .o_kanban_group:first-child .o_kanban_record:last .oe_kanban_content",
    extra_trigger: ".o_opportunity_kanban",
    ...
    trigger: ".o_opportunity_kanban .o_kanban_group:eq(2) .o_kanban_record:last",
