odoo.define('pos_cache.PointOfSaleModel', function (require) {
    ...
    return patch(PointOfSaleModel.prototype, 'pos_cache', {
        ...
        async actionNotifyDoneLoadingProducts() {
            this.ui.showNotification(_t('All products are loaded. The images are being loaded in the background.'), 5000);
        },
    });
});
