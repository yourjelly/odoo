...
class Channel(models.Model):
    ...
    nbr_document = fields.Integer('Documents', compute='_compute_slides_statistics', store=True, compute_sudo=True)
    nbr_video = fields.Integer('Videos', compute='_compute_slides_statistics', store=True, compute_sudo=True)
    nbr_infographic = fields.Integer('Infographics', compute='_compute_slides_statistics', store=True, compute_sudo=True)
    nbr_article = fields.Integer("Articles", compute='_compute_slides_statistics', store=True, compute_sudo=True)
    nbr_quiz = fields.Integer("Number of Quizs", compute='_compute_slides_statistics', store=True, compute_sudo=True)
    total_slides = fields.Integer('Number of Contents', compute='_compute_slides_statistics', store=True, compute_sudo=True)
    total_views = fields.Integer('Visits', compute='_compute_slides_statistics', store=True, compute_sudo=True)
    total_votes = fields.Integer('Votes', compute='_compute_slides_statistics', store=True, compute_sudo=True)
    total_time = fields.Float('Duration', compute='_compute_slides_statistics', digits=(10, 2), store=True, compute_sudo=True)
