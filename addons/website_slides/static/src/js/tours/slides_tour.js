...
wTourUtils.registerWebsitePreviewTour('slides_tour', {
    ...
    trigger: '[is-ready="true"]:not(.o_ignore_in_tour):iframe a.btn-primary.o_wslides_js_slide_upload',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe a[data-slide-category="document"]',
    content: markup(_t("First, let's add a <b>Document</b>. It has to be a .pdf file.")),
    position: 'bottom',
}, {
    trigger: ':not(.o_ignore_in_tour):iframe input#upload',
    content: markup(_t("Choose a <b>File</b> on your computer.")),
}, {
    trigger: ':not(.o_ignore_in_tour):iframe input#name',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe input#duration',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe button.o_w_slide_upload_published',
    content: markup(_t("<b>Save & Publish</b> your lesson to make it available to your attendees.")),
    position: 'bottom',
    width: 285,
}, {
    trigger: '[is-ready="true"]:not(.o_ignore_in_tour):iframe span.badge:contains("New")',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe a[name="o_wslides_list_slide_add_quizz"]',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe input[name="question-name"]',
    content: markup(_t("Enter your <b>Question</b>. Be clear and concise.")),
    position: 'left',
    width: 330,
}, {
    trigger: ':not(.o_ignore_in_tour):iframe input.o_wslides_js_quiz_answer_value',
    content: markup(_t("Enter at least two possible <b>Answers</b>.")),
    position: 'left',
    width: 290,
}, {
    trigger: ':not(.o_ignore_in_tour):iframe a.o_wslides_js_quiz_is_correct',
    content: markup(_t("Mark the correct answer by checking the <b>correct</b> mark.")),
    position: 'right',
    width: 230,
}, {
    trigger: ':not(.o_ignore_in_tour):iframe i.o_wslides_js_quiz_comment_answer:last',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe a.o_wslides_js_quiz_validate_question',
    content: markup(_t("<b>Save</b> your question.")),
    position: 'left',
    width: 170,
}, {
    trigger: '[is-ready="true"]:not(.o_ignore_in_tour):iframe li.breadcrumb-item:nth-child(2)',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe a.o_wslides_js_slides_list_slide_link',
    ...
    trigger: ':not(.o_ignore_in_tour):iframe .o_wslides_fs_toggle_sidebar',
