...
class TestPartnerMerge(slides_common.SlidesCase):
    ...
    and destination partners to the destination partner.

    It also tests that the karma is adequately adjusted."""
    ...
    def setUpClass(cls):
        ...
        cls.user_student0, cls.user_student1, cls.user_student2 = cls.user_students
        # Initial karma
        cls.user_student0.karma = 100
        cls.user_student1.karma = 200
        cls.user_student2.karma = 300
        ...
        cls.complete_slide(cls.user_student0, cls.channel2_slide1)  # karma 10 for completing the channel (1 slide)
        cls.complete_slide(cls.user_student1, cls.slide_3)  # karma 42
    ...
    def test_initial_values(self):
        self.assertEqual(self.user_student0.karma, 100 + 10)
        self.assertEqual(self.user_student1.karma, 200 + 42)
        self.assertEqual(self.user_student2.karma, 300)
    ...
    def _test_merge_2_partners(self, partner_ids_to_merge):
        self.merge_partners(partner_ids_to_merge)

        # Check merge
        self.assertEqual(self.user_student0.partner_id, self.user_student1.partner_id)

        # Check karma
        self.assertEqual(self.user_student0.karma, 110 + 42)
        self.assertEqual(self.user_student1.karma, 242 + 10)

        # Check membership
        self.assertEqual(len(self.channel.partner_ids), 4 - 1)
        self.assertEqual(len(self.channel2.partner_ids), 2 - 0)
        self.assertIn(self.user_student0.partner_id, self.channel.partner_ids)
        self.assertIn(self.user_student0.partner_id, self.channel2.partner_ids)

        # Check completion
        self.assertTrue(self.slide.with_user(self.user_student0).user_has_completed)
        self.assertFalse(self.slide_2.with_user(self.user_student0).user_has_completed)
        self.assertTrue(self.slide_3.with_user(self.user_student0).user_has_completed)
        self.assertFalse(self.channel.with_user(self.user_student0).completed)
        self.assertTrue(self.channel2.with_user(self.user_student0).completed)
        self.env.invalidate_all(flush=False)

    def _test_merge_3_partners(self, partner_ids_to_merge):
        self.merge_partners(partner_ids_to_merge)

        # Check merge
        self.assertEqual(self.user_student0.partner_id, self.user_student1.partner_id)
        self.assertEqual(self.user_student0.partner_id, self.user_student2.partner_id)

        # Check karma
        self.assertEqual(self.user_student0.karma, 110 + 42 + 15)
        self.assertEqual(self.user_student1.karma, 242 + 10 + 15)
        ...
        # Check completion
        self.assertTrue(self.slide.with_user(self.user_student0).user_has_completed)
        self.assertTrue(self.slide_2.with_user(self.user_student0).user_has_completed)
        self.assertTrue(self.slide_3.with_user(self.user_student0).user_has_completed)
        self.assertTrue(self.channel.with_user(self.user_student0).completed)
        self.assertTrue(self.channel2.with_user(self.user_student0).completed)

    def test_merge_2_partners_perm0(self):
        self._test_merge_2_partners(self.merge_2_partners_permutation[0])

    def test_merge_2_partners_perm1(self):
        self._test_merge_2_partners(self.merge_2_partners_permutation[1])

    def test_merge_3_partners_perm0(self):
        self._test_merge_3_partners(self.merge_3_partners_permutation[0])

    def test_merge_3_partners_perm1(self):
        self._test_merge_3_partners(self.merge_3_partners_permutation[1])

    def test_merge_3_partners_perm2(self):
        self._test_merge_3_partners(self.merge_3_partners_permutation[2])

    def test_merge_3_partners_perm3(self):
        self._test_merge_3_partners(self.merge_3_partners_permutation[3])

    def test_merge_3_partners_perm4(self):
        self._test_merge_3_partners(self.merge_3_partners_permutation[4])

    def test_merge_3_partners_perm5(self):
        self._test_merge_3_partners(self.merge_3_partners_permutation[5])
