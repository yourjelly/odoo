...
class WebsiteSlides(WebsiteProfile):
    ...
    def _build_channel_domain(
        self, base_domain, slide_type=None, slug_tags=None, my=False, **post
    ):
    ...
    def _create_or_get_channel_tag(self, tag_id, group_id):
        ...
        if tag_id[0] == 0:
            ...
            new_tag = request.env["slide.channel.tag"].create(
                {"name": tag_id[1]["name"], "group_id": group_id,}
            )
            return new_tag
    ...
    def slides_channel_all(self, slide_type=None, slug_tags=None, my=False, **post):
        ...
        domain = self._build_channel_domain(
            domain, slide_type=slide_type, slug_tags=slug_tags, my=my, **post
        )
    ...
    def slide_quiz_question_add_or_update(
        ...
        return request.env.ref("website_slides.lesson_content_quiz_question")._render(
            {"slide": slide, "question": slide_question,}
        )
