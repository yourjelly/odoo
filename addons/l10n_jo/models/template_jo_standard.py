...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_jo_standard_template_data(self):
        return {
            ...
            'property_account_expense_categ_id': 'jo_account_500200',
            'property_account_income_categ_id': 'jo_account_400100',
            'property_account_expense_id': 'jo_account_500200',
            'property_account_income_id': 'jo_account_400100',
