...
class AccountMove(models.Model):
    ...
    def _check_invoice_type_document_type(self):
        ...
        ar_doctype_99 = self.filtered(
            ...
            and x.l10n_latam_document_type_id.code == "99"
    ...
    def _inverse_l10n_latam_document_number(self):
        ...
        to_review = self.filtered(
            lambda x: x.journal_id.type == "sale"
    ...
    def _get_starting_sequence(self):
        ...
        if (
            ...
            and self.env.company.country_id.code == "AR"
        ):
    ...
    def _get_vat(self):
        ...
        for vat in vat_taxable:
            ...
            res += [
                {
                    "Id": vat.tax_line_id.tax_group_id.l10n_ar_vat_afip_code,
                    "BaseImp": base_imp,
