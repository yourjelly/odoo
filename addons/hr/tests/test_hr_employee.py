...
class TestHrEmployee(TestHrCommon):
    ...
    def test_employee_has_avatar_even_if_it_has_no_image(self):
        self.assertIsNotNone(self.employee_without_image.avatar_128)
        self.assertIsNotNone(self.employee_without_image.avatar_256)
        self.assertIsNotNone(self.employee_without_image.avatar_512)
        self.assertIsNotNone(self.employee_without_image.avatar_1024)
        self.assertIsNotNone(self.employee_without_image.avatar_1920)
