...
class User(models.Model):
    ...
    employee_phone = fields.Char(related='employee_id.phone', readonly=False, compute_sudo=False)
    work_email = fields.Char(related='employee_id.work_email', readonly=False, compute_sudo=False)
    category_ids = fields.Many2many(related='employee_id.category_ids', string="Employee Tags", readonly=False, compute_sudo=False)
    department_id = fields.Many2one(related='employee_id.department_id', readonly=False, compute_sudo=False)
    address_id = fields.Many2one(related='employee_id.address_id', readonly=False, compute_sudo=False)
    work_location = fields.Char(related='employee_id.work_location', readonly=False, compute_sudo=False)
    employee_parent_id = fields.Many2one(related='employee_id.parent_id', compute_sudo=False)
    coach_id = fields.Many2one(related='employee_id.coach_id', readonly=False, compute_sudo=False)
    address_home_id = fields.Many2one(related='employee_id.address_home_id', readonly=False, compute_sudo=False)
    is_address_home_a_company = fields.Boolean(related='employee_id.is_address_home_a_company', readonly=False, compute_sudo=False)
    private_email = fields.Char(related='address_home_id.email', string="Private Email", readonly=False)
    km_home_work = fields.Integer(related='employee_id.km_home_work', readonly=False, compute_sudo=False)
    # res.users already have a field bank_account_id and country_id from the res.partner inheritance: don't redefine them
    employee_bank_account_id = fields.Many2one(related='employee_id.bank_account_id', string="Employee's Bank Account Number", compute_sudo=False, readonly=False)
    employee_country_id = fields.Many2one(related='employee_id.country_id', string="Employee's Country", readonly=False, compute_sudo=False)
    identification_id = fields.Char(related='employee_id.identification_id', readonly=False, compute_sudo=False)
    passport_id = fields.Char(related='employee_id.passport_id', readonly=False, compute_sudo=False)
    gender = fields.Selection(related='employee_id.gender', readonly=False, compute_sudo=False)
    birthday = fields.Date(related='employee_id.birthday', readonly=False, compute_sudo=False)
    place_of_birth = fields.Char(related='employee_id.place_of_birth', readonly=False, compute_sudo=False)
    country_of_birth = fields.Many2one(related='employee_id.country_of_birth', readonly=False, compute_sudo=False)
    marital = fields.Selection(related='employee_id.marital', readonly=False, compute_sudo=False)
    spouse_complete_name = fields.Char(related='employee_id.spouse_complete_name', readonly=False, compute_sudo=False)
    spouse_birthdate = fields.Date(related='employee_id.spouse_birthdate', readonly=False, compute_sudo=False)
    children = fields.Integer(related='employee_id.children', readonly=False, compute_sudo=False)
    emergency_contact = fields.Char(related='employee_id.emergency_contact', readonly=False, compute_sudo=False)
    emergency_phone = fields.Char(related='employee_id.emergency_phone', readonly=False, compute_sudo=False)
    visa_no = fields.Char(related='employee_id.visa_no', readonly=False, compute_sudo=False)
    permit_no = fields.Char(related='employee_id.permit_no', readonly=False, compute_sudo=False)
    visa_expire = fields.Date(related='employee_id.visa_expire', readonly=False, compute_sudo=False)
    additional_note = fields.Text(related='employee_id.additional_note', readonly=False, compute_sudo=False)
    barcode = fields.Char(related='employee_id.barcode', readonly=False, compute_sudo=False)
    pin = fields.Char(related='employee_id.pin', readonly=False, compute_sudo=False)
    certificate = fields.Selection(related='employee_id.certificate', readonly=False, compute_sudo=False)
    study_field = fields.Char(related='employee_id.study_field', readonly=False, compute_sudo=False)
    study_school = fields.Char(related='employee_id.study_school', readonly=False, compute_sudo=False)
