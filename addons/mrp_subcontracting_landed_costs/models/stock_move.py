...
class StockMove(models.Model):
    ...
    def get_stock_valuation_layer_ids(self):
        stock_valuation_layer_ids = super().get_stock_valuation_layer_ids()
        subcontracted_productions = self._get_subcontract_production()
        if self.is_subcontract and subcontracted_productions:
            return (subcontracted_productions.move_raw_ids | subcontracted_productions.move_finished_ids).stock_valuation_layer_ids
