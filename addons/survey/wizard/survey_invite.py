    ...
    def _send_mail(self, answer):
        ...
        if email_layout_xmlid:
            template_ctx = {
                ...
                'title': answer.survey_id.certification and 'Start Certification' or 'Start Survey' if self.env.context['active_model'] == 'survey.survey' else 'Start the written interview'
            }
