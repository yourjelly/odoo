...
registry.category("web_tour.tours").add('test_survey_session_manage_tour', {
    ...
    content: "Final Leaderboard is displayed",
}, {
    trigger: 'h1',
    run: () => {
    ...
    content: "check that we can start another session",
}])});
