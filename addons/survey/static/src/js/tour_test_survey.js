...
tour.register('test_survey', {
    ...
    [
        ...
        // Question: What do you think about the structure of the menus?
        {
            ...
            trigger: 'input[name="1_8_30"][value="30"]',
            run: 'text 30',
        },
        ...
        {
            content: "Checking 'I'd like to contribute but I don't know how?'",
            trigger: 'input[name="1_13_53"][value="53"]',
            run: 'text 53',
        },
        // Question: Do you have a proposition to help people to contribute?
        {
            content: "Writing answer",
            trigger: 'textarea[name="1_14"]',
        ...
        // Question: Where do you develop your new features?
        {
            ...
            trigger: 'input[name="1_17_59"][value="59"]',
            run: 'text 59',
        },
        {
