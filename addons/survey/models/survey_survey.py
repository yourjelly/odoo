...
class Survey(models.Model):
    ...
    def _compute_survey_statistic(self):
        ...
        for survey_id, values in stat.items():
            ...
            stat[survey_id]["answer_score_avg"] = avg_total / (
                stat[survey_id]["answer_done_count"] or 1
            )
            stat[survey_id]["success_ratio"] = (
                stat[survey_id]["success_count"]
                / (stat[survey_id]["answer_done_count"] or 1.0)
            ) * 100
        ...
        **additional_vals
        ...
        for survey in self:
            ...
            if survey.session_state == "in_progress":
                ...
                answer_vals.update(
                    {"state": "in_progress", "start_datetime": fields.Datetime.now(),}
                )
    ...
    def action_send_survey(self):
        ...
        if (
            not self.page_ids and self.questions_layout == "page_per_section"
        ) or not self.question_ids:
            raise exceptions.UserError(
