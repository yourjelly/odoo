...
class TestStockPickingWave(common.TransactionCase):
    ...
    def setUp(self):
        ...
        # self.stock_picking_type_internal = self.ref('stock.picking_type_internal')
        # self.wave_ids = self.ref('stock_picking_wave_freeze_2')
    ...
    def test_00_test_picking(self):
        ...
        # self.stock_picking_wave = self.stock_picking_wave.create({})
