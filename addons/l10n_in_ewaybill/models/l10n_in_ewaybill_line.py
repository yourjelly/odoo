...
class EwaybillStockLine(models.Model):
    ...
    _description = "Ewaybill line for stock movement"
    ...
    product_id = fields.Many2one(
        ...
        string='Product', related="stock_move_id.product_id", store=True, readonly=False)

    quantity = fields.Float(
        'Quantity', digits='Product Unit of Measure', related="stock_move_id.quantity_done", store=True, readonly=False)
