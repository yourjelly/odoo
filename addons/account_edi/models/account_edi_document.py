...
class AccountEdiDocument(models.Model):
            ...
            if doc.state in ('to_send', 'to_cancel'):
                ...
                if config_errors:
                    ...
                    if move_applicability and move_applicability.get('edi_content'):
                        res = base64.b64encode(move_applicability['edi_content_method'](move))
            doc.edi_content = res
        ...
        * doc_type:       Are the moves of this job invoice or payments ?
        ...
        for state, edi_flow in (('to_send', 'post'), ('to_cancel', 'cancel')):
            ...
            for edi_doc in documents:
                ...
                move_applicability = edi_doc.edi_format_id._get_move_applicability(move)

                batching_key = [edi_format, state, move_applicability.get(edi_flow), move.company_id]
    ...
    def _process_job(self, job):
        ...
        if job['method_to_call']:
            method_to_call = getattr(edi_format, job['method_to_call'])
        else:
