...
class CrmLead(models.Model):
    ...
    partner_assigned_id = fields.Many2one('res.partner', 'Assigned Partner', track_visibility='onchange', is_business_field=True, help="Partner this case has been forwarded/assigned to.", index=True)
