...
class ResPartner(models.Model):
    ...
    grade_id = fields.Many2one('res.partner.grade', 'Level', track_visibility='onchange', is_business_field=True)
    ...
    date_partnership = fields.Date('Partnership Date', is_business_field=True)
