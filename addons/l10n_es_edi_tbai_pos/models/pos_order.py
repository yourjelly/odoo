...
class PosOrder(models.Model):
    ...
    def action_pos_order_paid(self):
        ...
        if not self.to_invoice and self.refunded_order_id and self.refunded_order_id.account_move:
            raise UserError(_("Please create an invoice for a refund whose related order was invoiced."))
