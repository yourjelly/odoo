odoo.define('website_hr_recruitment.tour', function(require) {
    ...
    wTourUtils.registerEditionTour('website_hr_recruitment_tour_edit_form', {
        ...
        run: () => {
            ...
            document.querySelector('.o_iframe:not(.o_technical_iframe)').contentDocument.querySelector('input[name="job_id"]').value = 'FAKE_JOB_ID_DEFAULT_VAL';
        },
    }, {
        ...
        run: () => {
            ...
            if (!document.querySelector('.o_iframe:not(.o_technical_iframe)').contentDocument.querySelector(selector)) {
        ...
        trigger: '#oe_snippets.o_loaded',
        run: () => {
            if (!document.querySelector('.o_iframe:not(.o_technical_iframe)').contentDocument.querySelector('input[name="job_id"][value="FAKE_JOB_ID_DEFAULT_VAL"]')) {
