...
class WebsiteVisitor(models.Model):
    ...
    def action_send_chat_request(self):
        ...
        if mail_channel_vals_list:
            ...
            channel_members.write(
                {"fold_state": "open", "is_minimized": True,}
            )
            ...
            for mail_channel_info in mail_channels_info:
                notifications.append(
                    [
                        (self._cr.dbname, "res.partner", operator.partner_id.id),
                        mail_channel_info,
                    ]
                )
    ...
    def _link_to_partner(self, partner, update_values=None):
        ...
        super(WebsiteVisitor, self)._link_to_partner(
            partner, update_values=update_values
        )
