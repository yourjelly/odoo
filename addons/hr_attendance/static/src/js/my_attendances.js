...
class MyAttendances extends owl.Component{
...
// debugger;
MyAttendances.template = "HrAttendanceMyMainMenu";
const my_attendances = new MyAttendances(); 
core.action_registry.add('hr_attendance_my_attendances', my_attendances);
