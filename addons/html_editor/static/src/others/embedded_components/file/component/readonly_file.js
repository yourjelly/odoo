...
} from "../../embedded_component_toolbar/embedded_component_toolbar";
import { StateFileModel } from "@html_editor/others/embedded_components/file/state_file_model";
import { getEmbeddedProps } from "@html_editor/others/embedded_component_utils";
import { Component, useState } from "@odoo/owl";

export class ReadonlyFileEmbeddedComponent extends Component {
    static components = {
        EmbeddedComponentToolbar,
        EmbeddedComponentToolbarButton,
    };
    ...
    static template = "html_editor.ReadonlyFileEmbeddedComponent";
...
export const readonlyFileEmbedding = {
    name: "file",
    Component: ReadonlyFileEmbeddedComponent,
    getProps: (host) => {
