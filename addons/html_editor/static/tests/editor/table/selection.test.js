...
describe("select a full table on cross over", () => {
    ...
    describe("toggleFormat", () => {
        test.todo("should apply bold to some characters and a table", async () => {
            await testEditor({
                contentBefore:
...
describe("select columns on cross over", () => {
    ...
    describe("toggleFormat", () => {
        test.todo("should apply bold to two columns", async () => {
            await testEditor({
                contentBefore:
                    "<table><tbody><tr>" +
                    "<td>a[b</td>" +
    ...
    describe("reset size", () => {
        test.todo(
            "should remove any height or width of the table and bring it back to it original form",
            async () => {
                await testEditor({
