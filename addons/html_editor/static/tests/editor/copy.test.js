...
describe("range not collapsed", () => {
    test("should copy a selection as text/plain, text/html and text/odoo-editor only text", async () => {
    ...
    test("should copy a selection as text/plain, text/html and text/odoo-editor with a <br>", async () => {
    ...
    test("should copy a selection as text/plain, text/html and text/odoo-editor in table", async () => {
        await setupEditor(
