...
class MailingSMSController(http.Controller):
    ...
    def blacklist_page(self, mailing_id, trace_code, **post):
        ...
        if sms_number:
            ...
            tocheck_number = sanitized_number or sms_number
            ...
            unsubscribe_error = _('Invalid number %s', tocheck_number) if not sanitized_number else _('Number %s not found', tocheck_number)
