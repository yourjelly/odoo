...
class HsnGstReport(models.Model):
    ...
    def get_gst_tag_ids(self):
        igst_tag = self.env.ref('l10n_in_gst.igst_tag_tax', False)
        cgst_tag = self.env.ref('l10n_in_gst.cgst_tag_tax', False)
        sgst_tag = self.env.ref('l10n_in_gst.sgst_tag_tax', False)
