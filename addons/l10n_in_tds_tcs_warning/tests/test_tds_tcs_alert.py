...
class TestTdsTcsAlert(L10nInTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.purchase_account.write({
            'l10n_in_tds_tcs_section': ChartTemplate.ref('tds_section_194c').id
        })
        ...
        cls.internet_account.write({
            'l10n_in_tds_tcs_section': ChartTemplate.ref('tds_section_194j').id
        })
        cls.rent_account = ChartTemplate.ref('p2111')
        cls.rent_account.write({
            'l10n_in_tds_tcs_section': ChartTemplate.ref('tds_section_194ib').id
        })
        cls.sale_account = ChartTemplate.ref('p20011')
        cls.sale_account.write({
            'l10n_in_tds_tcs_section': ChartTemplate.ref('tcs_section_206c1g_r').id
        })
        ...
        cls.tax_194c.write({'l10n_in_section_id': ChartTemplate.ref('tds_section_194c').id})
        cls.tax_194j = ChartTemplate.ref('tds_10_us_194j')
        cls.tax_194j.write({'l10n_in_section_id': ChartTemplate.ref('tds_section_194j').id})
        cls.tax_194ib = ChartTemplate.ref('tds_20_us_194ib')
        cls.tax_194ib.write({'l10n_in_section_id': ChartTemplate.ref('tds_section_194ib').id})
        cls.tax_206c1g_r = ChartTemplate.ref('tcs_5_us_206c_1g_som')
        cls.tax_206c1g_r.write({'l10n_in_section_id': ChartTemplate.ref('tcs_section_206c1g_r').id})
