        ...
        for product in self:
            ...
            if manufacture_orders:
                for order in manufacture_orders:
                    ...
                    total_manufacture_cost += res1['data']['summary']['mo_cost']
                    nos_of_products_manufactured+= res1['data']['summary']['quantity']
                    if order.scrap_count >0:
                        ...
                        for scrap_order in scrap_orders:
                            scrap_quantities+=scrap_order.scrap_qty
                        nos_of_products_manufactured-=scrap_quantities
