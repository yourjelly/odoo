...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_it_edi_check_invoice_configuration(self, invoice):
        ...
        if (
            ...
            errors.append(
                _(
                    "The buyer, %s, or his company must have either a VAT number either a tax code (Codice Fiscale).",
                    buyer.display_name,
                )
            )
                ...
                if discount_elements:
                    for discount_element in discount_elements:
                        ...
                        if discount_amount_text and discount_amount_text[0].text:
                            discount_amount = (
                                float(discount_amount_text[0].text) * discount_sign * -1
                            )
                            discount = {}
                            discount["seq"] = 0
                        ...
                        with invoice_form.invoice_line_ids.new() as invoice_line_form:
                            ...
                            if line_elements:
                                for line_element in line_elements:
                                    ...
                                    if (
                                        discount_percentage
                                        and discount_percentage[0].text
                                    ):
                                        pourcentage_actual = (
                                            1
                                            - float(discount_percentage[0].text)
                                ...
                                if total_discount_amount != 0:
                                    ...
                                    if total_discount_amount < 0:
                                        discount["name"] = _(
                                            "DISCOUNT: %s", invoice_line_form.name
                                        )
                                    else:
                                        discount["name"] = _(
                                            "EXTRA CHARGE: %s", invoice_line_form.name
                                        )
