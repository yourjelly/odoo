...
patch(SaleOrderLineProductField.prototype, {
    ...
    async _onProductUpdate() {
        ...
        if (this.props.record.data.product_type === 'service' && this.props.record.data.service_tracking === 'event') {
    ...
    _editLineConfiguration() {
        ...
        if (this.props.record.data.product_type === 'event' && this.props.record.data.service_tracking === 'event') {
            this._openEventConfigurator();
        }
    },

    get isConfigurableLine() {
        return super.isConfigurableLine || (this.props.record.data.product_type === 'service' && this.props.record.data.service_tracking === 'event');
    },
