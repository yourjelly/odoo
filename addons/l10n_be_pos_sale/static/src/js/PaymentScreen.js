...
export const PoSSaleBePaymentScreen = (PaymentScreen) =>
    class extends PaymentScreen {
        toggleIsToInvoice() {
            ...
            const has_intracom_taxes = orderLines.some(line=>line.tax_ids?.some(tax=>this.env.pos.intracom_tax_ids.includes(tax)));
            if(this.currentOrder.is_to_invoice() && this.env.pos.company.country?.code === "BE" && has_origin_order && has_intracom_taxes){
