...
export class DocsPortalWebClient extends Component {
    static props = {};
    static components = { ActionContainer, MainComponentsContainer };
    static template = "test_docs.DocsPortalWebClient";
    ...
    async _showView() {
        ...
        await this.actionService.doAction("test_docs.document_document_action", {
