...
class TestResMixin(TestResourceCommon):
    def test_adjust_calendar(self):
        ...
        self.assertEqual(
            result[self.john],
            (datetime_tz(2020, 4, 3, 8, 0, 0, tzinfo=self.john.tz), None,),
        )
        ...
        self.assertEqual(
            result[self.john],
            (None, datetime_tz(2020, 4, 3, 13, 0, 0, tzinfo=self.john.tz),),
        )
    ...
    def test_adjust_calendar_timezone_after(self):
        ...
        self.assertEqual(
            result[self.john],
            (datetime(2020, 4, 3, 6, 0, 0), datetime(2020, 4, 3, 21, 0, 0),),
    ...
    def test_list_work_time_per_day(self):
        ...
        self.assertEqual(
            working_time, [(date(2018, 4, 10), 8), (date(2018, 4, 13), 12),]
        )
...
class TestTimezones(TestResourceCommon):
    ...
    def test_work_hours_count(self):
        ...
        count = self.calendar_jean.get_work_hours_count(
            datetime_tz(2018, 4, 10, 8, 0, 0), datetime_tz(2018, 4, 10, 12, 0, 0),
        )
    ...
    def test_work_data(self):
        ...
        data = self.jean._get_work_days_data_batch(
            datetime_tz(2018, 4, 9, 8, 0, 0), datetime_tz(2018, 4, 13, 16, 0, 0),
        )[self.jean.id]
