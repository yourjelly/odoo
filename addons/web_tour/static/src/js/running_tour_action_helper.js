...
var RunningTourActionHelper = core.Class.extend({
    ...
    _drag_and_drop: function (element, to) {
        ...
        element.dispatchEvent(new MouseEvent("mousedown", { bubbles: true, which: 1, button: 0, clientX: elementCenter.left, clientY: elementCenter.top}));
        element.dispatchEvent(new Event("mousemove", { bubbles: true }));
        to.dispatchEvent(new Event("mouseenter", { bubbles: true, clientX: toCenter.left, clientY: toCenter.top }));
