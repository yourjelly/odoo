...
""",
    ...
    "assets": {
        "web.assets_qweb": ["web_tour/static/src/debug/tour_dialog_component.xml",],
        "web.assets_common": [
        ...
        "web.assets_frontend": ["web_tour/static/src/js/public/**/*",],
        "web.qunit_suite_tests": ["web_tour/static/tests/**/*",],
    },
    "auto_install": True,
}
