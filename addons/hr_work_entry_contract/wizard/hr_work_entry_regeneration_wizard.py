        ...
        for wizard in self:
            ...
            if wizard.search_criteria_completed:
                ...
                if (
                    ...
                    wizard.earliest_available_date_message = "The earliest available date is {date}".format(
                ...
                if (
                    ...
                    wizard.latest_available_date_message = "The latest available date is {date}".format(
