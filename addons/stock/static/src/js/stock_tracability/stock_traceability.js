...
import { StockTracabilityControlPanel } from "./stock_traceability_control_panel";
import { StockTracabilityReport } from "./stock_traceability_report";
import { registry } from "@web/core/registry";

const { Component } = owl;

class StockTracability extends Component {
    setup() {
        this.lotId = this.props.action.context.active_id;  
    }
}

StockTracability.template = "stock.stockTracability";
StockTracability.components = {
    StockTracabilityControlPanel,
    StockTracabilityReport,
};

registry.category("actions").add("stock_report_generic", StockTracability);
