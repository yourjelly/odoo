...
class StockQuant(models.Model):
    ...
    def _domain_location_id(self):
        if self.env.user._has_group('stock.group_stock_user'):
    ...
    def action_view_inventory(self):
        ...
        ctx['no_at_date'] = True
        if self.env.user._has_group('stock.group_stock_user') and not self.env.user._has_group('stock.group_stock_manager'):
    ...
    def _is_inventory_mode(self):
        ...
        """
        return self.env.context.get('inventory_mode') and self.env.user._has_group('stock.group_stock_user')
    ...
    def _get_quants_action(self, domain=None, extend=False):
        ...
        if self.env.context.get('inventory_mode') and self.env.user._has_group('stock.group_stock_manager'):
