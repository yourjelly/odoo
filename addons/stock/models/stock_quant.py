...
from odoo.tools import check_barcode_encoding, groupby, SQL, is_valid_code_128
...
class QuantPackage(models.Model):
    ...
    valid_code_128 = fields.Boolean(string="Is Package Name in Code 128", compute='_compute_valid_code_128', store=True)
