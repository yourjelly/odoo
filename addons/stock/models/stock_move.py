...
class StockMove(models.Model):
    ...
    def _compute_show_details_visible(self):
        ...
        """
        has_package = self.env.user._has_group('stock.group_tracking_lot')
        multi_locations_enabled = self.env.user._has_group('stock.group_stock_multi_locations')
        consignment_enabled = self.env.user._has_group('stock.group_tracking_owner')
