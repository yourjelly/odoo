    ...
    def _sanity_check(self, separate_pickings=True):
        ...
        if not self._should_show_transfers():
            if pickings_without_moves:
                raise UserError(_("Please add some products to move.\n\nYou can’t validate an empty transfer. Please add some items that you would like to move before proceeding."))
