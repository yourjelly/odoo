...
class StockWarehouseOrderpoint(models.Model):
    ...
    snooze_until = fields.Date('Snoozed', help="Hidden until next scheduler.")
    ...
    def action_replenish(self):
        ...
        self._compute_qty()
        self.filtered(lambda o: o.create_uid.id == SUPERUSER_ID and o.qty_to_order <= 0.0 and self.trigger == 'manual').unlink()
        return notification
    ...
    def _get_orderpoint_action(self):
        """Replenish report main function. Check for products missing in warehouses.
        """
