...
class ProductTemplate(models.Model):
    ...
    property_stock_production = fields.Many2one(
        ...
        company_dependent=True, domain="[('usage', '=', 'production'), '|', ('company_id', '=', False), ('company_id', '=', company_id)]",
        help="This stock location will be used, instead of the default one, as the source location for stock moves generated by manufacturing orders.")
    property_stock_inventory = fields.Many2one(
        'stock.location', "Inventory Location",
        company_dependent=True, domain="[('usage', '=', 'inventory'), '|', ('company_id', '=', False), ('company_id', '=', company_id)]",
