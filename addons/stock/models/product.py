...
class ProductTemplate(models.Model):
    ...
    _inherit = ['product.template', 'company.consistency.mixin']
    ...
    property_stock_production = fields.Many2one(
        ...
        company_dependent=True, domain="[('usage', '=', 'production'), '|', ('company_id', '=', False), ('company_id', '=', allowed_company_ids[0])]",
        help="This stock location will be used, instead of the default one, as the source location for stock moves generated by manufacturing orders.")
    property_stock_inventory = fields.Many2one(
        'stock.location', "Inventory Location",
        company_dependent=True, domain="[('usage', '=', 'inventory'), '|', ('company_id', '=', False), ('company_id', '=', allowed_company_ids[0])]",
    ...
    def _company_consistency_m2o_property_optional_cid_fields(self):
        res = super(ProductTemplate, self)._company_consistency_m2o_property_optional_cid_fields()
        return res + ['property_stock_production', 'property_stock_inventory']
