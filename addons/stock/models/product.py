...
class Product(models.Model):
    ...
    def action_view_orderpoints(self):
        ...
        action['domain'] = ['!', '&', ('active', '=', False), ('create_uid', '=', SUPERUSER_ID)]
        if self and len(self) == 1:
            ...
            action['domain'] = [('product_id', 'in', self.ids)] + action.get('domain')
        return action
...
class ProductTemplate(models.Model):
    ...
    def action_view_orderpoints(self):
        return self.mapped('product_variant_ids').action_view_orderpoints()
