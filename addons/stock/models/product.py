...
class ProductTemplate(models.Model):
    ...
    def _compute_quantities_dict(self):
        ...
        for template in self:
            ...
            outgoing_qty = 0
            for p in variants:
                qty_available += variants_quantites_dict[p.id]["qty_available"]
                virtual_available += variants_quantites_dict[p.id]["virtual_available"]
                incoming_qty += variants_quantites_dict[p.id]["incoming_qty"]
                outgoing_qty += variants_quantites_dict[p.id]["outgoing_qty"]
