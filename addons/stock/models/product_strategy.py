...
class StockPutawayRule(models.Model):
    ...
    def create(self, vals):
        rules = super(StockPutawayRule, self).create(vals)
        rules._company_consistency_check()
        return rules
    ...
    def _company_consistency_m2o_optional_cid_fields(self):
        res = super(StockPutawayRule, self)._company_consistency_m2o_optional_cid_fields()
        return res + ['product_id', 'location_in_id', 'location_out_id']
