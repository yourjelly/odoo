...
class Location(models.Model):
    ...
    def _get_putaway_strategy(self, product, quantity=0, package=None, packaging=None):
        ...
        # If not product putaway found, we're looking for category putaway.
        ...
        # If not product category found and if package_type, looking putaway with only package_type
        if package_type:
    ...
    def _check_product_storage(self, product, quantity):
        ...
        if self.storage_category_id:
            ...
            if self.storage_category_id.allow_new_product == "empty" and self.quant_ids:
                return False
