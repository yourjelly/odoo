        ...
        if putaway_rules:
            ...
            if locations.storage_category_id:
                if package and package.package_type_id:
                    ...
                    ], ['location_dest_id'], ['reserved_qty:array_agg', 'qty_done:array_agg', 'product_uom_id:array_agg'])
                    quant_data = self.env['stock.quant']._read_group([
                        ('product_id', '=', product.id),
                        ('location_id', 'in', locations.ids),
                    ...
                    for location_dest, reserved_qty_list, qty_done_list, uom_ids in move_line_data:
