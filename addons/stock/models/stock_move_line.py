...
class StockMoveLine(models.Model):
    ...
    def _onchange_putaway_location(self):
        ...
        if not self.id and self.env.user._has_group('stock.group_stock_multi_locations') and self.product_id and self.quantity_product_uom \
    ...
    def _get_default_dest_location(self):
        if not self.env.user._has_group('stock.group_stock_storage_categories'):
