...
class StockMoveLine(models.Model):
    ...
    state = fields.Selection(related='move_id.state', store=True, compute_sudo=False, readonly=False)
    ...
    reference = fields.Char(related='move_id.reference', store=True, compute_sudo=False, readonly=False)
