...
class TestStockFlow(TestStockCommon):
    ...
    def test_00_picking_create_and_transfer_quantity(self):
        ...
        move_cust_c.move_line_ids[0].write(
            {"qty_done": 2.0, "lot_id": lot2_productC.id,}
        )
        self.StockPackObj.create(
            {
                "product_id": self.productC.id,
        ...
        packD[0].write(
            {"qty_done": 8, "lot_id": lot1_productD.id,}
        )
        ...
        packCs.write(
            {"qty_done": 1, "lot_id": lot3_productC.id,}
        )
        self.StockPackObj.create(
            {
                "product_id": self.productC.id,
    ...
    def test_10_pickings_transfer_with_different_uom(self):
        ...
        self.assertEqual(
            sum(total_qty),
            525.3,
            "Expecting 525.3 gram , got %.4f gram on location stock!"
            % (sum(total_qty)),
        )
        self.assertEqual(
            self.gB.qty_available,
            525.3,
            "Wrong quantity available (%s found instead of 525.3"
            % (self.gB.qty_available),
        )
        ...
        self.assertEqual(
            sum(total_qty),
            999.9995,
            "Expecting 999.9995 kg , got %.4f kg on location stock!" % (sum(total_qty)),
        )
        ...
        self.assertEqual(
            ...
            2.0,
            "Wrong move quantity (%s found instead of 2.0)"
            % (moves_KG.product_uom_qty),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            sum(total_qty),
            999.9990,
            "Expecting 999.9990 kg , got %.4f kg on location stock!" % (sum(total_qty)),
        )
        ...
        self.assertEqual(
            moves_KG.product_uom_qty,
            1.5,
            "Wrong move quantity (%s found instead of 1.5)"
            % (moves_KG.product_uom_qty),
        )
        self.assertEqual(
            moves_KG.product_uom.id, self.uom_gm.id, "Wrong uom in move for product KG."
        ...
        self.assertEqual(
            sum(total_qty),
            999.9985,
            "Expecting 999.9985 kg , got %.4f kg on location stock!" % (sum(total_qty)),
        )
        ...
        self.assertEqual(
            moves_KG.product_uom_qty,
            1,
            "Wrong move quantity (%s found instead of 1.0)"
            % (moves_KG.product_uom_qty),
        )
        self.assertEqual(
            moves_KG.product_uom.id, self.uom_gm.id, "Wrong uom in move for product KG."
        ...
        self.assertEqual(
            sum(total_qty),
            999.9980,
            "Expecting 999.9980 kg , got %.4f kg on location stock!" % (sum(total_qty)),
        )
        ...
        self.assertEqual(
            moves_KG.product_uom_qty,
            0.5,
            "Wrong move quantity (%s found instead of 0.5)"
            % (moves_KG.product_uom_qty),
        )
        self.assertEqual(
            moves_KG.product_uom.id, self.uom_gm.id, "Wrong uom in move for product KG."
        ...
        self.assertAlmostEqual(
            sum(total_qty),
            999.9975,
            msg="Expecting 999.9975 kg , got %.4f kg on location stock!"
            % (sum(total_qty)),
        )
