...
class TestStockCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.picking_type_out = cls.ModelDataObj.xmlid_to_res_id(
            "stock.picking_type_out"
        )
        cls.env["stock.picking.type"].browse(
            cls.picking_type_out
        ).reservation_method = "manual"
        cls.supplier_location = cls.ModelDataObj.xmlid_to_res_id(
            "stock.stock_location_suppliers"
        )
        cls.stock_location = cls.ModelDataObj.xmlid_to_res_id(
        ...
        cls.customer_location = cls.ModelDataObj.xmlid_to_res_id(
