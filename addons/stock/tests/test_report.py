...
class TestReportsCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.picking_type_in = cls.env["stock.picking.type"].browse(
            cls.ModelDataObj.xmlid_to_res_id("stock.picking_type_in")
        )
        cls.picking_type_out = cls.env["stock.picking.type"].browse(
            cls.ModelDataObj.xmlid_to_res_id("stock.picking_type_out")
        )
        cls.supplier_location = cls.env["stock.location"].browse(
            cls.ModelDataObj.xmlid_to_res_id("stock.stock_location_suppliers")
        )
        cls.stock_location = cls.env["stock.location"].browse(
            cls.ModelDataObj.xmlid_to_res_id("stock.stock_location_stock")
        )
