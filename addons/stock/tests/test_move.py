...
class StockMove(TransactionCase):
    ...
    def test_putaway_5(self):
        ...
        self.stock_location.write(
            {"putaway_rule_ids": [(6, 0, [putaway.id,])],}
        )
        # creation
        move1 = self.env["stock.move"].create(
            {
    ...
    def test_putaway_6(self):
        ...
        self.stock_location.write(
            {
                "putaway_rule_ids": [
                    (6, 0, [putaway_category_all.id, putaway_category_office_furn.id,])
                ],
            }
        )
    ...
    def test_putaway_with_storage_category_5(self):
        ...
        package_type = self.env["stock.package.type"].create({"name": "package type",})
