...
class StockMove(TransactionCase):
    ...
    def test_putaway_3(self):
        ...
        the receipt move line.
        """
        # This test will apply a both the putaway strategy by product and category on the stock location to put everything
        # incoming in the sublocation selected by putaway stratagy.
