    ...
    def default_get(self, fields):
        ...
        if picking:
            ...
            for move in picking.move_lines:
                ...
                for move_line in move.move_dest_ids.filtered(lambda m: m.state in ['partially_available', 'assigned', 'done']).mapped('move_line_ids').mapped('product_qty'):
                    quantity -= move_line.product_uom_id._compute_quantity(move_line.product_uom_qty, move.product_uom, rounding_method='HALF-UP')
