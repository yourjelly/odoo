...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    def test_event_mail_schedule(self):
        ...
        self.assertEqual(capture.records[0].call_at, now.replace(microsecond=0))
        self.assertEqual(capture.records[0].cron_id, self.env.ref('event.event_mail_scheduler'))
        ...
        self.assertEqual(
            ...
            "Should have called 2 times execution (batch of 10 with 15 registrations left = 2 iterations)"
        )
