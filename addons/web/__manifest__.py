...
""",
    ...
    "assets": {
        ...
        "web.report_assets_pdf": ["web/static/src/css/reset.min.css",],
        # ---------------------------------------------------------------------
        # SUB BUNDLES
        # ---------------------------------------------------------------------
        ...
        "web.frontend_legacy": ["web/static/src/legacy/frontend/**/*",],
        # ---------------------------------------------------------------------
        # TESTS BUNDLES
        # ---------------------------------------------------------------------
        "web.assets_tests": [
        ...
        # Used during the transition of the web architecture
        "web.frontend_legacy_tests": ["web/static/tests/legacy/frontend/*.js",],
    },
