...
class Base(models.AbstractModel):
    ...
    def _read_x2many(self, global_context_dict, field_name, specification, record_raw, local_context_dict) -> list[dict]:
    ...
    def _read_many2one(self, global_context_dict, field_name, specification, local_context_dict) -> list:
        if "__context" in specification:
    ...
    def _read_main(self, global_context_dict, specification, parent_raw: dict = None) -> (list[dict], list[dict]):
