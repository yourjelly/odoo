...
class BaseDocumentLayout(models.TransientModel):
    ...
    def _default_report_footer(self):
        ...
        footer_fields = filter(
            None, [company.phone, company.email, company.website, company.vat]
        )
    ...
    def extract_image_primary_secondary_colors(self, logo, white_threshold=225):
        ...
        secondary = (
            tools.average_dominant_color(remaining)[0]
            if len(remaining) > 0
            else primary
        )
    ...
    def _get_asset_style(self):
        ...
        company_styles = template_style._render({"company_ids": self,})
