...
class WebSuite(odoo.tests.HttpCase):
    ...
    def test_unit_desktop(self):
        ...
        self.browser_js('/web/tests/next?headless&loglevel=2&preset=desktop&suite=de765e9c&timeout=15000', "", "", login='admin', timeout=1800, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
