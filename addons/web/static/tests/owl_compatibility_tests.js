odoo.define('web.OwlCompatibilityTests', function (require) {
    ...
    QUnit.module("Owl Compatibility", function () {
        ...
        QUnit.test("adapter has same el as sub widget (modify)", async function (assert) {
            assert.expect(7);
        ...
        QUnit.test("sub widget patch modify el instance", async function (assert) {
            assert.expect(7);
            ...
            const MyWidget = Widget.extend({
                ...
                render: function () {
                    this._replaceElement(`<div>Hello ${this.name}!</div>`);
                },
                update: function (name) {
                    this.name = name;
                },
