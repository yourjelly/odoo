...
describe("@web", "core", "py_js", "py_timedelta", () => {
    test("create", () => {
    ...
    test("bool", () => {
        ...
        expect(evaluateExpr("bool(td(1))", ctx)).toBeTruthy();
        expect(evaluateExpr("bool(td(0, 1))", ctx)).toBeTruthy();
        expect(evaluateExpr("bool(td(0, 0, 1))", ctx)).toBeTruthy();
        expect(evaluateExpr("bool(td(microseconds=1))", ctx)).toBeTruthy();
        expect(evaluateExpr("bool(not td(0))", ctx)).toBeTruthy();
    });
});
