    ...
    QUnit.module(
        ...
        function () {
            ...
            QUnit.test("simple calendar rendering", async function (assert) {
                ...
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter .o_calendar_filter_item[data-value=1] input")[0]
                );
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=2] input")
                );
                assert.containsN(
                    calendar,
                    ".fc-event",
                ...
                assert.strictEqual(
                    $typeFilter.find(".o_calendar_filter_item:last").data("value"),
                    false,
                    "filters having false value should be displayed at last in filter items"
                );
                assert.strictEqual(
                    $typeFilter.find(".o_calendar_filter_item:last .o_cw_filter_title").text(),
                    "Undefined",
                    "filters having false value should display 'Undefined' string"
                );
                assert.strictEqual(
                    $typeFilter.find(".o_calendar_filter_item:last label img").length,
                    0,
                    "filters having false value should not have any user image"
                );

                var $attendeesFilter = $sidebar.find(
                    ".o_calendar_filter:has(span:contains(attendees))"
                );
                ...
                assert.ok(
                    $attendeesFilter.find(".o_field_many2one").length,
                ...
                await testUtils.dom.click(
                    calendar.$('.o_calendar_filter input[type="checkbox"]').eq(1)
                ); // click on partner 2
                assert.containsN(calendar, ".fc-event", 4, "should now only display 4 event");
                await testUtils.dom.click(
                    calendar.$('.o_calendar_filter input[type="checkbox"]').eq(2)
                );
                ...
                assert.containsN(
                    $sidebar,
                    ".o_calendar_filter:has(span:contains(attendees)) .o_calendar_filter_item",
                    4,
                ...
                await testUtils.dom.click(
                    $sidebar.find(".o_calendar_filter_item .o_remove").eq(1),
                    { allowInvisible: true }
                );
                assert.containsN(
                    $sidebar,
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    await testUtils.dom.click(
                        calendar.$(".fc-event:contains(event 4) .fc-content")
                    );
            ...
            QUnit.test(
                "breadcrumbs are updated with the displayed period",
                async function (assert) {
                    assert.expect(4);
            ...
            QUnit.test("create and change events", async function (assert) {
                ...
                assert.ok(
                    calendar.$(".fc-dayGridMonth-view").length,
                    "should display in month mode"
                );
                ...
                assert.ok(
                    calendar.$(".o_cw_popover").length,
                    "should open a popover clicking on event"
                );
                assert.ok(
                    calendar.$(".o_cw_popover .o_cw_popover_edit").length,
                    "popover should have an edit button"
                );
                assert.ok(
                    calendar.$(".o_cw_popover .o_cw_popover_delete").length,
                    "popover should have a delete button"
                );
                assert.ok(
                    calendar.$(".o_cw_popover .o_cw_popover_close").length,
                ...
                assert.strictEqual(
                    calendar.$(".fc-event:contains(new event in quick create)").length,
                    1,
                ...
                assert.containsOnce(
                    calendar,
                    ".fc-event:contains(new event in quick create validated by pressing enter key.)",
                ...
                assert.strictEqual(
                    $(".modal-lg .o_form_view").length,
                    1,
                    "should open the slow create dialog"
                );
                assert.strictEqual(
                    $(".modal-lg .modal-title").text(),
                    "New Event",
                    "should use the string attribute as modal title"
                );
                assert.strictEqual(
                    $('.modal-lg .o_form_view input[name="name"]').val(),
                    "coucou",
                ...
                assert.strictEqual(
                    calendar.$(".fc-event:contains(coucou)").length,
                    1,
                ...
                testUtils.fields.editInput(
                    $(".modal-dialog input:first"),
                    "new event in quick create 2"
                );
                await testUtils.dom.click($(".modal-footer button.btn:contains(Edit)"));

                assert.strictEqual(
                    $(".modal-lg input:first").val(),
                    "new event in quick create 2",
                ...
                assert.hasAttrValue(
                    $newevent2.closest(".fc-event-container"),
                    "colspan",
                    "2",
                ...
                await testUtils.dom.click(
                    calendar.$(".fc-event:contains(new event in quick create 2) .fc-content")
                );
                var $popover_description = calendar.$(".o_cw_popover .o_cw_body .list-group-item");
                assert.strictEqual(
                    $popover_description.children()[1].textContent,
                    "December 20-21, 2016",
                    "The popover description should indicate the correct range"
                );
                assert.strictEqual(
                    $popover_description.children()[2].textContent,
                    "(2 days)",
            ...
            QUnit.test("quickcreate with custom create_name_field", async function (assert) {
                ...
                assert.containsOnce(
                    calendar,
                    ".fc-event:contains(custom event in quick create)",
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    assert.strictEqual(
                        $(".modal-lg main .o_form_view.o_form_editable").length,
                        1,
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    assert.strictEqual(
                        calendar.$(".fc-content .fc-time").text(),
                        "8:00 - 10:00",
                    ...
                    assert.strictEqual(
                        $newevent.find(".o_event_title").text(),
                        "new event",
                        "should display the new event with title"
                    );

                    assert.deepEqual(
                        $newevent[0].fcSeg.eventRange.def.extendedProps.record,
                        {
                            display_name: "new event",
                            start: fieldUtils.parse.datetime(
                                "2016-12-13 06:00:00",
                                this.data.event.fields.start,
                                { isUTC: true }
                            ),
                            stop: fieldUtils.parse.datetime(
                                "2016-12-13 08:00:00",
                                this.data.event.fields.stop,
                                { isUTC: true }
                            ),
                            allday: false,
                            name: "new event",
            ...
            QUnit.test("default week start (US)", function (assert) {
                ...
                createCalendarView({
                    ...
                    assert.strictEqual(
                        calendar.$(".fc-day-header").first().text(),
                        "Sun 11",
                        "The first day of the week should be Sunday"
                    );
                    assert.strictEqual(
                        calendar.$(".fc-day-header").last().text(),
                        "Sat 17",
            ...
            QUnit.test("render popover", async function (assert) {
                ...
                assert.strictEqual(
                    calendar.$(".o_cw_popover .popover-header").text(),
                    "event 4",
                ...
                assert.strictEqual(
                    calendar.$(".o_cw_popover .list-group-item:first b.text-capitalize").text(),
                ...
                assert.containsOnce(
                    calendar,
                    ".o_cw_popover .o_cw_popover_fields_secondary .list-group-item:first .o_field_char",
                    "should apply char widget"
                );
                assert.strictEqual(
                    calendar
                        .$(
                            ".o_cw_popover .o_cw_popover_fields_secondary .list-group-item:first strong"
                        )
                        .text(),
                    "Custom Name : ",
                ...
                assert.containsOnce(
                    calendar,
                    ".o_cw_popover .o_cw_popover_fields_secondary .list-group-item:last .o_form_uri",
                    "should apply m20 widget"
                );
                assert.strictEqual(
                    calendar
                        .$(
                            ".o_cw_popover .o_cw_popover_fields_secondary .list-group-item:last strong"
                        )
                        .text(),
                    "user : ",
            ...
            QUnit.test("render popover with modifiers", async function (assert) {
                ...
                this.data.event.fields.priority = {
                    string: "Priority",
                    type: "selection",
                    selection: [
                        ["0", "Normal"],
                ...
                assert.strictEqual(
                    calendar.$(".o_cw_popover li.o_invisible_modifier").text(),
                    "user : partner 1",
            ...
            QUnit.test(
                "render popover with widget which has specialData attribute",
                async function (assert) {
                    assert.expect(3);
                ...
                async function (assert) {
                    ...
                    this.data.event.onchanges = {
                        allday: function (obj) {
                            if (obj.allday) {
                                obj.start_date =
                                    (obj.start && obj.start.split(" ")[0]) || obj.start_date;
                                obj.stop_date =
                                    (obj.stop && obj.stop.split(" ")[0]) ||
                                    obj.stop_date ||
                                    obj.start_date;
                            } else {
                                obj.start =
                                    (obj.start_date && obj.start_date + " 00:00:00") || obj.start;
                                obj.stop =
                                    (obj.stop_date && obj.stop_date + " 00:00:00") ||
                                    obj.stop ||
                                    obj.start;
                            }
                        },
                    ...
                    assert.strictEqual(
                        $('.o_field_widget[name="start"] input').val(),
                        "12/13/2016 08:00:00",
                    ...
                    await testUtils.dom.click(
                        $(".bootstrap-datetimepicker-widget .timepicker-hours td.hour:contains(08)")
                    );
                    await testUtils.dom.click(
                    ...
                    await testUtils.dom.click(
                        $(".bootstrap-datetimepicker-widget .timepicker-hours td.hour:contains(10)")
                    );
                    await testUtils.dom.click(
                        $('.bootstrap-datetimepicker-widget .picker-switch a[data-action="close"]')
                    );
            ...
            QUnit.test(
                "create event with timezone in week mode American locale",
                async function (assert) {
                    assert.expect(5);
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    assert.strictEqual(
                        $('.o_field_widget[name="start_date"] input').val(),
                        "12/13/2016",
                        "should display the date"
                    );
            ...
            QUnit.test("check calendar week column timeformat", async function (assert) {
                ...
                assert.strictEqual(
                    calendar.$(".fc-axis:contains(8am)").length,
                    1,
                    "calendar should show according to timeformat"
                );
                assert.strictEqual(
                    calendar.$(".fc-axis:contains(11pm)").length,
                    1,
            ...
            QUnit.test("create all day event in week mode", async function (assert) {
                ...
                try {
                    testUtils.dom.triggerPositionalMouseEvent(
                        pos.left + 15,
                        pos.top + 15,
                        "mousedown"
                    );
            ...
            QUnit.test(
                "create event with default context (no quickCreate)",
                async function (assert) {
                    assert.expect(3);
            ...
            QUnit.test(
                "create all day event in week mode (no quickCreate)",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test("rendering, with many2many", async function (assert) {
                ...
                assert.containsN(
                    calendar,
                    ".o_calendar_filter_items .o_cw_filter_avatar",
                    3,
                ...
                assert.strictEqual(
                    calendar.$(".o_cw_popover").find("img").length,
                    1,
                    "should have 1 avatar"
                );
            ...
            QUnit.test("open form view", async function (assert) {
                ...
                assert.strictEqual(
                    $("#ui-datepicker-div:empty").length,
                    0,
                    "should have a clean body"
                );
            });

            QUnit.test(
                "create and edit event in month mode (all_day: false)",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test(
                "show start time of single day event for month mode",
                async function (assert) {
                    assert.expect(4);
                    ...
                    assert.strictEqual(
                        calendar.$(".fc-event:contains(event 2) .fc-content .fc-time").text(),
                        "06:55",
                        "should have a correct time 06:55 AM in month mode"
                    );
                    assert.strictEqual(
                        calendar.$(".fc-event:contains(event 4) .fc-content .fc-time").text(),
                        "",
                        "should not display a time for all day event"
                    );
                    assert.strictEqual(
                        calendar.$(".fc-event:contains(event 5) .fc-content .fc-time").text(),
                        "",
            ...
            QUnit.test(
                "start time should not shown in month mode if hide_time is true",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test("check filters with filter_field specified", async function (assert) {
                ...
                assert.containsOnce(
                    calendar,
                    '.o_calendar_filter_item[data-id="2"] input:checked',
                ...
                assert.strictEqual(
                    this.data.filter_partner.records.find((r) => r.id === 2).partner_checked,
                    false,
            ...
            QUnit.test('"all" filter', async function (assert) {
                ...
                assert.containsN(calendar, ".fc-event", 0, "should display 0 events on the week");
                ...
                assert.containsN(calendar, ".fc-event", 4, "should display 4 events on the week");
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=2] input")
                );
                assert.containsN(calendar, ".fc-event", 9, "should display 9 events on the week");
            ...
            QUnit.test("Add filters and specific color", async function (assert) {
                ...
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=1] input")
                );
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=2] input")
                );
                ...
                assert.containsOnce(
                    $typeFilter,
                    "#o_cw_filter_collapse_EventType",
                    "Id should be equals to o_cw_filter_collapse_EventType for 'Event Type'"
                );
                assert.containsN(
                    $typeFilter,
                    ".o_calendar_filter_item",
                    3,
                    "should display 3 filter items for 'Event Type'"
                );
            ...
            QUnit.test("create event with filters", async function (assert) {
                ...
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=4] input")
                );
            ...
            QUnit.test("Update event with filters", async function (assert) {
                ...
                await testUtils.dom.click(
                    $(".ui-menu-item a:contains(user 5)").trigger("mouseenter")
                );
                ...
                assert.containsN(
                    ...
                    3,
                    "should display 3 true checkbox"
                );
                assert.containsN(
                    calendar,
                    ".o_calendar_filter_item input:not(:checked)",
                    3,
                    "should display 3 false checkbox"
                );
                // Click to select all users
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_items_checkall:eq(1) input")
                );
                ...
                assert.containsN(
                    ...
                    ".o_calendar_filter_item input:checked",
                    4,
                    "should display 4 true checkbox"
                );
                // unselect all user
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_items_checkall:eq(1) input")
            ...
            QUnit.test("change pager with filters", async function (assert) {
                ...
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=1] input")[0]
                );
                await testUtils.dom.click(
                    calendar.$(".o_calendar_filter_item[data-value=2] input")
                );
                ...
                assert.strictEqual(
                    calendar.$(".fc-event .o_event_title").text().replace(/\s/g, ""),
                    "event8event9",
            ...
            QUnit.test(
                "ensure events are still shown if filters give an empty domain",
                async function (assert) {
                    assert.expect(2);
                    ...
                    var calendar = await createCalendarView({
                        ...
                        data: this.data,
                        arch:
                            '<calendar mode="week" date_start="start">' +
                            '<field name="partner_ids" write_model="filter_partner" write_field="partner_id"/>' +
                            "</calendar>",
                        viewOptions: {
                            initialDate: initialDate,
                    ...
                    assert.containsN(calendar, ".fc-event", 5, "should display 5 events");
                    await testUtils.dom.click(
                        calendar.$(".o_calendar_filter_item[data-value=all] input[type=checkbox]")
                    );
                    assert.containsN(calendar, ".fc-event", 5, "should display 5 events");
                    calendar.destroy();
                }
            ...
            QUnit.test("events starting at midnight", async function (assert) {
                ...
                try {
                    ...
                    calendar.destroy();
                    throw new Error(
                        "The test failed to simulate a click on the screen." +
                            "Your screen is probably too small or your dev tools are open."
                    );
                }
                assert.ok(
                    $(".modal-dialog.modal-sm").length,
                    "should open the quick create dialog"
                );
            ...
            QUnit.test("set event as all day when field is date", async function (assert) {
                ...
                assert.strictEqual(
                    moment(calendar.model.data.data[0].r_start).date(),
                    14,
            ...
            QUnit.test(
                "check if the view destroys all widgets and instances",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test("create an event (async dialog) [REQUIRE FOCUS]", async function (assert) {
                ...
                assert.strictEqual($(".modal").length, 0, "should not have opened the dialog yet");

                prom.resolve();
                await testUtils.nextTick();

                assert.strictEqual($(".modal").length, 1, "should have opened the dialog");
                assert.strictEqual(
                    $(".modal input")[0],
            ...
            QUnit.test("calendar is configured to have no groupBy menu", async function (assert) {
                ...
                await doAction(webClient, 1);
                assert.containsNone(
                    $(webClient.el).find(".o_control_panel .o_search_options span.fa.fa-bars"),
            ...
            QUnit.test("timezone does not affect current day", async function (assert) {
                ...
                assert.strictEqual(
                    $sidebar.find(".ui-datepicker-current-day").text(),
                    "12",
            ...
            QUnit.test("timezone does not affect drag and drop", async function (assert) {
                ...
                assert.strictEqual(
                    calendar.$(".fc-event:eq(0)").text().replace(/\s/g, ""),
                    "08:00event1"
                );
                await testUtils.dom.click(calendar.$(".fc-event:eq(0)"));
                assert.strictEqual(
                    calendar.$('.o_field_widget[name="start"]').text(),
                    "12/09/2016 08:00:00"
                );

                assert.strictEqual(
                    calendar.$(".fc-event:eq(5)").text().replace(/\s/g, ""),
                    "16:00event6"
                );
                ...
                assert.strictEqual(
                    calendar.$(".fc-event:eq(1)").text().replace(/\s/g, ""),
                    "08:00event1"
                );
                await testUtils.dom.click(calendar.$(".fc-event:eq(1)"));
                assert.strictEqual(
            ...
            QUnit.test(
                "timzeone does not affect calendar with date field",
                async function (assert) {
                    assert.expect(11);
                    ...
                    assert.strictEqual(
                        calendar
                            .$(
                                ".o_cw_popover .o_cw_popover_fields_secondary .list-group-item:last .o_field_date"
                            )
                            .text(),
                        "12/20/2016",
            ...
            QUnit.test("drag and drop on month mode", async function (assert) {
                ...
                const calendar = await createCalendarView({
                    arch: `<calendar date_start="start" date_stop="stop" mode="month" event_open_popup="true" quick_add="False">
                    <field name="name"/>
                    <field name="partner_id"/>
                </calendar>`,
                    archs: archs,
                ...
                assert.hasClass(
                    calendar.$('.o_calendar_widget > [data-event-id="1"]'),
                    "dayGridMonth",
                ...
                assert.containsOnce(
                    calendar,
                    '.popover:contains("07:00")',
                    "start hour shouldn't have been changed"
                );
                assert.containsOnce(
                    calendar,
                    '.popover:contains("19:00")',
            ...
            QUnit.test("drag and drop on month mode with all_day mapping", async function (assert) {
                ...
                const calendar = await createCalendarView({
                    arch: `<calendar date_start="start" date_stop="stop" mode="month" event_open_popup="true" quick_add="False" all_day="allday">
                    <field name="name"/>
                    <field name="partner_id"/>
                </calendar>`,
                    archs: archs,
                ...
                await testUtils.dom.click(
                    $(".bootstrap-datetimepicker-widget .timepicker-hours td.hour:contains(07)")
                );
                await testUtils.dom.click(
                    $('.bootstrap-datetimepicker-widget .picker-switch a[data-action="close"]')
                );
                ...
                await testUtils.dom.click(
                    $(".bootstrap-datetimepicker-widget .timepicker-hours td.hour:contains(19)")
                );
                await testUtils.dom.click(
                    $('.bootstrap-datetimepicker-widget .picker-switch a[data-action="close"]')
                );
            ...
            QUnit.test(
                "drag and drop on month mode with date_start and date_delay",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test(
                "form_view_id attribute works (for creating events)",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test(
                "form_view_id attribute works with popup (for creating events)",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test(
                "calendar fallback to form view id in action if necessary",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test("initial_date given in the context", async function (assert) {
                ...
                serverData.views = {
                    "event,1,calendar":
                        '<calendar date_start="start" date_stop="stop" mode="day"/>',
                    "event,false,search": "<search></search>",
                };
                ...
                assert.strictEqual(
                    $(".o_control_panel .breadcrumb-item").text(),
                    "context initial date (December 12, 2016)",
            ...
            QUnit.test("default week start (US) month mode", async function (assert) {
                ...
                assert.strictEqual(
                    $firstDay.find(".fc-week-number").text(),
                    "36",
                    "The number of the week should be correct"
                );
                assert.strictEqual(
                    $firstDay.find(".fc-day-number").text(),
                    "1",
         ...
         */
                    ...
                    assert.strictEqual(
                        calendar.$(".o_event_title").length,
                        3,
                        "3 events should be available"
                    ); // OK
                    assert.strictEqual(
                        calendar.$(".o_event_title").first().text(),
                        "First event",
            ...
            `,
                ...
                await testUtils.nextTick();
                assert.equal(
                    $(".o_field_boolean.o_field_widget[name=allday] input").is(":checked"),
                    false,
            ...
            QUnit.test("correctly display year view", async function (assert) {
                ...
                assert.strictEqual(
                    calendar.el.querySelector(".fc-month:first-child .fc-header-toolbar")
                        .textContent,
                    "Jan 2016"
                );
                assert.containsN(
                ...
                assert.notOk(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-11-17"]')
                ...
                assert.ok(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-11-16"]')
                        .classList.contains("fc-has-event")
                );
                await clickDate("2016-11-16");
                assert.containsOnce(calendar, ".o_cw_popover");
                let popoverText = calendar.el
                    .querySelector(".o_cw_popover")
                ...
                assert.ok(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-11-14"]')
                        .classList.contains("fc-has-event")
                );
                await clickDate("2016-11-14");
                assert.containsOnce(calendar, ".o_cw_popover");
                popoverText = calendar.el
                    .querySelector(".o_cw_popover")
                    .textContent.replace(/\s{2,}/g, " ")
                    .trim();
                assert.strictEqual(popoverText, "November 14-16, 2016 event 7");
                ...
                assert.notOk(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-11-13"]')
                        .classList.contains("fc-has-event")
                );
                ...
                assert.notOk(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-12-10"]')
                        .classList.contains("fc-has-event")
                );
                ...
                assert.ok(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-12-12"]')
                        .classList.contains("fc-has-event")
                );
                ...
                assert.ok(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-12-14"]')
                        .classList.contains("fc-has-event")
                );
                ...
                assert.notOk(
                    calendar.el
                        .querySelector('.fc-day-top[data-date="2016-12-21"]')
                        .classList.contains("fc-has-event")
                );
            ...
            QUnit.test("click outside the popup should close it", async function (assert) {
                ...
                assert.containsOnce(calendar, ".o_cw_popover", "open popup when click on event");
            ...
            QUnit.test("calendar: disableQuickCreate in data event", async function (assert) {
                ...
                // Create event
                var $initCell = calendar.$(
                    '.fc-time-grid .fc-minor[data-time="06:30:00"] .fc-widget-content:last-child'
                );
                var $endCell = calendar.$(
                    '.fc-time-grid .fc-minor[data-time="10:30:00"] .fc-widget-content:last-child'
                );
