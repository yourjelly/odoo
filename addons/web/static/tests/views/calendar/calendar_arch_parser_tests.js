...
QUnit.skipWOWL("defaults", (assert) => {
...
QUnit.skipWOWL("canCreate", (assert) => {
...
QUnit.skipWOWL("canDelete", (assert) => {
...
QUnit.skipWOWL("eventLimit", (assert) => {
    check(assert, "event_limit", "", "eventLimit", 5);
...
QUnit.skipWOWL("fieldMapping", (assert) => {
    assert.ok(false);
});

QUnit.skipWOWL("fieldNames", (assert) => {
    assert.ok(false);
});

QUnit.skipWOWL("filtersInfo", (assert) => {
    assert.ok(false);
});
...
QUnit.skipWOWL("hasQuickCreate", (assert) => {
...
QUnit.skipWOWL("popoverFields", (assert) => {
    assert.ok(false);
});

QUnit.skipWOWL("scale", (assert) => {
    check(assert, "mode", "", "scale", "day");
