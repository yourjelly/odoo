...
QUnit.todo("section can have input to add filter", async (assert) => {
    const panel = await start({});
...
QUnit.todo("section cannot have input to add filter", async (assert) => {
    const panel = await start({});
...
QUnit.todo("filter can have color", async (assert) => {});
