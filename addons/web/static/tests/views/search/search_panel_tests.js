...
QUnit.module("SearchPanel", (hooks) => {
  hooks.beforeEach(() => {
    const serverData = {
      models: {
        partner: {
  ...
  QUnit.test("basic rendering of a component with search panel", async function (assert) {
    ...
    assert.hasClass(firstSection.querySelector(".o_search_panel_section_header i"), "fa-folder");
    ...
    assert.hasClass(secondSection.querySelector(".o_search_panel_section_header i"), "fa-filter");
