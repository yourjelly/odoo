...
QUnit.module("Views", (hooks) => {
    ...
    QUnit.test("can click on action-bound links", async (assert) => {
        assert.expect(10);
        ...
        const allLinks = toy.el.querySelectorAll("a");
        assert.strictEqual(allLinks.length, 3);

        await click(allLinks[0]);
