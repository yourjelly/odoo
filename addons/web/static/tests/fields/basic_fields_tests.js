...
QUnit.module('basic_fields', {
    ...
    QUnit.test('email field in form view', async function (assert) {
        ...
        var $mailtoLink = form.$('div.o_form_uri.o_field_widget.o_text_overflow > a');
        ...
        // save
        await testUtils.form.clickSave(form);
        $mailtoLink = form.$('div.o_form_uri.o_field_widget.o_text_overflow > a');
    ...
    QUnit.test('email field in editable list view', async function (assert) {
        ...
        var $mailtoLink = list.$('div.o_form_uri.o_field_widget.o_text_overflow > a');
        ...
        $mailtoLink = list.$('div.o_form_uri.o_field_widget.o_text_overflow > a');
        assert.strictEqual($mailtoLink.length, 5,
