 ...
 * @param {Component|Widget} view, view controller
 * @returns {number[]}
 */
function getCounters(view) {
    return [...view.el.querySelectorAll(".o_search_panel_counter")].map((counter) =>
        Number(counter.innerText.trim())
    );
}

/**
 * Fold/unfold the category value (with children)
 * @param {Component|Widget} view
 * @param {string} text
 * @returns {Promise}
 */
function toggleFold(view, text) {
    const headers = [...view.el.querySelectorAll(".o_search_panel_category_value header")];
    const target = headers.find((header) => header.innerText.trim().startsWith(text));
    return click(target);
}

function makeTestComponent(assert) {
    class TestComponent extends Component {
        willStart() {
            assert.step(JSON.stringify(this.props.domain));
        }
        willUpdateProps(nextProps) {
            assert.step(JSON.stringify(nextProps.domain));
        }
    }
...
QUnit.module("Search", (hooks) => {
    ...
    QUnit.test("basic rendering of a component without search panel", async function (assert) {
        assert.expect(3);
        const TestComponent = makeTestComponent(assert);
    ...
    QUnit.test("basic rendering of a component with search panel", async function (assert) {
        assert.expect(16);
        const TestComponent = makeTestComponent(assert);
        const comp = await makeWithSearch(
            {
        ...
        assert.hasClass(comp.el, "o_component_with_search_panel");
        ...
        assert.verifySteps([
            ...
            "[]", // initial domain (does not need the sections to be loaded)
    ...
    //   QUnit.skip('sections with custom icon and color', async function (assert) {
    //       assert.expect(4);
    ...
    //   QUnit.skip('sections with attr invisible="1" are ignored', async function (assert) {
    ...
    //   QUnit.skip('categories and filters order is kept', async function (assert) {
    //       assert.expect(4);
    ...
    //   QUnit.skip('specify active category value in context and manually change category', async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip('use category (on many2one) to refine search', async function (assert) {
    //       assert.expect(14);
    ...
    //   QUnit.skip('use category (on selection) to refine search', async function (assert) {
    //       assert.expect(14);
    ...
    //   QUnit.skip('category has been archived', async function (assert) {
    //       assert.expect(2);
    ...
    //   QUnit.skip('use two categories to refine search', async function (assert) {
    //       assert.expect(14);
    ...
    //   QUnit.skip('category with parent_field', async function (assert) {
    //       assert.expect(33);
    ...
    //   QUnit.skip('category with no parent_field', async function (assert) {
    //       assert.expect(10);
    ...
    //   QUnit.skip('can (un)fold parent category values', async function (assert) {
    //       assert.expect(7);
    ...
    //   QUnit.skip('fold status is kept at reload', async function (assert) {
    //       assert.expect(4);
    ...
    //   QUnit.skip('concurrency: delayed search_reads', async function (assert) {
    //       assert.expect(19);
    ...
    //   QUnit.skip("concurrency: single category", async function (assert) {
    //       assert.expect(12);
    ...
    //   QUnit.skip("concurrency: category and filter", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip("concurrency: category and filter with a domain", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip('concurrency: misordered get_filters', async function (assert) {
    //       assert.expect(15);
    ...
    //   QUnit.skip('concurrency: delayed get_filter', async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip('use filter (on many2one) to refine search', async function (assert) {
    //       assert.expect(32);
    ...
    //   QUnit.skip('use filter (on selection) to refine search', async function (assert) {
    //       assert.expect(32);
    ...
    //   QUnit.skip("only reload categories and filters when domains change (counters disabled, selection)", async function (assert) {
    //       assert.expect(8);
    ...
    //   QUnit.skip("only reload categories and filters when domains change (counters disabled, many2one)", async function (assert) {
    //       assert.expect(8);
    ...
    //   QUnit.skip('category counters', async function (assert) {
    //       assert.expect(16);
    ...
    //   QUnit.skip('category selection without counters', async function (assert) {
    //       assert.expect(10);
    ...
    //   QUnit.skip('filter with groupby', async function (assert) {
    //       assert.expect(42);
    ...
    //   QUnit.skip('filter with domain', async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip('filter with domain depending on category', async function (assert) {
    //       assert.expect(22);
    ...
    //   QUnit.skip('specify active filter values in context', async function (assert) {
    //       assert.expect(4);
    ...
    //   QUnit.skip('retrieved filter value from context does not exist', async function (assert) {
    //       assert.expect(1);
    ...
    //   QUnit.skip('filter with groupby and default values in context', async function (assert) {
    //       assert.expect(2);
    ...
    //   QUnit.skip('Does not confuse false and "false" groupby values', async function (assert) {
    //       assert.expect(6);
    ...
    //   QUnit.skip('tests conservation of category record order', async function (assert) {
    //       assert.expect(1);
    ...
    //   QUnit.skip('search panel is not instantiated in dialogs', async function (assert) {
    //       assert.expect(2);
    ...
    //   QUnit.skip("Reload categories with counters when filter values are selected", async function (assert) {
    //       assert.expect(8);
    ...
    //   QUnit.skip("many2one: select one, expand, hierarchize, counters", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip("many2one: select one, no expand, hierarchize, counters", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip("many2one: select one, expand, no hierarchize, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select one, no expand, no hierarchize, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select one, expand, hierarchize, no counters", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip("many2one: select one, no expand, hierarchize, no counters", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip("many2one: select one, expand, no hierarchize, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select one, no expand, no hierarchize, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, expand, groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, no expand, groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, expand, no groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, no expand, no groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, expand, groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, no expand, groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, expand, no groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2one: select multi, no expand, no groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, expand, groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, no expand, groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, expand, no groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, no expand, no groupby, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, expand, groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, no expand, groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, expand, no groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("many2many: select multi, no expand, no groupby, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select one, expand, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select one, no expand, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select one, expand, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select one, no expand, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select multi, expand, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select multi, no expand, counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select multi, expand, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select multi, no expand, no counters", async function (assert) {
    //       assert.expect(3);
    ...
    //   QUnit.skip("selection: select multi, no expand, counters, extra_domain", async function (assert) {
    //       assert.expect(5);
    ...
    //   QUnit.skip("reached limit for a category", async function (assert) {
    //       assert.expect(6);
    ...
    //   QUnit.skip("reached limit for a filter", async function (assert) {
    //       assert.expect(6);
    ...
    //   QUnit.skip("Categories with default attributes should be udpated when external domain changes", async function (assert) {
    //       assert.expect(8);
    ...
    //   QUnit.skip("Category with counters and filter with domain", async function (assert) {
    //       assert.expect(2);
