...
test("construct simple domain based on date field (no comparisonOptionId)", () => {
    ...
    domain = constructDateDomain(referenceMoment, dateSearchItem, ["month_0", "year_0"]);
    expect(domain).toEqual({
        domain: new Domain(
    ...
    domain = constructDateDomain(referenceMoment, dateSearchItem, ["second_quarter", "year_0"]);
    expect(domain).toEqual({
        domain: new Domain(
    ...
    domain = constructDateDomain(referenceMoment, dateSearchItem, ["year_0"]);
    expect(domain).toEqual({
        domain: new Domain(
...
test("construct simple domain based on datetime field (no comparisonOptionId)", () => {
    ...
    let domain = constructDateDomain(referenceMoment, dateTimeSearchItem, ["month_0", "year_0"]);
    expect(domain).toEqual({
        domain: new Domain(
    ...
    domain = constructDateDomain(referenceMoment, dateTimeSearchItem, ["second_quarter", "year_0"]);
    expect(domain).toEqual({
        domain: new Domain(
    ...
    domain = constructDateDomain(referenceMoment, dateTimeSearchItem, ["year_0"]);
    expect(domain).toEqual({
        domain: new Domain(
...
test(`construct comparison domain based on date field and option "previous_period"`, () => {
    ...
    domain = constructDateDomain(
        referenceMoment,
        dateSearchItem,
        ["year_0", "year_-2", "month_0", "month_-2"],
        "previous_period"
    );
    expect(domain).toEqual({
        domain: new Domain(
    ...
    domain = constructDateDomain(
        referenceMoment,
        dateSearchItem,
        ["second_quarter", "third_quarter", "year_-1"],
        "previous_period"
    );
    expect(domain).toEqual({
        domain: new Domain(
