...
QUnit.module("Search", (hooks) => {
    ...
    QUnit.test("simple rendering", async (assert) => {
        ...
        assert.containsOnce(target, ".o_control_panel_main");
        ...
        assert.containsOnce(target, ".o_control_panel_breadcrumbs_actions");
    ...
    QUnit.test("view switcher", async (assert) => {
        ...
        assert.containsN(target, ".o_cp_switch_buttons", 2);
