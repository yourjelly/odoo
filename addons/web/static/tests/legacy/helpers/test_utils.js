odoo.define('web.test_utils', async function (require) {
    ...
    const testUtilsCreate = require('./test_utils_create');
    const testUtilsControlPanel = require('./test_utils_control_panel');
    const testUtilsDom = require('./test_utils_dom');
    const testUtilsFields = require('./test_utils_fields');
    const testUtilsFile = require('./test_utils_file');
    const testUtilsForm = require('./test_utils_form');
    const testUtilsGraph = require('./test_utils_graph');
    const testUtilsKanban = require('./test_utils_kanban');
    const testUtilsMock = require('./test_utils_mock');
    const testUtilsModal = require('./test_utils_modal');
    const testUtilsPivot = require('./test_utils_pivot');
