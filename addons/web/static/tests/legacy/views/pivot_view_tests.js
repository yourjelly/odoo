...
QUnit.module("Views", (hooks) => {
    ...
    QUnit.test("columns are highlighted when hovering a measure", async function (assert) {
        ...
        await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name="date_filter" date="date" domain="[]" default_period='month_0'/>
                </search>`,
    ...
    QUnit.test("rendering of pivot view with comparison", async function (assert) {
        ...
        await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name="date_filter" date="date" domain="[]" default_period='year_-1'/>
                </search>`,
    ...
    QUnit.test("export data in excel with comparison", async function (assert) {
        ...
        await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name="date_filter" date="date" domain="[]" default_period='month_-2'/>
                </search>`,
            context: { search_default_date_filter: 1 },
        });
