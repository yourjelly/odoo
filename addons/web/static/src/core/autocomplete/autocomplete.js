...
export class AutoComplete extends Component {
    setup() {
        ...
        this.debouncedProcessInput = useDebounced(this.processInput, this.constructor.timeout);
    ...
    onInput() {
        this.inputProcessing = this.debouncedProcessInput().then(() => {
