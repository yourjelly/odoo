...
export class SelectMenu extends Component {
    ...
    setup() {
        ...
        this.selectedChoice = this.getSelectedChoice(this.props.value);
        onWillUpdateProps((nextProps) => {
            if (this.props.value != nextProps.value) {
                this.selectedChoice = this.getSelectedChoice(nextProps.value);
            }
        });
    }
    ...
    getSelectedChoice(value) {
        if (value) {
            const choices = [...this.props.choices, ...this.props.groups.flatMap((g) => g.choices)];
            return choices.find((c) => {
                if (typeof c.value === "object" && typeof value === "object") {
                    return shallowEqual(c.value, value);
                }
