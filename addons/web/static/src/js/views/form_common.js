...
var CompletionFieldMixin = {
    ...
    _search_create_popup: function(view, ids, context) {
        var self = this;
        var select_create_dialog = new SelectCreateDialog(this, _.extend({}, (this.options || {}), {
...
var FormWidget = Widget.extend(InvisibilityChangerMixin, {
    ...
    init: function(field_manager, node) {
        ...
        this.tabindex = this.node.attrs.tabindex && parseInt(this.node.attrs.tabindex) || null;
    ...
    bind_tabindex: function() {
        ...
        if ($element && !this.get('readonly') && (!_.isNull(this.tabindex) && this.tabindex >= 0) && !this.no_tabindex) {
...
var SelectCreateListView = ListView.extend({
    ...
    keydown_ENTER: function(e) {
        if (this.options.selectable && this.popup.selected_ids) {
            this.popup.on_selected(this.popup.selected_ids);
            this.popup.close();
        } else if(this.current_selected_row) {
