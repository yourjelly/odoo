...
function loadLibs(libs) {
    ...
    mutex.exec(function () {
        ...
        proms.push(_loadArray(cssLibs, ajax.loadCSS).then(function () {
        ...
        proms.push(_loadArray(libs.jsLibs || [], ajax.loadJS).then(function () {
    ...
    function _loadArray(array, loadCallback) {
        ...
        _.each(array, function (urlData) {
            _mutex.exec(function () {
                ...
                return Promise.all(_.map(urlData, function (url) {
