...
return {
    ...
    buildQuery: function (options) {
        ...
        if (options.route === '/web/dataset/read_group') {
            ...
            params.groupby = options.groupBy || params.groupBy;
            ...
            params.orderby = orderBy ? this._serializeSort(orderBy) : orderBy;
            params.lazy = 'lazy' in options ? options.lazy : params.lazy;
        }
