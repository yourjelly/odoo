...
var ControlPanel = Widget.extend({
    ...
    _render_breadcrumbs_li: function (bc, index, length) {
        ...
        if (bc.view && bc.view.type === 'form'){
            ...
            var breadcrumb = "<span class='display_name_content'>"+ li_content +"</span><span class='oe_breadcrumb_editable_mode' style='display: none;'><input type='text' id='"+ bc.data_record.id +","+ bc.action.action_descr.res_model+"' name='breadcrumb_editable' value='"+ li_content +"' style='width: auto;display: inline-block'/></span>";
            if (priority){
