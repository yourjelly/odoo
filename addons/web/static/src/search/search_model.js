    ...
    async getSearchItemsProperty(searchItem, definitionRecord, definitionRecordModel, definitionRecordField) {
        ...
        for (const [definitionRecordId, definitionRecordName, definitions] of result) {
            for (const definition of definitions) {
                const item = Object.values(this.searchItems).find(item =>
                    item.fieldName === searchItem.fieldName
                    && item.propertyName === definition.name);
        ...
        const domains = autocompleteValues.map(({ label, value, operator }) => {
            ...
            if (field.filterDomain) {
                ...
                domain = [
                    ...
                    [`${field.fieldName}.${field.propertyName}`, operator, value],
                ];
            }
