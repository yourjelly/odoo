...
/**
 * @typedef {import("./search_model_types").Category} Category
 * @typedef {import("./search_model_types").Filter} Filter
 * @typedef {import("./search_model_types").Section} Section
 * @typedef {import("./search_model_types").SectionPredicate} SectionPredicate
 *
 * @typedef {import("../core/domain").DomainListRepr} DomainListRepr
 * @typedef {import("../core/context").Context} Context
 */
...
export class SearchModel extends Model {
    ...
    async load(config) {
        ...
        if (config.state) {
            const { modelName } = JSON.parse(config.state);
