...
const FIELD_OPERATORS = {
    ...
    boolean: [
        { symbol: "=", description: _t("is Yes"), value: true },
        { symbol: "!=", description: _t("is No"), value: true },
    ],
    char: [
...
const QUARTERS = {
    1: { description: _t("Q1"), coveredMonths: [0, 1, 2] },
    2: { description: _t("Q2"), coveredMonths: [3, 4, 5] },
    3: { description: _t("Q3"), coveredMonths: [6, 7, 8] },
    4: { description: _t("Q4"), coveredMonths: [9, 10, 11] },
};
const MONTH_OPTIONS = {
    this_month: {
...
const COMPARISON_OPTIONS = {
    previous_period: {
        description: _t("Previous Period"), id: 'previous_period',
    },
    previous_year: {
        description: _t("Previous Year"), id: 'previous_year', addParam: { years: -1 },
    },
};
const PER_YEAR = {
    year: 1,
