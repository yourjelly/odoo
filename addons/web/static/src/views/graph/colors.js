...
export const COLORS = (getCookie("color_scheme") === "light" ? COLORS_BRIGHT : COLORS_DARK);
...
export const BORDER_WHITE = (getCookie("color_scheme") === "light" ? "rgba(255,255,255,0.6)" : "rgba(0, 0, 0, 0.6)");
