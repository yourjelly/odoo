            ...
            switch (node.tagName) {
                case "calendar": {
                    ...
                    if (node.hasAttribute("create")) {
                        canCreate = archParseBoolean(node.getAttribute("create"));
                    }
                    if (node.hasAttribute("delete")) {
                        canDelete = archParseBoolean(node.getAttribute("delete"));
                    }
                    if (node.hasAttribute("quick_add")) {
                        hasQuickCreate = archParseBoolean(node.getAttribute("quick_add"));
                    }
