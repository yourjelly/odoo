...
import { enableEventLogs, on, watchListeners } from "@web/../lib/hoot-dom/helpers/events";
...
const { clearTimeout, console, document, Math, performance, Promise, setTimeout } = globalThis;
