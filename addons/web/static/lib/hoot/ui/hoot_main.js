...
import { getRect, queryAll } from "@odoo/hoot-dom";
import { Component, useExternalListener, useRef, useSubEnv, xml } from "@odoo/owl";
            ...
            <main class="hoot d-flex flex-column mh-100" t-att-class="{ 'hoot-animations': env.runner.config.fun }">
                <header class="hoot-panel d-flex flex-column">
                    <nav class="hoot-controls py-1 px-2">
                        <h1
                            class="hoot-logo hoot-text-primary m-0 user-select-none"
