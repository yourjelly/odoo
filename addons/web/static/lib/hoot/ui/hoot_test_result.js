                            ...
                            >
                                ...
                                >
                                    <t t-foreach="assertion.messageParts" t-as="part" t-key="part_index">
                                        <t t-if="part.tag and part.tag !== 'raw'">
                                            <t t-if="part.tag.endsWith('[]')">
                                                <strong class="hoot-array">
                                                    <t>[</t>
                                                    <span t-attf-class="hoot-{{ part.tag.slice(0, -2) }}" t-esc="part.slice(1, -1)" />
                                                    <t>]</t>
                                                </strong>
                                            </t>
                                            <t t-else="">
                                                <strong t-attf-class="hoot-{{ part.tag }}" t-esc="part" />
                                            </t>
                                        </t>
                                        <t t-else="">
                                            <span t-esc="part" />
