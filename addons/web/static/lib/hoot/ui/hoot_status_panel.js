    ...
    static template = xml`
        <div class="hoot-status d-flex align-items-center justify-content-between gap-3 px-3 py-1" t-att-class="state.className">
            <div class="d-flex align-items-center gap-2 overflow-hidden">
                ...
                <t t-if="state.timer">
                    <span class="hoot-text-skip" t-esc="formatTime(state.timer)" />
                </t>
            </div>
            <div class="d-flex gap-1">
                ...
                >
                    <i
                        class="hoot-icon fa fa-filter"
                        t-att-class="{ 'hoot-rotate-180': props.sorted === 'asc' }"
                    />
                </button>
            </div>
        </div>
