...
const { document, localStorage, matchMedia, Object } = globalThis;
...
export class HootConfigDropdown extends Component {
    ...
    setup() {
        ...
        this.color = useState(makeColorSchemeStore("hoot-color-scheme"));
