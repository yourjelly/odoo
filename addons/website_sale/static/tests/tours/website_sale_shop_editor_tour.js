...
tour.register('shop_editor', {
    ...
    extra_trigger: "div.o_pricelist_dropdown a[data-bs-toggle=dropdown][aria-expanded=true]",
    content: "Click somewhere else in the shop.",
}, {
    trigger: "div.o_pricelist_dropdown a[data-bs-toggle=dropdown]",
    extra_trigger: "div.o_pricelist_dropdown a[data-bs-toggle=dropdown][aria-expanded=false]",
