...
// TODO Move back to 000.js once everything is converted ?
        ...
        if (productCategoryId && productCategoryId !== 'all') {
            if (productCategoryId === 'current') {
                ...
                if (!productCategoryId) {
                    console.log(registry.category("services").get("website_page"));
                    const mainObject = registry.category("services").get("website_page").getMainObject();
