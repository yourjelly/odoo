...
class TestWebsiteSaleImage(odoo.tests.HttpCase):
    ...
    def test_02_image_holder(self):
        ...
        attr_values = self.env["product.attribute.value"].create(
            [
                {"name": "Red", "attribute_id": product_attribute.id, "sequence": 1,},
                {"name": "Green", "attribute_id": product_attribute.id, "sequence": 2,},
                {"name": "Blue", "attribute_id": product_attribute.id, "sequence": 3,},
            ]
        )
