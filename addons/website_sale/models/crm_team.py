    ...
    def get_abandoned_carts(self):
        ...
        return {
            ...
            'help': '<p class="o_view_nocontent_smiling_face">%s</p><p>%s</p>' % (
                _("You can find all abandoned carts here, i.e. the carts generated by your website's visitors from over an hour ago that haven't been confirmed yet."),
                _("You should send an email to the customers to encourage them!"),
            ),
        }
