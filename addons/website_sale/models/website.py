...
class Website(models.Model):
    ...
    def _prepare_sale_order_values(self, partner, pricelist):
        ...
        salesperson_id = affiliate_id if self.env['res.users'].sudo().browse(affiliate_id).exists() else False
        ...
        default_user_id = partner.parent_id.user_id.id or partner.user_id.id or request.website.salesperson_id.id or self.salesperson_id.id
        values = {
            ...
            'user_id': salesperson_id or default_user_id,
