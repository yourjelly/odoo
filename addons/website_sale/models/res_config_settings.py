...
class ResConfigSettings(models.TransientModel):
    ...
    module_website_sale_stock = fields.Boolean(
        "Inventory", help='Installs the "Website Delivery Information" application'
    )
    ...
    def get_values(self):
        ...
        res.update(sale_delivery_settings=sale_delivery_settings,)
        return res
    ...
    def _onchange_sale_delivery_settings(self):
        if self.sale_delivery_settings == "none":
            self.update(
                {"module_delivery": False, "module_website_sale_delivery": False,}
            )
        elif self.sale_delivery_settings == "internal":
            self.update(
                {"module_delivery": True, "module_website_sale_delivery": False,}
            )
        else:
            self.update(
                {"module_delivery": True, "module_website_sale_delivery": True,}
            )
