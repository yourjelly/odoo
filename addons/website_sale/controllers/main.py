...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def _prepare_address_form_values(self, partner_id, address_type, parent_id=None, **_kwargs):
        ...
        :param str callback:
        :return: The checkout page values.
        :rtype: dict ARJ TODO UPDATE !!!
        """
        partner_sudo, val = super()._prepare_address_form_values(partner_id, address_type, **_kwargs)
        ...
        return partner_sudo, val

    @route('/shop/address/submit', type='http', methods=['POST'], auth='public', website=True, sitemap=False)
    def shop_address_submit(self, partner_id=None, address_type='billing', use_same=None, callback=None, required_fields=None, **form_data):
        ...
        # print("partner_id", partner_id, request.env['res.partner'].browse(partner_id).name, is_anonymous_cart)
        partner_sudo, submit_values = self._get_address_submit_result(partner_id=partner_id, address_type=address_type, **form_data)
        is_new_address = False
        # print(partner_sudo, address_values)
        ...
        submit_values.update({'successUrl': callback})
        return json.dumps(submit_values)
    ...
    def _complete_address_values(self, partner_sudo, address_values, address_type, use_same, order_sudo):
        ...
        if address_type == 'billing':
            ...
            if commercial_partner.active and partner_sudo.id != commercial_partner.id:
    ...
    def _create_new_address(self, address_values, address_type, use_same, order_sudo):
        ...
        self._complete_address_values(
            ResPartner, address_values, address_type, use_same, order_sudo
        )
        ...
        return ResPartner.with_context(
            creation_context
