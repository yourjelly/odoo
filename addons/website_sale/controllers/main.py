...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def pricelist_change(self, pricelist, **post):
        ...
        if (
            ...
            if redirect_url and request.website.is_view_active('website_sale.filter_products_price'):
                # FIXME ANVFE do we really want to convert the existing filters to the 'new' currency?
    ...
    def cart_update_json(
        ...
        values['notification_info'] = self._get_cart_notification_information(order_sudo, [values['line_id']])
