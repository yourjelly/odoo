...
class PaymentRefundWizard(models.TransientModel):
    ...
    def _compute_support_refund(self):
        for wizard in self:
            ...
            pm = wizard.transaction_id.payment_method_id.primary_payment_method_id or wizard.transaction_id.payment_method_id
            pm_support_refund = pm.support_refund #here also check the primar payment method
