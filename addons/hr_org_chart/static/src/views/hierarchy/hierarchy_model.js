...
export class HierarchyNode {
     ...
     * Fetch child nodes
     *
     * TODO: rename the method into fetchChildNodes
     */
    ...
    async updateParentNode(nodeId, { parentNodeId, parentResId }) {
        ...
        if (node) {
            ...
            if (parentNode) {
                ...
                if (this.childFieldName && parentNode.nodes.length === 0 && parentNode.childResIds.length > 0) {
