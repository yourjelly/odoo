...
class PurchaseAdvancePaymentInv(models.TransientModel):
    ...
    # check_count = fields.Boolean(related='purchase_order_ids.check_count')
    ...
    def _compute_count(self):
        ...
        if len(wizard.purchase_order_ids) > 1:
            self.purchase_order_ids.check_count = True
    ...
    def create_invoices(self):
        breakpoint()
        self.env['purchase.order'].action_create_invoice(self.purchase_order_ids, self.consolidated_billing)
    ...
    #         'domain': [('line_ids.sale_line_ids.order_id', 'in', self.purchase_order_ids.ids), ('state', '=', 'draft')],
    #     }
