...
class TestPurchaseLeadTime(TestPurchase):
    ...
    def test_00_product_company_level_delays(self):
        ...
        self.assertEqual(purchase.picking_ids.min_date, po_schedule_date, 'Schedule date of In type shipment should be equal to: schedule date of purchase order.')
    ...
    def test_01_product_level_delay(self):
        ...
        self._create_make_procurement(self.product_2, 5.00)
        purchase2 = self.env['purchase.order.line'].search([('product_id', '=', self.product_1.id)], limit=1).order_id
        ...
        # Check scheduled date of In Type shipment
        self.assertEqual(purchase2.picking_ids.min_date, po_schedule_date, 'Schedule date of In type shipment should be same as schedule date of purchase order.')
    ...
    def test_02_product_route_level_delays(self):
        ...
        self.assertEqual(incoming_shipment.min_date, po_schedule_date, 'Schedule date of In type shipment should be same as schedule date of purchase order.')
        ...
        self.assertEqual(incoming_shipment1.min_date, incoming_shipment1_schedule_date, 'Schedule date of Internal Type shipment for input stock location should be equal to: schedule date of purchase order + push rule delay.')
        ...
        self.assertEqual(incoming_shipment2.min_date, incoming_shipment2_schedule_date, 'Schedule date of Internal Type shipment for quality control stock location should be equal to: schedule date of Internal type shipment for input stock location + push rule delay..')
