...
class TestProjectrecurrence(TransactionCase):
            ...
            .create(
                {
                    ...
                    "type_ids": [(4, cls.stage_a.id), (4, cls.stage_b.id),],
                }
            )
        )
    ...
    def test_recurrence_update_task(self):
        ...
        task_c.write(
            {"name": "my super updated task", "recurrence_update": "all",}
        )
        ...
        task_a.write(
            {"name": "don't you dare change my title", "recurrence_update": "this",}
        )
        ...
        task_b.write(
            {"description": "hello!", "recurrence_update": "subsequent",}
        )
