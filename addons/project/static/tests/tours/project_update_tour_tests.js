odoo.define('project.update.tour', function (require) {
    'use strict';
    ...
    [tour.stepUtils.showAppsMenuItem(), {
        ...
        trigger: "input.datetimepicker-input[name=date_deadline]",
        run: 'text 12/12/2099'
    }, {
        trigger: ".modal-footer button"
    }, {
        ...
        trigger: ".o_open_milestone:eq(0) .o_milestone_detail span:eq(0)"
    }, {
        trigger: "input.datetimepicker-input[name=date_deadline]",
        run: 'text 12/12/2100'
    }, {
        ...
        trigger: ".o_field_widget[name=description] :contains('1 were closed')",
        run: function () {},
    }, {
        trigger: ".o_field_widget[name=description] :contains('New milestone') :contains('(due on 2100-12-12)')",
        run: function () {},
    }, {
        trigger: ".o_field_widget[name=description] :contains('New milestone') :contains('(2099-12-12 => 2100-12-12)')",
        run: function () {},
    }]);
