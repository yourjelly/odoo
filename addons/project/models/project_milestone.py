...
class ProjectMilestone(models.Model):
    ...
    def _compute_task_count(self):
        task_read_group = self.env['project.task']._read_group([('milestone_id', 'in', self.ids), ('allow_milestones', '=', True)], ['milestone_id'], ['__count'])
        task_count_per_milestone = {milestone.id: count for milestone, count in task_read_group}
