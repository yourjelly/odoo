...
class ProjectUpdate(models.Model):
    ...
    def _get_template_values(self, project):
        ...
        show_profitability = profitability_values and profitability_values.get('analytic_account_id') and (profitability_values.get('costs') or \
            profitability_values.get('revenues'))
