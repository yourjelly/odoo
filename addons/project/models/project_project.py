    ...
    def create(self, vals_list):
        ...
        if self.env.user.has_group('project.group_project_stages'):
            if 'default_stage_id' in self._context:
                ...
                default_stages_by_company = {company_id : self.env['project.project.stage'].search([('company_id', 'in', [False, company_id])], limit=1) for company_id in companies_ids}
                ...
                for vals in vals_list:
                    if vals.get('company_id'):
                        ...
                        if default_stage.company_id:
                            vals['company_id'] = default_stage.company_id.id
