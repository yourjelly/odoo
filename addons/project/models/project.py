...
class Project(models.Model):
    ...
    def _compute_task_count(self):
        task_data = self.env['project.task'].read_group([('project_id', 'in', self.ids), '|', ('stage_id.fold', '=', False), ('stage_id', '=', False)], ['project_id'], ['project_id'], label=False)
    ...
    def _compute_task_needaction_count(self):
        ...
        ], ['project_id'], ['project_id'], label=False)
