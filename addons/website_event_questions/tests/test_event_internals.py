...
class TestEventData(TestEventQuestionCommon):
    ...
    def test_process_attendees_form(self):
        ...
        self.assertEqual(registrations, [
            ...
            'user_input_line_ids': [
                (0, 0, {'question_id': self.event_question_1.id, 'suggested_answer_id': 5}),
                (0, 0, {'question_id': self.event_question_2.id, 'suggested_answer_id': 7}),
            ...
            'user_input_line_ids': [
                (0, 0, {'question_id': self.event_question_1.id, 'suggested_answer_id': 9}),
                (0, 0, {'question_id': self.event_question_2.id, 'suggested_answer_id': 7}),
                (0, 0, {'question_id': self.event_question_3.id, 'value_text_box': 'Free Text'})]}
        ])
