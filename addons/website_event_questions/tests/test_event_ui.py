...
class TestUi(tests.HttpCase):
    ...
    def test_01_tickets_questions(self):
        ...
        first_registration_answers = first_registration.user_input_line_ids
        ...
        ).suggested_answer_id.name, 'Vegetarian')
        ...
        ).suggested_answer_id.name, 'A friend')

        second_registration_answers = second_registration.user_input_line_ids
        self.assertEqual(len(second_registration_answers), 2)

        self.assertEqual(second_registration_answers.filtered(
            lambda answer: answer.question_id.title == 'Meal Type'
        ).suggested_answer_id.name, 'Pastafarian')
