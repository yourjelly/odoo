...
class Project(models.Model):
    ...
    def _get_profitability_items_from_aal(self, profitability_items, with_action=True):
        ...
        can_see_timesheets = with_action and len(self) == 1 and self.env.user._has_group('hr_timesheet.group_hr_timesheet_approver')
        revenues_dict = {}
        costs_dict = {}
...
class ProjectTask(models.Model):
    ...
    def _get_default_partner_id(self, project, parent):
        ...
        if not res and project:
            ...
            related_project = project if not self.env.user._has_group('base.group_portal') else project.sudo()
