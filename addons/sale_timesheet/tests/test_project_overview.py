...
class TestSaleProject(TestReporting):
    def test_project_overview_by_project(self):
        ...
        self.assertEqual(
            ...
            0,
            "The hours non-billable should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The hours non-billable-project should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The hours billable-time should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The hours billable-fixed should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The total hours should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The rate non-billable should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The rate non-billable-project should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The rate billable-time should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The rate billable-fixed should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The total rates should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The amount invoiced should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The amount cost should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The amount expense-cost should be the one from the SO2 line, as we are in ordered quantity",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The amount of the other revenues should be equal to the created other_revenues account analytic line",
        )
        self.assertEqual(
            float_compare(
            ...
            0,
            "The total amount should be the sum of the SO2 line and the created other_revenues account analytic line",
        )
        self.assertEqual(
            float_compare(
