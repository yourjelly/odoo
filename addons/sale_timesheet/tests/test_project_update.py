...
class TestProjectUpdateSaleTimesheet(TestProjectUpdate):
    def test_project_update_form_profitability(self):
        ...
        self.assertTrue(
            "Profitability" in update.description,
            "The description should contain 'Profitability'.",
        )
    ...
    def test_project_update_description_profitability(self):
        ...
        self.assertEqual(
            ...
            (today + relativedelta(months=-1)).strftime("%B"),
        ...
        self.assertEqual(
            template_values["profitability"]["timesheet_unit_amount"],
            "0",
        ...
        self.assertEqual(
            template_values["profitability"]["timesheet_trend"],
            "0",
        ...
        self.assertEqual(
            template_values["profitability"]["billing_rate"],
            "0",
    ...
    def test_project_update_panel_profitability_no_billable(self):
        ...
        self.assertEqual(
            len(panel_data["profitability_items"]["data"]),
            1,
            "Panel data should contain 'profitability_items>data' entries",
        )
        try:
    ...
    def test_project_update_panel_profitability_no_timesheet(self):
        ...
        self.assertEqual(
            panel_data["profitability_items"]["action"],
            "action_view_timesheet",
            "Panel data should contain 'profitability_items>action' entry",
        )
