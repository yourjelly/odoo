...
""",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            'hr_holidays/static/src/js/time_off_calendar_controller.js',
            'hr_holidays/static/src/js/time_off_calendar_popover.js',
            'hr_holidays/static/src/js/time_off_calendar_popover_renderer.js',
            'hr_holidays/static/src/js/time_off_calendar_renderer.js',
            'hr_holidays/static/src/js/time_off_calendar_views.js',
            'hr_holidays/static/src/js/time_off_calendar_employee_controller.js',
            'hr_holidays/static/src/js/time_off_calendar_employee_views.js',
