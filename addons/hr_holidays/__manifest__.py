...
""",
    ...
    'assets': {
        'assets_backend': [
            ...
            # after link[last()]
            'hr_holidays/static/scss/hr_leave_mobile.scss',
            # after link[last()]
            'hr_holidays/static/src/scss/time_off.scss',
            # after link[last()]
            'hr_holidays/static/src/bugfix/bugfix.scss',
            # after link[last()]
            'hr_holidays/static/src/components/partner_im_status_icon/partner_im_status_icon.scss',
            # after link[last()]
            'hr_holidays/static/src/components/thread_icon/thread_icon.scss',
            # after link[last()]
