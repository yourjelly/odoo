...
class TestAccrualAllocations(TestHrHolidaysCommon):
    def setUp(self):
        ...
        self.accrual_type = LeaveType.create(
            {"name": "accrual", "allocation_type": "fixed", "validity_start": False,}
        )
    ...
    def test_accrual_base_leaves(self):
            ...
            .create(
                {
                    ...
                    "date_to": datetime.combine(
                        df + relativedelta(days=1), time(0, 0, 0)
                    ),
                    "number_of_days": 1,
                }
            )
        ...
        self.assertEqual(
            ...
            0.8,
            "As employee took some unpaid leaves last week, he should be allocated only .8 days",
        )
    ...
    def test_accrual_many(self):
        ...
        self.assertEqual(alloc_1.number_of_days, 0.5)
    ...
    def test_accrual_new_employee(self):
        ...
        self.set_employee_create_date(
            self.employee_emp_id, fields.Datetime.to_string(fields.Datetime.now())
        )
        ...
        self.assertEqual(
            alloc_0.number_of_days,
            0,
            "Employee is new he should not get any accrual leaves",
        )
    ...
    def test_accrual_multi(self):
        ...
        self.assertEqual(
            alloc.number_of_days, 1, "Cron only allocates 1 days every two weeks"
        )
    ...
    def test_accrual_validation(self):
        ...
        self.assertEqual(
            alloc_0.number_of_days,
            0,
            "Cron validity passed, should not allocate any leave",
        )
    ...
    def test_accrual_balance_limit(self):
        ...
        self.assertEqual(
            ...
            5,
            "Should have allocated only 5 days as balance limit is 5",
        )
