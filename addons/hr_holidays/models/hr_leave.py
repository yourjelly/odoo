...
class HrLeave(models.Model):
    ...
    # request type
    request_unit = fields.Selection([('day', 'Days'), ('hour', 'Hours'), ('half_day', 'Half Day')], string='Request Unit', default='day')
    # view
    ...
    def _compute_date_from_to(self):
        for holiday in self:
            if not holiday.request_date_from:
                ...
                if (holiday.request_unit == 'half_day' or holiday.request_unit == 'hour') and holiday.request_date_to != holiday.request_date_from:
