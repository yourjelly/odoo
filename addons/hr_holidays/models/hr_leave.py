...
class HolidaysRequest(models.Model):
    ...
    def _get_employee_domain(self):
        ...
        if not self.env.user._has_group('hr_holidays.group_hr_holidays_user'):
            domain += [
                '|',
...
""",
    ...
    def _check_mandatory_day(self):
        is_leave_user = self.env.user._has_group('hr_holidays.group_hr_holidays_user')
    ...
    def _check_double_validation_rules(self, employees, state):
        if self.env.user._has_group('hr_holidays.group_hr_holidays_manager'):
            return
    ...
    def write(self, values):
        is_officer = self.env.user._has_group('hr_holidays.group_hr_holidays_user') or self.env.is_superuser()
