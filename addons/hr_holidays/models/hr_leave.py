...
class HolidaysRequest(models.Model):
    ...
    user_id = fields.Many2one('res.users', string='User', related='employee_id.user_id', compute_sudo=True, compute_sudo=True, store=True, default=lambda self: self.env.uid, readonly=True)
