...
class HolidaysRequest(models.Model):
    ...
    def _compute_state(self):
        for holiday in self:
            holiday.state = (
                "confirm" if holiday.validation_type != "no_validation" else "draft"
            )
    ...
    def _check_holidays(self):
        mapped_days = self.mapped("holiday_status_id").get_employees_days(
    ...
    def _check_leave_type_validity(self):
        for leave in self:
            ...
            dto = leave.date_to
            if (
                leave.holiday_status_id.validity_start
                and leave.holiday_status_id.validity_stop
            ):
