...
class AccountAnalyticLine(models.Model):
    ...
    def _check_can_write(self, values):
        ...
        if not (self.env.user.has_group('hr_timesheet.group_hr_timesheet_approver') or self.env.su) and any(self.env.user.id != analytic_line.user_id.id for analytic_line in self):
