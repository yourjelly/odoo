...
class ResConfigSettings(models.TransientModel):
    ...
    module_project_timesheet_synchro = fields.Boolean("Awesome Timesheet", compute='_compute_timesheet_modules', store=True, readonly=False)
    module_project_timesheet_holidays = fields.Boolean("Record Time Off", compute='_compute_timesheet_modules', store=True, readonly=False)
    ...
    def _compute_timesheet_modules(self):
        self.filtered(lambda c: not c.module_hr_timesheet).update({
