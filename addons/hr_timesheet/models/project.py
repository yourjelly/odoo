...
class Task(models.Model):
    ...
    analytic_account_active = fields.Boolean(
        "Active Analytic Account", compute="_compute_analytic_account_active"
    )
    allow_timesheets = fields.Boolean(
        "Allow timesheets",
    ...
    def _fields_view_get(
        ...
        result = super(Task, self)._fields_view_get(
            view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu
        )
        result["arch"] = self.env["account.analytic.line"]._apply_timesheet_label(
            result["arch"]
        )
