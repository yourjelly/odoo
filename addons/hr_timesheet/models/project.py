...
class Task(models.Model):
    ...
    allow_timesheets = fields.Boolean("Allow timesheets", related='effective_project_id.allow_timesheets', help="Timesheets can be logged on this task.", readonly=True)
