...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    def test_complete_order_confirms_transaction(self):
        ...
        normalized_data = PaypalController._normalize_paypal_response(self, self.completed_order)
    ...
    def test_feedback_processing(self):
        normalized_data = PaypalController._normalize_paypal_response(
            self, self.notification_data.get('resource'), is_webhook_origin=True)
        # Unknown transaction
