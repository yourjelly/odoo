...
class DeliveryCarrier(models.Model):
    ...
    def _get_price_available(self, order):
        ...
        return self._get_price_from_picking(total)

    def _get_price_dict(self, total, **kwargs):
    ...
    def _get_price_from_picking(self, total, **kwargs):
        price = 0.0
        criteria_found = False
        price_dict = self._get_price_dict(total, **kwargs)
