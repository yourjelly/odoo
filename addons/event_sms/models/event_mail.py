    ...
    def execute(self):
        for scheduler in self:
            ...
            if scheduler.interval_type != 'after_sub':
                ...
                if not scheduler.event_mail_sent and scheduler.scheduled_date <= now and scheduler.notification_type == 'sms' and \
                        (scheduler.interval_type != 'before_event' or scheduler.event_id.date_end > now) and \
                        scheduler.sms_template_id:
