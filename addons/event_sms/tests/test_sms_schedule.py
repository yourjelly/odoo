...
class TestSMSSchedule(TestEventCommon, SMSCase):
    ...
    def test_sms_schedule(self):
        ...
        self.assertTrue(all(m.mail_sent is False for m in sub_scheduler.mail_registration_ids))
        ...
        self.assertTrue(sub_scheduler.mail_registration_sent)
        ...
        self.assertTrue(before_scheduler.event_mail_sent)
