odoo.define('library.client_action', function (require) {
    ...
    var MoneyChartWidget = require('library.MoneyChartWidget');
    ...
    var ClientAction = Widget.extend(ControlPanelMixin, {
        ...
        start: function () {
            ...
            var def2 = this._renderMoneyChart();
         ...
         * @private
         */
        _renderMoneyChart: function () {
            var chartData = {
                benefit: this.stats.benefit,
                income: this.stats.money_in,
                money_lost: this.stats.money_lost,
            };
            var chart = new MoneyChartWidget(this, chartData);
            this.$('.o_fancy_money_chart').empty();
            return chart.appendTo(this.$('.o_fancy_money_chart'));
        },
        /**
         * @private
         */
