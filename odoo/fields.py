...
class Properties(Field):
    ...
    The "definition_record" define the field used to find the parent of the current record.
    The parent must have a PropertiesDefinition field "definition_record_field" that
