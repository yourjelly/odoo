...
class BaseModel(metaclass=MetaModel):
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def get_view(self, view_id=None, view_type='form', **options):
        ...
        arch, view = self._get_view(view_id=view_id, view_type=view_type, **options)
    ...
    def _fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        arch, view = self._get_view(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
        result = {
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        result = self.get_view(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
