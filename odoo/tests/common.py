...
class HttpCase(TransactionCase):
    ...
    def __init__(self, methodName="runTest"):
        ...
        self.xmlrpc_url = url_8 = "http://%s:%d/xmlrpc/2/" % (
            HOST,
        ...
        self._values.update(
            (
                ...
                self._cleanup_onchange(
                    self._view["fields"][k], v, self._values.get(k),
                ),
            )
...
class O2MForm(Form):
    ...
    def _get_modifier(self, field, modifier, default=False, modmap=None, vals=None):
        ...
        return super()._get_modifier(
            field, modifier, default=default, modmap=modmap, vals=vals
        )
