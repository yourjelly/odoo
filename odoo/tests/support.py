...
from odoo.modules import module, graph
...
class OdooTestModule(_pytest.python.Module):
    ...
    name for Odoo modules so they're imported via e.g. odoo.addons.sale
...
class DataTests(object):
    ...
    def pytest_collect_file(self, parent, path):
        if path.basename not in module.MANIFEST_NAMES:
            return
