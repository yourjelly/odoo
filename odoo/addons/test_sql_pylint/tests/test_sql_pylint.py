...
class TestSQLPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--reports=n',
            '--ignore=models.py,fields.py,base,tools,osv,test_new_api,service',
            "--msg-template='{msg_id} at {path}:{line} \n {msg}'",
            '--load-plugins=pylint.extensions.bad_builtin,sql_injection_checker',
        ]
