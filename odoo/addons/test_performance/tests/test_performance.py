...
class TestPerformance(SavepointCaseWithUserDemo):
    ...
    def setUpClass(cls):
        ...
        cls.env["test_performance.base"].create(
            [
                {"name": "Object 0", "value": 0, "partner_id": partner3.id,},
                {"name": "Object 1", "value": 10, "partner_id": partner3.id,},
                {"name": "Object 2", "value": 20, "partner_id": partner4.id,},
                {"name": "Object 3", "value": 30, "partner_id": partner10.id,},
                {"name": "Object 4", "value": 40, "partner_id": partner12.id,},
            ]
        )
