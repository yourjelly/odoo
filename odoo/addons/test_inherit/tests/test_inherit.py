...
class TestXMLIDS(common.TransactionCase):
    def test_xml_ids(self):
        ...
        self.assertCountEqual(xml_ids.get(foo.id), [
            'test_new_api.field_selection__test_new_api_selection__state__foo',
        ])
        self.assertCountEqual(xml_ids.get(bar.id), [
            'test_new_api.field_selection__test_new_api_selection__state__bar',
            'test_inherit.field_selection__test_new_api_selection__state__bar',
        ])
