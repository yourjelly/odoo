...
class TestError(common.HttpCase):
    ...
    def test_02_delete(self):
        ...
        try:
            ...
            self.assertIn("Another model is not quite ready to let go of the record you're trying to delete.", e.faultString)
            ...
            self.assertIn("How about archiving it instead?", e.faultString)
        ...
        try:
            ...
            self.assertIn(
                "How about archiving it instead?",
                e.faultString,
            )
