...
class TestGroupBooleans(common.TransactionCase):
    ...
    def test_agg_and(self):
        ...
        groups = self.Model.read_group(
            domain=[], fields=["key", "bool_and"], groupby=["key"],
        )
    ...
    def test_agg_or(self):
        ...
        groups = self.Model.read_group(
            domain=[], fields=["key", "bool_or"], groupby=["key"],
        )
    ...
    def test_agg_array(self):
        ...
        groups = self.Model.read_group(
            domain=[], fields=["key", "bool_array"], groupby=["key"],
        )
...
class TestAggregate(common.TransactionCase):
    ...
    def test_agg_default(self):
        ...
        self.assertEqual(
            groups,
            [{"key": 1, "value": 10, "key_count": 4, "__domain": [("key", "=", 1)],}],
        )
    ...
    def test_agg_explicit(self):
        ...
        self.assertEqual(
            groups,
            [{"key": 1, "value": 4, "key_count": 4, "__domain": [("key", "=", 1)],}],
        )
