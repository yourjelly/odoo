...
// Add second component
    ...
    content: _t("Select a product, or create a new one on the fly."),
    position: "right",
    run: "fill the_flow.component2 && click .modal-body",
}, {
    mobile: false,
    trigger: ".o_selected_row .o_required_modifier[name=product_id] input",
    ...
    content: _t("Select a product, or create a new one on the fly."),
    position: "right",
    run: "clear && fill the_flow.component2 && click .o_selected_row",
}, {
    mobile: false,
...
...stepUtils.statusbarButtonsSteps('Register Payment', _t("Register Payment"), ".o_statusbar_status .o_arrow_button_current:contains('Posted')"),
{
    ...
    run: "clear && fill the_flow.statement.line",
}, {
    mobile: false,
    edition: "enterprise",
