...
class TestActionBindings(common.TransactionCase):
    def test_bindings(self):
        ...
        self.assertItemsEqual(
            bindings["action"], (action1 + action2).read(), "Wrong action bindings",
        )
        self.assertItemsEqual(
            bindings["report"], action3.read(), "Wrong action bindings",
        )
        ...
        bindings = Actions.get_bindings("res.partner")
        self.assertItemsEqual(
            bindings["action"], action1.read(), "Wrong action bindings",
        )
        self.assertItemsEqual(
            bindings["report"], action3.read(), "Wrong action bindings",
        )
