# -*- coding: utf-8 -*-
{
    ...
    "depends": ["base"],
    "installable": True,
    "data": ["data/ir_asset.xml", "views/views.xml",],
    "auto_install": False,
    "assets": {
        ...
        "test_assetsbundle.manifest1": ["test_assetsbundle/static/src/*/**",],
        ...
        "test_assetsbundle.manifest6": [("include", "test_assetsbundle.manifest4"),],
