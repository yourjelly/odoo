...
class Users(models.Model):
    ...
    def _populate_factories(self):
        ...
        return [
            ...
            ("login", populate.get_string("user_login")),
            #  ("active", populate.cartesian([True, False], [0.9, 0.1])),  # it petes
            ("state", populate.constant("active")),  # can be active or new see auth_signup inherited model. Avoid trying to send mail for now
        ]
