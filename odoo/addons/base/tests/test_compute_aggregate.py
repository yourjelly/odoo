...
class TestCompute(TransactionCase):
        ...
        for model_name in self.env.registry:
            ...
            for field in Model._fields.values():
                ...
                if isinstance(field.compute, str):
                    func = getattr(records, field.compute, None)
                    if func is None:
                        continue
    ...
    def test_all_compute_new_read_group(self):
        self.all_compute('_read_group(', 'res_compute_new_read_group.json')
    ...
    def test_summarize_result(self):
        files_to_read = [
            ...
            'res_compute_new_read_group.json',
        ]
