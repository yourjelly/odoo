...
class TestRecordCache(TransactionCaseWithUserDemo):
    ...
    def test_cache(self):
        ...
        self.assertCountEqual(cache.get_missing_ids(Model, (foo1 + bar1)._ids, name), [1, 2])
        self.assertCountEqual(cache.get_missing_ids(Model, (foo2 + bar2)._ids, name), [1, 2])
        ...
        self.assertCountEqual(cache.get_missing_ids(Model, (foo1 + bar1)._ids, name), [])
        self.assertCountEqual(cache.get_missing_ids(Model, (foo2 + bar2)._ids, name), [])
        ...
        check(bar1, 'BAR2_NAME', 'BAR2_REF')
        check(bar2, 'BAR2_NAME', 'BAR2_REF')
        self.assertCountEqual(cache.get_missing_ids(Model, (foo1 + bar1)._ids, name), [1])
        self.assertCountEqual(cache.get_missing_ids(Model, (foo2 + bar2)._ids, name), [1])
