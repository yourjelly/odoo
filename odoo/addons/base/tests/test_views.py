...
class TestViews(ViewCase):
    ...
    @mute_logger('odoo.addons.base.models.ir_ui_view')
    def test_unknown_groups_field(self):
        arch = """
            <form string="View">
...
class ViewModifiers(ViewCase):
    ...
    def test_17_attrs_groups_validation(self):
        ...
        # don't need to add field, group_system is on the model, and don't need to add negative group
        validate("""
            <form string="View">
                <field name="name"/>
                <field name="inherit_id" %(attrs)s groups="base.group_system,!base.group_no_one"/>
            </form>
        """, add_field_with_groups=False)
        ...
        """, add_field_with_groups='~base.group_no_one')
