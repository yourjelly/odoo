...
class TestViews(ViewCase):
    ...
    def test_attrs_groups_behavior(self):
        ...
        self.assertFalse(self.env['res.partner'].with_user(user_demo).env.user._has_group('base.group_system'))
        ...
        self.assertTrue(self.env['res.partner'].with_user(user_admin).env.user._has_group('base.group_system'))
