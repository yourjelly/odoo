...
class Currency(models.Model):
    ...
    def _get_view(self, view_id=None, view_type='form', **options):
        arch, view = super(Currency, self)._get_view(view_id=view_id, view_type=view_type, **options)
...
class CurrencyRate(models.Model):
    ...
    @api.model
    def _get_view(self, view_id=None, view_type='form', **options):
        arch, view = super(CurrencyRate, self)._get_view(view_id=view_id, view_type=view_type, **options)
