...
class Users(models.Model):
    ...
    def _get_company_ids(self):
        ...
        domain = [('active', '=', True), ('user_ids', 'in', self.ids)]
        ...
        if self._context.get('install_filename') or self._context.get(MODULE_UNINSTALL_FLAG):
            ...
            for app, kind, gs, category_name in sorted_tuples:  # we process the user type first
                ...
                if app.xml_id == 'base.module_category_user_type':
                    ...
                    user_type_readonly = str([(user_type_field_name, '!=', group_employee.id)])
                    attrs['widget'] = 'radio'
            ...
            user_type_invisible = str([(user_type_field_name, '!=', group_employee.id)]) if user_type_field_name else None
