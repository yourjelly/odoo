...
from odoo.tools.translate import TranslationImporter, get_po_paths, get_xml_paths
    ...
    def _load_module_terms(self, modules, langs, overwrite=False, imported_module=False):
        ...
        for module_name in modules:
            ...
            for lang in langs:
                ...
                for xml_path in get_xml_paths(module_name, env=env):
                    translation_importer.load_file(xml_path, lang, module=module_name)
                    is_lang_imported = True
