...
class PropertiesCase(TransactionCase):
    ...
    def test_properties_field_read_batch(self):
        ...
        expected_queries = [
            ...
            # read the definition on the parent
    ...
    def test_properties_field_create_batch(self):
        ...
        self.assertEqual(
            ...
            msg='Should have updated the parent definition')
    ...
    def test_properties_field_many2one_unlink(self):
        ...
        with self.assertQueryCount(4):
            ...
            # 1 query to read the parent definition
    ...
    def test_properties_field_onchange(self):
        ...
        # change the parent, change the definition and add default values
        self.assertEqual(message.discussion, self.discussion_2)
        with self.assertQueryCount(7):
        ...
        # change the parent and the definition at the same time
    ...
    def test_properties_field_parent_update(self):
        """Test the parent definition update from the child."""
        self.discussion_1.attributes_definition = []
