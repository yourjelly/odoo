...
class TestDefaultView(common.TransactionCase):
    ...
    def test_default_form_view(self):
        self.assertEqual(
            etree.tostring(self.env['test_new_api.message']._get_default_form_view(), pretty_print=True, encoding='unicode'),
        ...
        self.assertEqual(
            etree.tostring(self.env['test_new_api.creativework.edition']._get_default_form_view(), pretty_print=True, encoding='unicode'),
        ...
        self.assertEqual(
            etree.tostring(self.env['test_new_api.mixed']._get_default_form_view(), pretty_print=True, encoding='unicode'),
