    ...
    def _onchange_name(self):
        if self.name and not self.address_id:
            self.address_id = (
                ...
                .sudo()
                .create({"name": self.name, "type": "private",})
            )
...
class SelectionBase(models.Model):
    ...
    my_selection = fields.Selection([("foo", "Foo"), ("bar", "Bar"),])
...
class SelectionBaseNullExplicit(models.Model):
    ...
    my_selection = fields.Selection(
        selection_add=[("quux", "Quux"),], ondelete={"quux": "set null"}
    )
...
class SelectionBaseNullImplicit(models.Model):
    ...
    my_selection = fields.Selection(selection_add=[("ham", "Ham"),])
...
class SelectionRequired(models.Model):
    ...
    active = fields.Boolean(default=True)
    my_selection = fields.Selection(
        [("foo", "Foo"), ("bar", "Bar"),], required=True, default="foo"
    )
...
class SelectionRequiredDefault(models.Model):
    ...
    my_selection = fields.Selection(
        selection_add=[("baz", "Baz"),], ondelete={"baz": "set default"}
    )
...
class SelectionRequiredCascade(models.Model):
    ...
    my_selection = fields.Selection(
        selection_add=[("eggs", "Eggs"),], ondelete={"eggs": "cascade"}
    )
...
class SelectionRequiredMultiple(models.Model):
    ...
    my_selection = fields.Selection(
        selection_add=[("pikachu", "Pikachu"), ("eevee", "Eevee"),],
        ondelete={
            "pikachu": "set default",
...
class SelectionRequiredCallback(models.Model):
    ...
    my_selection = fields.Selection(
        selection_add=[("knickers", "Oh la la"),],
        ondelete={
...
class SelectionNonStored(models.Model):
    ...
    my_selection = fields.Selection([("foo", "Foo"), ("bar", "Bar"),], store=False)
...
class SelectionRequiredWithWriteOverride(models.Model):
    ...
    my_selection = fields.Selection(
        selection_add=[("divinity", "Divinity: Original Sin 2"),],
