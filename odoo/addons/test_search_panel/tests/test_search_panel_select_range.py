...
class TestSelectRange(odoo.tests.TransactionCase):
    ...
    def test_many2one_empty(self):
        ...
        self.assertEqual(result, {"parent_field": "parent_name_id", "values": [],})

    def test_many2one(self):
        parent_folders = self.TargetModel.create(
            [{"name": "Folder 1",}, {"name": "Folder 2",},]
        )
        ...
        result = self.SourceModel.search_panel_select_range(
            "folder_id", enable_counters=True, expand=True,
        )
        self.assertEqual(
            result["values"],
            [
        ...
        result = self.SourceModel.search_panel_select_range(
            "folder_id", enable_counters=True, expand=True, limit=2,
        )
        self.assertEqual(
            result, SEARCH_PANEL_ERROR,
        )

        # counters, expand, hierarchization, and unreached limit
        result = self.SourceModel.search_panel_select_range(
            "folder_id", enable_counters=True, expand=True, limit=200,
        )
        self.assertEqual(
            result,
            {
        ...
        result = self.SourceModel.search_panel_select_range(
            "folder_id", enable_counters=True, expand=True, hierarchize=False,
        )
        self.assertEqual(
            result["values"],
            [
        ...
        result = self.SourceModel.search_panel_select_range("folder_id", expand=True,)
        self.assertEqual(
            result["values"],
            [
                {"display_name": "Folder 1", "id": f1_id, "parent_name_id": False,},
                {"display_name": "Folder 2", "id": f2_id, "parent_name_id": False,},
                {"display_name": "Folder 3", "id": f3_id, "parent_name_id": f1_id,},
                {"display_name": "Folder 4", "id": f4_id, "parent_name_id": f2_id,},
            ],
        )
        ...
        result = self.SourceModel.search_panel_select_range(
            "folder_id", expand=True, hierarchize=False,
        )
        self.assertEqual(
            result["values"],
            [
        ...
        result = self.SourceModel.search_panel_select_range(
            "folder_id", enable_counters=True, hierarchize=False,
        )
        self.assertEqual(
            result["values"],
            [
        ...
        result = self.SourceModel.search_panel_select_range(
            "folder_id", enable_counters=True, hierarchize=False, limit=2,
        )
        self.assertEqual(
            result, SEARCH_PANEL_ERROR,
        )
    ...
    def test_many2one_deep_hierarchy(self):
        folders_level_0 = self.TargetModel.create(
            [{"name": "Folder 1",}, {"name": "Folder 2",}, {"name": "Folder 3",},]
        )
    ...
    def test_many2one_empty_no_parent_name(self):
        ...
        self.assertEqual(result, {"parent_field": False, "values": [],})
    ...
    def test_many2one_no_parent_name(self):
        ...
        # counters and expand
        result = self.SourceModel.search_panel_select_range(
            "categ_id", enable_counters=True, expand=True,
        )
        self.assertEqual(
            result["values"],
            [
        ...
        result = self.SourceModel.search_panel_select_range("categ_id", expand=True,)
        self.assertEqual(
            result["values"],
            [
    ...
    def test_selection_empty(self):
        result = self.SourceModel.search_panel_select_range("state", expand=True,)
        self.assertEqual(
            result,
            {
                "parent_field": False,
    ...
    def test_selection(self):
        records = self.SourceModel.create(
            [{"name": "Rec 1", "state": "a",}, {"name": "Rec 2", "state": "a",},]
        )
        ...
        # counters and expand
        result = self.SourceModel.search_panel_select_range(
            "state", enable_counters=True, expand=True,
        )
        self.assertEqual(
            result["values"],
            [
        ...
        self.assertEqual(
            result["values"],
            [{"display_name": "A", "id": "a",}, {"display_name": "B", "id": "b",},],
        )
        ...
        # counters and no expand
        result = self.SourceModel.search_panel_select_range(
            "state", enable_counters=True,
        )
        self.assertEqual(
            result["values"], [{"__count": 2, "display_name": "A", "id": "a",},]
        )

        # no counters and no expand
        result = self.SourceModel.search_panel_select_range("state",)
        self.assertEqual(result["values"], [{"display_name": "A", "id": "a",},])
