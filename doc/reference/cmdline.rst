...
.. program:: odoo-bin typescriptconfiggenerator

When working on javascript, there are ways to help your editor providing you with
powerful and complete auto-completion. One of those ways is the use of a tsconfig.json file.
...
.. code-block:: console
   ...
   $ community/odoo-bin typescriptconfiggenerator community/addons community/odoo/addons enterprise > tsconfig.json
