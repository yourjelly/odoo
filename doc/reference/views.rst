...
The root element of the Kanban view is <dashboard>, it does not accept any
attributes.
...
``view``
    ...
    ``ref`` (optional)
        a xml id for a view. If not given, the default view for the model will
        be used.
...
``formula``
    ...
    - ``string`` (optional)
        A short description that will be displayed above the formula. If not
        given, it will fall back to the field string.
